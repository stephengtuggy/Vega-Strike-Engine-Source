...
Universe::Universe(int argc, char **argv, const char *galaxy_str, bool server) : current_cockpit(0), script_system(NULL)
{
...
Universe::Universe() : current_cockpit(0), script_system(NULL)
{
    is_server = false;
}
