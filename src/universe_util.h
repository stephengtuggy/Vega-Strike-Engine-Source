...
/// this function restores the active system.... there must be an equal number of pushSystems ans popSystems or else Vega Strike may behave
/// unpredictably
void popSystem();
...
/// this gets the difficutly of the game... ranges between 0 and 1... many missions depend on it never going past .99 unless it's always at
/// one.
float GetDifficulty();
...
/// this sends an IO message... I'm not sure if delay currently works, but from, to and message do :-) ... if you want to send to the bar do
/// "bar" as the to string... if you want to make news for the news room specify "news"
...
/// affects all players... player just affects the player who accepted the mission.
