...
void Pilot::SetComm(std::shared_ptr<Unit> parent)
{
...
float Pilot::adjustSpecificRelationship(std::shared_ptr<Unit> parent, void *aggressor, float factor, int faction)
{
...
void Pilot::DoHit(std::shared_ptr<Unit> parent, void *aggressor, int faction)
{
...
float Pilot::getAnger(const std::shared_ptr<Unit> parent, const std::shared_ptr<Unit> target) const
{
...
float Pilot::GetEffectiveRelationship(const std::shared_ptr<Unit> parent, const std::shared_ptr<Unit> target) const
{
...
Animation *Pilot::getCommFace(std::shared_ptr<Unit> parent, float mood, unsigned char &sex)
{
