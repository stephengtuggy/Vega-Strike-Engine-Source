...
class UnitFactory
{
  ...
  public:
    ...
    static Enhancement *
    createEnhancement(const char *filename, int faction, const string &modifications, Flightgroup *flightgrp = NULL, int fg_subnumber = 0);
    ...
    static Asteroid *createAsteroid(
        const char *filename, int faction, Flightgroup *fg = NULL, int fg_snumber = 0, float difficulty = .01, ObjSerial netcreate = 0);
