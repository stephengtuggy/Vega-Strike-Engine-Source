...
#define IMPLEMENT_IMPLICIT_NODE(base_class, volume)                                                                                        \
  public:                                                                                                                                  \
    ...
    /* Data access */                                                                                                                      \
    inline_ const base_class *GetPos() const                                                                                               \
    {                                                                                                                                      \
...
#define IMPLEMENT_NOLEAF_NODE(base_class, volume)                                                                                          \
  public:                                                                                                                                  \
    ...
    /* Leaf tests */                                                                                                                       \
    inline_ bool HasPosLeaf() const                                                                                                        \
    {                                                                                                                                      \
        return mPosData & 1;                                                                                                               \
    }                                                                                                                                      \
    inline_ bool HasNegLeaf() const                                                                                                        \
    {                                                                                                                                      \
        return mNegData & 1;                                                                                                               \
    }                                                                                                                                      \
    /* Data access */                                                                                                                      \
    ...
    inline_ udword GetPosPrimitive() const                                                                                                 \
    {                                                                                                                                      \
        return (udword)(mPosData >> 1);                                                                                                    \
    }                                                                                                                                      \
    inline_ udword GetNegPrimitive() const                                                                                                 \
    {                                                                                                                                      \
        return (udword)(mNegData >> 1);                                                                                                    \
    }                                                                                                                                      \
    /* Stats */                                                                                                                            \
    inline_ udword GetNodeSize() const                                                                                                     \
    {                                                                                                                                      \
...
#define IMPLEMENT_COLLISION_TREE(base_class, node)                                                                                         \
  public:                                                                                                                                  \
    ...
    /* Data access */                                                                                                                      \
    inline_ const node *GetNodes() const                                                                                                   \
    {                                                                                                                                      \
        return mNodes;                                                                                                                     \
    }                                                                                                                                      \
    /* Stats */                                                                                                                            \
    override(AABBOptimizedTree) udword GetUsedBytes() const                                                                                \
    {                                                                                                                                      \
