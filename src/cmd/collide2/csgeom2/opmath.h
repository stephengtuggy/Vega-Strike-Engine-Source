 ...
 */
template <class T> const T &csMax(const T &a, const T &b)
{
    if (b < a)
        return a;
    return b;
 ...
 */
template <class T> const T &csMin(const T &a, const T &b)
{
    if (a < b)
        return a;
    return b;
 ...
 */
template <class T> void csSort(T &a, T &b)
{
    if (b < a)
        CS::Swap(a, b);
}
 ...
 */
template <class T, class U> void csSort(T &a, T &b, U &x, U &y)
{
    if (b < a) {
        CS::Swap(a, b);
        CS::Swap(x, y);
 ...
 */
template <class T> T csClamp(const T &a, T max, T min)
{
 ...
 */
template <class T> T csSmoothStep(const T &a, T max, T min)
{
    T tmp, tmp2;
    if (a <= min)
        tmp = 0.0f;
 ...
 * \a f.
 */
template <class T, class Tfactor> T csLerp(const T &a, const T &b, const Tfactor &f)
{
    return (a + (b - a) * f);
}
 ...
 */
template <class T> T csSquare(const T &x)
{
    return x * x;
}
