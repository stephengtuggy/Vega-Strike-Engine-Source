...
{
    static GFXColor col_enemy =
        vs_config->getColor("relation_enemy", vs_config->getColor("enemy", GFXColor(1.0, 0.0, 0.0, 1.0))); // red   - like target
    static GFXColor col_friend =
        vs_config->getColor("relation_friend", vs_config->getColor("friend", GFXColor(0.0, 1.0, 0.0, 1.0))); // green - like target
    static GFXColor col_neutral = vs_config->getColor(
        "relation_neutral", vs_config->getColor("black_and_white", GFXColor(1.0, 1.0, 1.0, 1.0))); // white - NOT like target
    GFXColor col;
    if (rel == 0)
        col = col_neutral;
    else {
