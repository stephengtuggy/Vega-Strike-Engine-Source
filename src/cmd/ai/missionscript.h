...
{
  public:
    AIFlyToJumppoint(std::shared_ptr<Unit> jumppoint, float fly_speed, bool aft);
};

class AIPatrol : public AImissionScript
{
  public:
    AIPatrol(int mode, const QVector &area, float range, std::shared_ptr<Unit> around_unit, float patrol_speed);
};

class AIPatrolDefend : public AImissionScript
{
  public:
    AIPatrolDefend(int mode, const QVector &area, float range, std::shared_ptr<Unit> around_unit, float patrol_speed);
};
