...
namespace CommXML
{
enum Names { UNKNOWN, NODE, EDGE, NAME, INDEX, VALUE, SOUND, SEXE, FILENAME, GAIN };

const EnumMap::Pair element_names[] = {
    EnumMap::Pair("UNKNOWN", UNKNOWN), EnumMap::Pair("Node", NODE), EnumMap::Pair("Edge", EDGE), EnumMap::Pair("Sound", SOUND)};
