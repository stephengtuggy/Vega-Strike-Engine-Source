        ...
        if (SSCK.rightpress == 0 && SSCK.leftpress == 0) {
            ...
            if (SSCK.rightpress != 0 && SSCK.leftpress == 0) {
                ...
                if (SSCK.leftpress != 0 && SSCK.rightpress == 0) {
                    ...
                    KeyboardRight(((float)FBWABS(SSCK.rightpress) - (float)FBWABS(SSCK.leftpress)) /
        ...
        if (SSCK.rollrightpress == 0 && SSCK.rollleftpress == 0) {
            ...
            if (SSCK.rollrightpress != 0 && SSCK.rollleftpress == 0) {
                ...
                if (SSCK.rollleftpress != 0 && SSCK.rollrightpress == 0) {
                    ...
                    KeyboardRollRight(
                        ((float)FBWABS(SSCK.rollrightpress) - (float)FBWABS(SSCK.rollleftpress)) /
                        (FBWABS(SSCK.rollleftpress) + SSCK.rollleftrelease + FBWABS(SSCK.rollrightpress) + SSCK.rollrightrelease));
                }
            }
        }
        if (SSCK.accelpress != 0)
