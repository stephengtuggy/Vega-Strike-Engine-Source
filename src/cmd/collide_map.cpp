...
CollideArray::iterator
CollideArray::changeKey(CollideArray::iterator iter, const Collidable &newKey, CollideArray::iterator tless, CollideArray::iterator tmore)
{
                ...
                if (tless == cmbegin) {
                    if (canbebolt && boltSpecimen) {
                        ...
                        if (canbebolt == true && BoltType(un)) {
                            ...
                            return CollideChecker<T, false>::CheckCollisionsInner(
                                tmpcm->begin(), tmpcm->end(), un, collider, Unit::UNIT_ONLY, tmptless, tmptmore, minlook, maxlook);
                        }
