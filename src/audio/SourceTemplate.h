...
class SourceTemplate
{
  ...
  public:
     ...
     */
    SourceTemplate(const std::string &soundName, VSFileSystem::VSFileType type = VSFileSystem::UnknownFile, bool looping = false) throw();

    ~SourceTemplate();

    /** Get the sound resource name */
    std::string getSoundName() const throw()
    {
        return soundName;
    }

    /** Set the sound resource name */
    void setSoundName(const std::string &newName) throw()
    {
        soundName = newName;
    }

    /** Get the sound file type */
    VSFileSystem::VSFileType getSoundType() const throw()
    {
        return soundType;
    }

    /** Set the sound file type */
    void setSoundType(VSFileSystem::VSFileType type) throw()
    {
        soundType = type;
    }
    ...
    void setAttenuated(bool loop) throw()
    {
    ...
    void setStreaming(bool stream) throw()
    {
