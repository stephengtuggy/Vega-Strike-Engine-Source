...
void Source::updateRenderable(int flags, const Listener &sceneListener) throw()
{
...
void Source::setRenderable(SharedPtr<RenderableSource> ptr) throw()
{
...
void Source::seek(Timestamp time) throw(Exception)
{
    if (rendererDataPtr.get() && isPlaying() && isActive()) {
