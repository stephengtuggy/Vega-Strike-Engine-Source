...
void OpenALRenderableStreamingSource::startPlayingImpl(Timestamp start) throw(Exception)
{
    if (!isPlayingImpl()) {
...
void OpenALRenderableStreamingSource::stopPlayingImpl() throw(Exception)
{
    shouldPlay     = false;
...
bool OpenALRenderableStreamingSource::isPlayingImpl() const throw(Exception)
{
...
Timestamp OpenALRenderableStreamingSource::getPlayingTimeImpl() const throw(Exception)
{
    ALfloat offs = -1.f;
...
void OpenALRenderableStreamingSource::seekImpl(Timestamp time) throw(Exception)
{
    // Seek the stream to the specified position
    atEos = false;
...
void OpenALRenderableStreamingSource::updateImpl(int flags, const Listener &sceneListener) throw(Exception)
{
...
void OpenALRenderableStreamingSource::queueALBuffers() throw(Exception)
{
    SharedPtr<Sound> sound = getSource()->getSound();
