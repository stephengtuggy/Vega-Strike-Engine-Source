...
OpenALSimpleSound::OpenALSimpleSound(const std::string &name, VSFileSystem::VSFileType type) throw()
    : SimpleSound(name, type, false), bufferHandle(AL_NULL_BUFFER)
{
}
...
void OpenALSimpleSound::loadImpl(bool wait) throw(Exception)
{
    // just in case
    unloadImpl();
...
void OpenALSimpleSound::unloadImpl() throw()
{
