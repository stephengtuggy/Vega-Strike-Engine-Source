...
#undef DOT
    ...
    {
        return TMatrix3<T>(m[0][0] + o.m[0][0],
                           m[0][1] + o.m[0][1],
                           m[0][2] + o.m[0][2],
                           m[1][0] + o.m[1][0],
                           m[1][1] + o.m[1][1],
    ...
    {
#define DOT(m, om, r, c) (m[r][0] * om[0][c] + m[r][1] * om[1][c] + m[r][2] * om[2][c])
        return TMatrix3<T>(DOT(m, o.m, 0, 0),
                           DOT(m, o.m, 0, 1),
                           DOT(m, o.m, 0, 2),
                           DOT(m, o.m, 1, 0),
                           DOT(m, o.m, 1, 1),
...
#undef DOT
    ...
    {
        return TMatrix3<T>(
            m[0][0] * t, m[0][1] * t, m[0][2] * t, m[1][0] * t, m[1][1] * t, m[1][2] * t, m[2][0] * t, m[2][1] * t, m[2][2] * t);
    }
    ...
    {
        return TVector3<Y>(m[0][0] * t.x + m[0][1] * t.y + m[0][2] * t.z,
