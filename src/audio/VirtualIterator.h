...
*/
template <class _T, class _Rt = _T &, class _Pt = _T *> class VirtualIterator : public std::iterator<std::bidirectional_iterator_tag, _T>
{
  public:
...
class VirtualStandardIterator : public VirtualIterator<typename std::iterator_traits<_It>::value_type,
...
template <typename _It> class VirtualValuesIterator : public VirtualMappingIterator<_It, typename _It::value_type::second_type>
{
  public:
    // They should be inherited, but somehow gcc 4.1.0 doesn't understand that >:9
...
template <typename _It> class VirtualKeysIterator : public VirtualMappingIterator<_It, typename _It::value_type::first_type>
{
  public:
    // They should be inherited, but somehow gcc 4.1.0 doesn't understand that >:9
...
class ChainingIterator : public VirtualIterator<typename _It1::value_type, typename _It1::reference_type, typename _It1::pointer_type>
{
    _It1 it1;
    _It2 it2;
