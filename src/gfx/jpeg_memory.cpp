...
jpeg_memory_dest(j_compress_ptr cinfo, JOCTET *buffer, int bufsize)
{
    ...
    if (cinfo->dest == NULL) /* first time for this JPEG object? */
        cinfo->dest =
            (struct jpeg_destination_mgr *)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_PERMANENT, sizeof(memory_destination_mgr));
...
extern void jpeg_memory_src(j_decompress_ptr cinfo, unsigned char *ptr, size_t size)
{
    ...
    src = cinfo->src       = (struct jpeg_source_mgr *)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_PERMANENT, sizeof(*src));
