...
{
  public:
    static typename aligned_allocator<T, ALIGN>::pointer ifaligned_start_pointer(const aligned_allocator<T, ALIGN> &           a,
                                                                                 typename aligned_allocator<T, ALIGN>::pointer p)
    {
        return __alpn(p, ALIGN);
    }

    static typename aligned_allocator<T, ALIGN>::pointer ifaligned_start_pointer(const aligned_allocator<T, ALIGN> &             a,
                                                                                 typename aligned_allocator<T, ALIGN>::reference r)
    {
