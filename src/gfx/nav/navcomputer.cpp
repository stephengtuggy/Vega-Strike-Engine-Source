...
static const ModeInfo selectorModeInfo[] = {ModeInfo("Target Select", "System", "TargetSelectMode", "TargetSelectGroup"),
...
bool NavComputer::actionAnd(const EventCommandId &command, Control *control)
{
    ...
    if (input->text() == "")
        return true;
    ValuedPickerCell<CriteriaType> *  parameterCell = static_cast<ValuedPickerCell<CriteriaType> *>(parameterPicker->selectedCell());
    ValuedPickerCell<CriteriaNode *> *criteriaCell  = static_cast<ValuedPickerCell<CriteriaNode *> *>(criteriaPicker->selectedCell());
