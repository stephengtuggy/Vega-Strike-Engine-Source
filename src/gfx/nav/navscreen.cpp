...
void NavigationSystem::DrawMission()
{
    ...
    for (; i < numfactions; ++i) {
        ...
        if (factionname != "neutral" && factionname != "privateer" && factionname != "planets" && factionname != "upgrades") {
            ...
            drawdescription(FactionUtil::GetFactionName(i),
                            (originx + (0.1 * deltax)),
                            (originy),
                            1,
                            1,
    ...
    text += "#FFA000     PRESS SHIFT-M TO TOGGLE THIS MENU    \n\n\n\n#000000*******#00a6FFVega Strike 0.5#000000*********\nWelcome to VS. "
            "Your ship undocks stopped; #8080FFArrow keys/mouse/joystick#000000 steer your ship. Use #8080FF+#000000 & #8080FF-#000000 to "
            "adjust cruise control, or #8080FF/#000000 & #8080FF[backspace]#000000 to go to max governor setting or full-stop, "
            "respectively. Use #8080FFy#000000 to toggle between maneuver and travel settings for your relative velocity governors. Use "
            "#8080ff[home]#000000 & #8080FF[end]#000000 to set and unset velocity reference point to the current target (non-hostile "
            "targets only). Use #8080FFTab#000000 to activate Overdrive(if present).\n\nPress #8080FFn#000000 to cycle nav points, "
            "#8080FFt#000000 to cycle targets, and #8080FFp#000000 to target objects in front of you.\n\n#8080FF[space]#000000 fires guns, "
            "and #8080ff[Enter]#000000 fires missiles.\n\nThe #8080FFa#000000 key activates SPEC drive for insystem FTL.\nInterstellar "
            "Travel requires a #FFBB11 jump drive#000000 and #FFBB11FTL Capacitors#000000 to be installed. To jump, fly into the green "
            "wireframe nav-marker; hit #8080FFj#000000 to jump to the linked system.\n\nTo dock, target a base, planet or large vessel and "
            "hail with #8080FF0#000000 to request docking clearance. When you get close, a green box will appear. Fly to the box. When "
            "inside the box, #8080FFd#000000 will dock.\n\n#FF0000If Vega Strike halts or acts oddly,#000000\n#FFFF00immediately#000000 "
            "post stderr.txt & stdout.txt\nto http://vegastrike.sourceforge.net/forums\nbefore you restart Vega Strike.\n";
     ...
     * right buttons access the galaxy and system maps");
     *
...
void NavigationSystem::Adjust3dTransformation(bool three_d, bool system_vs_galaxy)
{
    ...
    if ((mouse_previous_state[0] == 1) &&
        TestIfInRange(screenskipby4[0], screenskipby4[1], screenskipby4[2], screenskipby4[3], mouse_x_current, mouse_y_current)) {
        if (system_vs_galaxy) {
            if (three_d) {
...
void NavigationSystem::RecordMinAndMax(
    const QVector &pos, float &min_x, float &max_x, float &min_y, float &max_y, float &min_z, float &max_z, float &max_all)
{
    // Record min and max
    //**********************************
...
float NavigationSystem::CalculatePerspectiveAdjustment(
    float &zscale, float &zdistance, QVector &pos, QVector &pos_flat, float &system_item_scale_temp, bool system_not_galaxy)
{
    pos_flat.i = pos.i;
    pos_flat.j = pos.j;
    pos_flat.k = center_z;
...
void NavigationSystem::DisplayOrientationLines(float the_x, float the_y, float the_x_flat, float the_y_flat, bool system_not_galaxy)
{
    ...
    if ((the_x > screenskipby4[1]) || (the_x < screenskipby4[0]) || (the_y > screenskipby4[3]) || (the_y < screenskipby4[2])) {
