                  ...
                  GFXColor *            factioncolours)
{
    ...
    // if(source != NULL)
    // relation =      FactionUtil::GetIntRelation( ( UniverseUtil::getPlayerX(UniverseUtil::getCurrentPlayer()) )->faction
    // ,source->faction); else relation = 0; the realtime relationship
    if (source != NULL)
