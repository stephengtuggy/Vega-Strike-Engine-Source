...
typedef enum { WS_MOUSE_DOWN = SDL_PRESSED, WS_MOUSE_UP = SDL_RELEASED } winsys_button_state_t;
...
typedef enum { WS_MOUSE_DOWN = GLUT_DOWN, WS_MOUSE_UP = GLUT_UP } winsys_button_state_t;
