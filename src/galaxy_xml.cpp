...
const EnumMap::Pair element_names[8]   = {EnumMap::Pair("UNKNOWN", UNKNOWN),
...
const EnumMap::Pair attribute_names[3] = {EnumMap::Pair("UNKNOWN", UNKNOWN), EnumMap::Pair("name", NAME), EnumMap::Pair("value", VALUE)};
