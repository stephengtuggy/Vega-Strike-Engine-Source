...
// Type of input event.
typedef enum { KEY_DOWN_EVENT, KEY_UP_EVENT, MOUSE_DOWN_EVENT, MOUSE_UP_EVENT, MOUSE_MOVE_EVENT, MOUSE_DRAG_EVENT } InputEventType;
...
enum Justification { RIGHT_JUSTIFY, CENTER_JUSTIFY, LEFT_JUSTIFY };
