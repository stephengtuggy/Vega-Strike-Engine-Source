...
)
{
    ...
    // FIXME -- Calling this here causes the loop in processEvent to be b0rked by a deletion. We now must checkForShutdown at a later
    // time...which is below    checkForShutDownEventManager();     // FIXME mbyron -- EVENT HACK.
}
