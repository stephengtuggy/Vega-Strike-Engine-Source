...
template <class _Module, bool _Default> class ModuleDeclaration
{
  public:
    ModuleDeclaration()
    {
...
class ConversionImpl
{
  public:
     ...
     */
    virtual RetCodeEnum convert(const std::string &inputFormat, const std::string &outputFormat, const std::string &opCode) = 0;
     ...
     */
    virtual void conversionHelp(const std::string &inputFormat, const std::string &outputFormat, const std::string &opCode) const = 0;
};
...
template <class _Impl, int _Priority = 0> class ConversionImplDeclaration
{
  public:
