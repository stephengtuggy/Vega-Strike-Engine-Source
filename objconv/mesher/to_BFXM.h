...
enum polytype { LINE, TRIANGLE, QUAD, LINESTRIP, TRISTRIP, TRIFAN, QUADSTRIP, UNKNOWN };
...
unsigned int appendrecordfromxml(XML   memfile,
                                 FILE *Outputfile,
                                 bool  forcenormals); // Append a record specified in memfile to the output file and return number of bytes
                                                     // written. Assumes Outputfile is appropriately positioned at the end of the file.
unsigned int appendmeshfromxml(XML   memfile,
                               FILE *Outputfile,
                               bool  forcenormals); // Append a mesh specified in memfile to the output file and return number of bytes
                                                   // written. Assumes Outputfile is appropriately positioned at the end of the file.
