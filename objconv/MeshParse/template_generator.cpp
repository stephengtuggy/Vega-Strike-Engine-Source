...
const EnumMap::Pair element_names[36]   = {EnumMap::Pair("UNKNOWN", UNKNOWN),
...
const EnumMap::Pair attribute_names[94] = {EnumMap::Pair("UNKNOWN", UNKNOWN),
    ...
    if (globalfileout) {
        ...
        if (xeq(name, "energy")) {
            ...
            for (iter = attributes.begin(); iter != attributes.end(); iter++) {
                ...
                if (shields) {
                    if (strcasecmp("front", tnam.c_str()) == 0 || strcasecmp("back", tnam.c_str()) == 0 ||
                        strcasecmp("left", tnam.c_str()) == 0 || strcasecmp("right", tnam.c_str()) == 0 ||
                        strcasecmp("top", tnam.c_str()) == 0 || strcasecmp("bottom", tnam.c_str()) == 0) {
