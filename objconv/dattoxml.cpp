...
int main(int argc, char **argv)
{
    ...
    for (i = 0; i < DrawDat.NumTris; i++) {
        Tag("Tri");
        Vert(DrawDat.Tris[i][2], DrawDat.TriTexture[i][4] * oo255, DrawDat.TriTexture[i][5] * oo255);
        Vert(DrawDat.Tris[i][1], DrawDat.TriTexture[i][2] * oo255, DrawDat.TriTexture[i][3] * oo255);
        Vert(DrawDat.Tris[i][0], DrawDat.TriTexture[i][0] * oo255, DrawDat.TriTexture[i][1] * oo255);
    ...
    for (i = 0; i < DrawDat.NumPents; i++) {
        Tag("Tri");
        Vert(DrawDat.Pents[i][2], DrawDat.PentTexture[i][4] * oo255, DrawDat.PentTexture[i][5] * oo255);
        Vert(DrawDat.Pents[i][1], DrawDat.PentTexture[i][2] * oo255, DrawDat.PentTexture[i][3] * oo255);
        Vert(DrawDat.Pents[i][0], DrawDat.PentTexture[i][0] * oo255, DrawDat.PentTexture[i][1] * oo255);
    ...
    for (i = 0; i < DrawDat.NumQuads; i++) {
        Tag("Quad");
        Vert(DrawDat.Quads[i][3], DrawDat.QuadTexture[i][6] * oo255, DrawDat.QuadTexture[i][7] * oo255);
        Vert(DrawDat.Quads[i][2], DrawDat.QuadTexture[i][4] * oo255, DrawDat.QuadTexture[i][5] * oo255);
        Vert(DrawDat.Quads[i][1], DrawDat.QuadTexture[i][2] * oo255, DrawDat.QuadTexture[i][3] * oo255);
        Vert(DrawDat.Quads[i][0], DrawDat.QuadTexture[i][0] * oo255, DrawDat.QuadTexture[i][1] * oo255);
    ...
    for (i = 0; i < DrawDat.NumPents; i++) {
        Tag("Quad");
        Vert(DrawDat.Pents[i][4], DrawDat.PentTexture[i][8] * oo255, DrawDat.PentTexture[i][9] * oo255);

        Vert(DrawDat.Pents[i][3], DrawDat.PentTexture[i][6] * oo255, DrawDat.PentTexture[i][7] * oo255);
    ...
    for (i = 0; i < DrawDat.NumHexs; i++) {
        Tag("Quad");
        Vert(DrawDat.Hexs[i][3], DrawDat.HexTexture[i][6] * oo255, DrawDat.HexTexture[i][7] * oo255);

        Vert(DrawDat.Hexs[i][2], DrawDat.HexTexture[i][4] * oo255, DrawDat.HexTexture[i][5] * oo255);

        Vert(DrawDat.Hexs[i][1], DrawDat.HexTexture[i][2] * oo255, DrawDat.HexTexture[i][3] * oo255);

        Vert(DrawDat.Hexs[i][0], DrawDat.HexTexture[i][0] * oo255, DrawDat.HexTexture[i][1] * oo255);

        ETag("Quad");
        Tag("Quad");
        Vert(DrawDat.Hexs[i][5], DrawDat.HexTexture[i][10] * oo255, DrawDat.HexTexture[i][11] * oo255);
        Vert(DrawDat.Hexs[i][4], DrawDat.HexTexture[i][8] * oo255, DrawDat.HexTexture[i][9] * oo255);
        Vert(DrawDat.Hexs[i][3], DrawDat.HexTexture[i][6] * oo255, DrawDat.HexTexture[i][7] * oo255);
        Vert(DrawDat.Hexs[i][0], DrawDat.HexTexture[i][0] * oo255, DrawDat.HexTexture[i][1] * oo255);
...
#define PI 3.1415926536
    ...
    Tab();
    fprintf(
        fp, "<Computer yaw=\"%f\" pitch=\"%f\" roll=\"%f\" afterburner=\"%f\" maxspeed=\"%f\"/>\n", ypr.i, ypr.j, ypr.k, abspeed, nspeed);
    Tab();
    Tag("Energy");
    Tab(2);
