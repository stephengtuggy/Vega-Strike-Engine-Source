 ...
 *  void changehome(bool makehomedir=false);				// Changes to user homedir in an OS independent way
 ...
 *  void vs_cdup();											// Goes up one level and changes the directory accordingly
