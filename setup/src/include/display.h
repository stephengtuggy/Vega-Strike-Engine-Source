...
#define GET_TITLE                                                                                                                          \
    char title[1000] = "VegaStrike Configurator";                                                                                          \
...
#define GET_STATIC_TEXT                                                                                                                    \
    char static_text[1000] = "Vega Strike requires the latest drivers for your video card.\nIf you run into problems please upgrade your " \
