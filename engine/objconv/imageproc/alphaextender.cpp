            ...
            if (row_pointers[i][j * stride + 3] == 0) {
                ...
                if (j > 0) {
                    if (row_pointers[i][(j - 1) * stride + 3]) {
                        row_pointers[i][j
                                * stride] =
                                row_pointers[i][(j - 1) * stride] * (1. / num_found)
                                        + row_pointers[i][j * stride] * (1 - 1. / num_found);
                        row_pointers[i][j * stride
                                + 1] =
                                row_pointers[i][(j - 1) * stride + 1] * (1. / num_found)
                                        + row_pointers[i][j * stride + 1] * (1 - 1. / num_found);
                        row_pointers[i][j * stride
                                + 2] =
                                row_pointers[i][(j - 1) * stride + 2] * (1. / num_found)
                ...
                if (i < sizey - 1) {
                    if (row_pointers[i + 1][j * stride + 3]) {
                        row_pointers[i][j
                                * stride] =
                                row_pointers[i + 1][j * stride] * (1. / num_found)
                                        + row_pointers[i][j * stride] * (1 - 1. / num_found);
                        row_pointers[i][j * stride
                                + 1] =
                                row_pointers[i + 1][j * stride + 1] * (1. / num_found)
                                        + row_pointers[i][j * stride + 1] * (1 - 1. / num_found);
                        row_pointers[i][j * stride
                                + 2] =
                                row_pointers[i + 1][j * stride + 2] * (1. / num_found)
                                        + row_pointers[i][j * stride + 2] * (1 - 1. / num_found);
                        num_found += 1;
                    }
                }
