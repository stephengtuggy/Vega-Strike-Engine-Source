...
void vega_config::Configuration::load_config(const std::string& json_text) {
    try {
        ...
        const boost::json::value * Screenshot_value_ptr = controls_object.if_contains("Screenshot");
        if (Screenshot_value_ptr != nullptr) {
            boost::json::object Screenshot_object = Screenshot_value_ptr->get_object();
            const boost::json::value * key_value_ptr = Screenshot_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.Screenshot.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = Screenshot_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.Screenshot.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * CommFormUp_value_ptr = controls_object.if_contains("CommFormUp");
        if (CommFormUp_value_ptr != nullptr) {
            boost::json::object CommFormUp_object = CommFormUp_value_ptr->get_object();
            const boost::json::value * key_value_ptr = CommFormUp_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.CommFormUp.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = CommFormUp_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.CommFormUp.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * CommBreakForm_value_ptr = controls_object.if_contains("CommBreakForm");
        if (CommBreakForm_value_ptr != nullptr) {
            boost::json::object CommBreakForm_object = CommBreakForm_value_ptr->get_object();
            const boost::json::value * key_value_ptr = CommBreakForm_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.CommBreakForm.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = CommBreakForm_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.CommBreakForm.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * CommHelpMeOut_value_ptr = controls_object.if_contains("CommHelpMeOut");
        if (CommHelpMeOut_value_ptr != nullptr) {
            boost::json::object CommHelpMeOut_object = CommHelpMeOut_value_ptr->get_object();
            const boost::json::value * key_value_ptr = CommHelpMeOut_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.CommHelpMeOut.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = CommHelpMeOut_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.CommHelpMeOut.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * CommAttackTarget_value_ptr = controls_object.if_contains("CommAttackTarget");
        if (CommAttackTarget_value_ptr != nullptr) {
            boost::json::object CommAttackTarget_object = CommAttackTarget_value_ptr->get_object();
            const boost::json::value * key_value_ptr = CommAttackTarget_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.CommAttackTarget.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = CommAttackTarget_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.CommAttackTarget.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * Comm1Key_value_ptr = controls_object.if_contains("Comm1Key");
        if (Comm1Key_value_ptr != nullptr) {
            boost::json::object Comm1Key_object = Comm1Key_value_ptr->get_object();
            const boost::json::value * key_value_ptr = Comm1Key_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.Comm1Key.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = Comm1Key_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.Comm1Key.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * Comm2Key_value_ptr = controls_object.if_contains("Comm2Key");
        if (Comm2Key_value_ptr != nullptr) {
            boost::json::object Comm2Key_object = Comm2Key_value_ptr->get_object();
            const boost::json::value * key_value_ptr = Comm2Key_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.Comm2Key.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = Comm2Key_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.Comm2Key.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * Comm3Key_value_ptr = controls_object.if_contains("Comm3Key");
        if (Comm3Key_value_ptr != nullptr) {
            boost::json::object Comm3Key_object = Comm3Key_value_ptr->get_object();
            const boost::json::value * key_value_ptr = Comm3Key_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.Comm3Key.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = Comm3Key_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.Comm3Key.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * Comm4Key_value_ptr = controls_object.if_contains("Comm4Key");
        if (Comm4Key_value_ptr != nullptr) {
            boost::json::object Comm4Key_object = Comm4Key_value_ptr->get_object();
            const boost::json::value * key_value_ptr = Comm4Key_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.Comm4Key.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = Comm4Key_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.Comm4Key.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * Comm5Key_value_ptr = controls_object.if_contains("Comm5Key");
        if (Comm5Key_value_ptr != nullptr) {
            boost::json::object Comm5Key_object = Comm5Key_value_ptr->get_object();
            const boost::json::value * key_value_ptr = Comm5Key_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.Comm5Key.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = Comm5Key_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.Comm5Key.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * Comm6Key_value_ptr = controls_object.if_contains("Comm6Key");
        if (Comm6Key_value_ptr != nullptr) {
            boost::json::object Comm6Key_object = Comm6Key_value_ptr->get_object();
            const boost::json::value * key_value_ptr = Comm6Key_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.Comm6Key.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = Comm6Key_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.Comm6Key.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * Comm7Key_value_ptr = controls_object.if_contains("Comm7Key");
        if (Comm7Key_value_ptr != nullptr) {
            boost::json::object Comm7Key_object = Comm7Key_value_ptr->get_object();
            const boost::json::value * key_value_ptr = Comm7Key_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.Comm7Key.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = Comm7Key_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.Comm7Key.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * Comm8Key_value_ptr = controls_object.if_contains("Comm8Key");
        if (Comm8Key_value_ptr != nullptr) {
            boost::json::object Comm8Key_object = Comm8Key_value_ptr->get_object();
            const boost::json::value * key_value_ptr = Comm8Key_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.Comm8Key.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = Comm8Key_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.Comm8Key.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * SaveTarget1_value_ptr = controls_object.if_contains("SaveTarget1");
        if (SaveTarget1_value_ptr != nullptr) {
            boost::json::object SaveTarget1_object = SaveTarget1_value_ptr->get_object();
            const boost::json::value * key_value_ptr = SaveTarget1_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.SaveTarget1.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = SaveTarget1_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.SaveTarget1.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * SaveTarget2_value_ptr = controls_object.if_contains("SaveTarget2");
        if (SaveTarget2_value_ptr != nullptr) {
            boost::json::object SaveTarget2_object = SaveTarget2_value_ptr->get_object();
            const boost::json::value * key_value_ptr = SaveTarget2_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.SaveTarget2.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = SaveTarget2_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.SaveTarget2.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * SaveTarget3_value_ptr = controls_object.if_contains("SaveTarget3");
        if (SaveTarget3_value_ptr != nullptr) {
            boost::json::object SaveTarget3_object = SaveTarget3_value_ptr->get_object();
            const boost::json::value * key_value_ptr = SaveTarget3_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.SaveTarget3.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = SaveTarget3_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.SaveTarget3.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * SaveTarget4_value_ptr = controls_object.if_contains("SaveTarget4");
        if (SaveTarget4_value_ptr != nullptr) {
            boost::json::object SaveTarget4_object = SaveTarget4_value_ptr->get_object();
            const boost::json::value * key_value_ptr = SaveTarget4_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.SaveTarget4.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = SaveTarget4_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.SaveTarget4.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * SaveTarget5_value_ptr = controls_object.if_contains("SaveTarget5");
        if (SaveTarget5_value_ptr != nullptr) {
            boost::json::object SaveTarget5_object = SaveTarget5_value_ptr->get_object();
            const boost::json::value * key_value_ptr = SaveTarget5_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.SaveTarget5.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = SaveTarget5_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.SaveTarget5.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * SaveTarget6_value_ptr = controls_object.if_contains("SaveTarget6");
        if (SaveTarget6_value_ptr != nullptr) {
            boost::json::object SaveTarget6_object = SaveTarget6_value_ptr->get_object();
            const boost::json::value * key_value_ptr = SaveTarget6_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.SaveTarget6.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = SaveTarget6_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.SaveTarget6.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * SaveTarget7_value_ptr = controls_object.if_contains("SaveTarget7");
        if (SaveTarget7_value_ptr != nullptr) {
            boost::json::object SaveTarget7_object = SaveTarget7_value_ptr->get_object();
            const boost::json::value * key_value_ptr = SaveTarget7_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.SaveTarget7.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = SaveTarget7_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.SaveTarget7.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * SaveTarget8_value_ptr = controls_object.if_contains("SaveTarget8");
        if (SaveTarget8_value_ptr != nullptr) {
            boost::json::object SaveTarget8_object = SaveTarget8_value_ptr->get_object();
            const boost::json::value * key_value_ptr = SaveTarget8_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.SaveTarget8.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = SaveTarget8_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.SaveTarget8.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * SaveTarget9_value_ptr = controls_object.if_contains("SaveTarget9");
        if (SaveTarget9_value_ptr != nullptr) {
            boost::json::object SaveTarget9_object = SaveTarget9_value_ptr->get_object();
            const boost::json::value * key_value_ptr = SaveTarget9_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.SaveTarget9.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = SaveTarget9_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.SaveTarget9.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * RestoreTarget1_value_ptr = controls_object.if_contains("RestoreTarget1");
        if (RestoreTarget1_value_ptr != nullptr) {
            boost::json::object RestoreTarget1_object = RestoreTarget1_value_ptr->get_object();
            const boost::json::value * key_value_ptr = RestoreTarget1_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.RestoreTarget1.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = RestoreTarget1_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.RestoreTarget1.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * RestoreTarget2_value_ptr = controls_object.if_contains("RestoreTarget2");
        if (RestoreTarget2_value_ptr != nullptr) {
            boost::json::object RestoreTarget2_object = RestoreTarget2_value_ptr->get_object();
            const boost::json::value * key_value_ptr = RestoreTarget2_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.RestoreTarget2.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = RestoreTarget2_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.RestoreTarget2.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * RestoreTarget3_value_ptr = controls_object.if_contains("RestoreTarget3");
        if (RestoreTarget3_value_ptr != nullptr) {
            boost::json::object RestoreTarget3_object = RestoreTarget3_value_ptr->get_object();
            const boost::json::value * key_value_ptr = RestoreTarget3_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.RestoreTarget3.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = RestoreTarget3_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.RestoreTarget3.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * RestoreTarget4_value_ptr = controls_object.if_contains("RestoreTarget4");
        if (RestoreTarget4_value_ptr != nullptr) {
            boost::json::object RestoreTarget4_object = RestoreTarget4_value_ptr->get_object();
            const boost::json::value * key_value_ptr = RestoreTarget4_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.RestoreTarget4.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = RestoreTarget4_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.RestoreTarget4.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * RestoreTarget5_value_ptr = controls_object.if_contains("RestoreTarget5");
        if (RestoreTarget5_value_ptr != nullptr) {
            boost::json::object RestoreTarget5_object = RestoreTarget5_value_ptr->get_object();
            const boost::json::value * key_value_ptr = RestoreTarget5_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.RestoreTarget5.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = RestoreTarget5_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.RestoreTarget5.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * RestoreTarget6_value_ptr = controls_object.if_contains("RestoreTarget6");
        if (RestoreTarget6_value_ptr != nullptr) {
            boost::json::object RestoreTarget6_object = RestoreTarget6_value_ptr->get_object();
            const boost::json::value * key_value_ptr = RestoreTarget6_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.RestoreTarget6.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = RestoreTarget6_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.RestoreTarget6.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * RestoreTarget7_value_ptr = controls_object.if_contains("RestoreTarget7");
        if (RestoreTarget7_value_ptr != nullptr) {
            boost::json::object RestoreTarget7_object = RestoreTarget7_value_ptr->get_object();
            const boost::json::value * key_value_ptr = RestoreTarget7_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.RestoreTarget7.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = RestoreTarget7_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.RestoreTarget7.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * RestoreTarget8_value_ptr = controls_object.if_contains("RestoreTarget8");
        if (RestoreTarget8_value_ptr != nullptr) {
            boost::json::object RestoreTarget8_object = RestoreTarget8_value_ptr->get_object();
            const boost::json::value * key_value_ptr = RestoreTarget8_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.RestoreTarget8.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = RestoreTarget8_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.RestoreTarget8.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * RestoreTarget9_value_ptr = controls_object.if_contains("RestoreTarget9");
        if (RestoreTarget9_value_ptr != nullptr) {
            boost::json::object RestoreTarget9_object = RestoreTarget9_value_ptr->get_object();
            const boost::json::value * key_value_ptr = RestoreTarget9_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.RestoreTarget9.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = RestoreTarget9_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.RestoreTarget9.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * FireKey_value_ptr = controls_object.if_contains("FireKey");
        if (FireKey_value_ptr != nullptr) {
            boost::json::object FireKey_object = FireKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = FireKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.FireKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = FireKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.FireKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * SwitchCombatMode_value_ptr = controls_object.if_contains("SwitchCombatMode");
        if (SwitchCombatMode_value_ptr != nullptr) {
            boost::json::object SwitchCombatMode_object = SwitchCombatMode_value_ptr->get_object();
            const boost::json::value * key_value_ptr = SwitchCombatMode_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.SwitchCombatMode.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = SwitchCombatMode_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.SwitchCombatMode.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * JumpKey_value_ptr = controls_object.if_contains("JumpKey");
        if (JumpKey_value_ptr != nullptr) {
            boost::json::object JumpKey_object = JumpKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = JumpKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.JumpKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = JumpKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.JumpKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * ToggleWarpDrive_value_ptr = controls_object.if_contains("ToggleWarpDrive");
        if (ToggleWarpDrive_value_ptr != nullptr) {
            boost::json::object ToggleWarpDrive_object = ToggleWarpDrive_value_ptr->get_object();
            const boost::json::value * key_value_ptr = ToggleWarpDrive_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.ToggleWarpDrive.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = ToggleWarpDrive_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.ToggleWarpDrive.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * ASAP_value_ptr = controls_object.if_contains("ASAP");
        if (ASAP_value_ptr != nullptr) {
            boost::json::object ASAP_object = ASAP_value_ptr->get_object();
            const boost::json::value * key_value_ptr = ASAP_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.ASAP.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = ASAP_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.ASAP.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * CloakKey_value_ptr = controls_object.if_contains("CloakKey");
        if (CloakKey_value_ptr != nullptr) {
            boost::json::object CloakKey_object = CloakKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = CloakKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.CloakKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = CloakKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.CloakKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * EjectKey_value_ptr = controls_object.if_contains("EjectKey");
        if (EjectKey_value_ptr != nullptr) {
            boost::json::object EjectKey_object = EjectKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = EjectKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.EjectKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = EjectKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.EjectKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * ECMKey_value_ptr = controls_object.if_contains("ECMKey");
        if (ECMKey_value_ptr != nullptr) {
            boost::json::object ECMKey_object = ECMKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = ECMKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.ECMKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = ECMKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.ECMKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * EjectCargoKey_value_ptr = controls_object.if_contains("EjectCargoKey");
        if (EjectCargoKey_value_ptr != nullptr) {
            boost::json::object EjectCargoKey_object = EjectCargoKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = EjectCargoKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.EjectCargoKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = EjectCargoKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.EjectCargoKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * MissileKey_value_ptr = controls_object.if_contains("MissileKey");
        if (MissileKey_value_ptr != nullptr) {
            boost::json::object MissileKey_object = MissileKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = MissileKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.MissileKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = MissileKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.MissileKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * WeapSelKey_value_ptr = controls_object.if_contains("WeapSelKey");
        if (WeapSelKey_value_ptr != nullptr) {
            boost::json::object WeapSelKey_object = WeapSelKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = WeapSelKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.WeapSelKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = WeapSelKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.WeapSelKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * ReverseWeapSelKey_value_ptr = controls_object.if_contains("ReverseWeapSelKey");
        if (ReverseWeapSelKey_value_ptr != nullptr) {
            boost::json::object ReverseWeapSelKey_object = ReverseWeapSelKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = ReverseWeapSelKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.ReverseWeapSelKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = ReverseWeapSelKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.ReverseWeapSelKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * Respawn_value_ptr = controls_object.if_contains("Respawn");
        if (Respawn_value_ptr != nullptr) {
            boost::json::object Respawn_object = Respawn_value_ptr->get_object();
            const boost::json::value * key_value_ptr = Respawn_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.Respawn.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = Respawn_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.Respawn.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * TurretControl_value_ptr = controls_object.if_contains("TurretControl");
        if (TurretControl_value_ptr != nullptr) {
            boost::json::object TurretControl_object = TurretControl_value_ptr->get_object();
            const boost::json::value * key_value_ptr = TurretControl_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.TurretControl.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = TurretControl_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.TurretControl.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * TextMessage_value_ptr = controls_object.if_contains("TextMessage");
        if (TextMessage_value_ptr != nullptr) {
            boost::json::object TextMessage_object = TextMessage_value_ptr->get_object();
            const boost::json::value * key_value_ptr = TextMessage_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.TextMessage.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = TextMessage_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.TextMessage.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * DockKey_value_ptr = controls_object.if_contains("DockKey");
        if (DockKey_value_ptr != nullptr) {
            boost::json::object DockKey_object = DockKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = DockKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.DockKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = DockKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.DockKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * RequestClearenceKey_value_ptr = controls_object.if_contains("RequestClearenceKey");
        if (RequestClearenceKey_value_ptr != nullptr) {
            boost::json::object RequestClearenceKey_object = RequestClearenceKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = RequestClearenceKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.RequestClearenceKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = RequestClearenceKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.RequestClearenceKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * ReverseMisSelKey_value_ptr = controls_object.if_contains("ReverseMisSelKey");
        if (ReverseMisSelKey_value_ptr != nullptr) {
            boost::json::object ReverseMisSelKey_object = ReverseMisSelKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = ReverseMisSelKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.ReverseMisSelKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = ReverseMisSelKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.ReverseMisSelKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * MisSelKey_value_ptr = controls_object.if_contains("MisSelKey");
        if (MisSelKey_value_ptr != nullptr) {
            boost::json::object MisSelKey_object = MisSelKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = MisSelKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.MisSelKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = MisSelKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.MisSelKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * TargetKey_value_ptr = controls_object.if_contains("TargetKey");
        if (TargetKey_value_ptr != nullptr) {
            boost::json::object TargetKey_object = TargetKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = TargetKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.TargetKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = TargetKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.TargetKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * SigTargetKey_value_ptr = controls_object.if_contains("SigTargetKey");
        if (SigTargetKey_value_ptr != nullptr) {
            boost::json::object SigTargetKey_object = SigTargetKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = SigTargetKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.SigTargetKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = SigTargetKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.SigTargetKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * SubUnitTargetKey_value_ptr = controls_object.if_contains("SubUnitTargetKey");
        if (SubUnitTargetKey_value_ptr != nullptr) {
            boost::json::object SubUnitTargetKey_object = SubUnitTargetKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = SubUnitTargetKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.SubUnitTargetKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = SubUnitTargetKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.SubUnitTargetKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * UnitTargetKey_value_ptr = controls_object.if_contains("UnitTargetKey");
        if (UnitTargetKey_value_ptr != nullptr) {
            boost::json::object UnitTargetKey_object = UnitTargetKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = UnitTargetKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.UnitTargetKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = UnitTargetKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.UnitTargetKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * LockTargetKey_value_ptr = controls_object.if_contains("LockTargetKey");
        if (LockTargetKey_value_ptr != nullptr) {
            boost::json::object LockTargetKey_object = LockTargetKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = LockTargetKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.LockTargetKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = LockTargetKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.LockTargetKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * PickTargetKey_value_ptr = controls_object.if_contains("PickTargetKey");
        if (PickTargetKey_value_ptr != nullptr) {
            boost::json::object PickTargetKey_object = PickTargetKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = PickTargetKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.PickTargetKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = PickTargetKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.PickTargetKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * NearestTargetKey_value_ptr = controls_object.if_contains("NearestTargetKey");
        if (NearestTargetKey_value_ptr != nullptr) {
            boost::json::object NearestTargetKey_object = NearestTargetKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = NearestTargetKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.NearestTargetKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = NearestTargetKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.NearestTargetKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * ReverseTargetKey_value_ptr = controls_object.if_contains("ReverseTargetKey");
        if (ReverseTargetKey_value_ptr != nullptr) {
            boost::json::object ReverseTargetKey_object = ReverseTargetKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = ReverseTargetKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.ReverseTargetKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = ReverseTargetKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.ReverseTargetKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * NearestHostileTargetKey_value_ptr = controls_object.if_contains("NearestHostileTargetKey");
        if (NearestHostileTargetKey_value_ptr != nullptr) {
            boost::json::object NearestHostileTargetKey_object = NearestHostileTargetKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = NearestHostileTargetKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.NearestHostileTargetKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = NearestHostileTargetKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.NearestHostileTargetKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * NearestDangerousHostileKey_value_ptr = controls_object.if_contains("NearestDangerousHostileKey");
        if (NearestDangerousHostileKey_value_ptr != nullptr) {
            boost::json::object NearestDangerousHostileKey_object = NearestDangerousHostileKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = NearestDangerousHostileKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.NearestDangerousHostileKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = NearestDangerousHostileKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.NearestDangerousHostileKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * NearestFriendlyKey_value_ptr = controls_object.if_contains("NearestFriendlyKey");
        if (NearestFriendlyKey_value_ptr != nullptr) {
            boost::json::object NearestFriendlyKey_object = NearestFriendlyKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = NearestFriendlyKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.NearestFriendlyKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = NearestFriendlyKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.NearestFriendlyKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * NearestBaseKey_value_ptr = controls_object.if_contains("NearestBaseKey");
        if (NearestBaseKey_value_ptr != nullptr) {
            boost::json::object NearestBaseKey_object = NearestBaseKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = NearestBaseKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.NearestBaseKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = NearestBaseKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.NearestBaseKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * NearestPlanetKey_value_ptr = controls_object.if_contains("NearestPlanetKey");
        if (NearestPlanetKey_value_ptr != nullptr) {
            boost::json::object NearestPlanetKey_object = NearestPlanetKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = NearestPlanetKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.NearestPlanetKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = NearestPlanetKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.NearestPlanetKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * NearestJumpKey_value_ptr = controls_object.if_contains("NearestJumpKey");
        if (NearestJumpKey_value_ptr != nullptr) {
            boost::json::object NearestJumpKey_object = NearestJumpKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = NearestJumpKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.NearestJumpKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = NearestJumpKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.NearestJumpKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * TurretTargetKey_value_ptr = controls_object.if_contains("TurretTargetKey");
        if (TurretTargetKey_value_ptr != nullptr) {
            boost::json::object TurretTargetKey_object = TurretTargetKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = TurretTargetKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.TurretTargetKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = TurretTargetKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.TurretTargetKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * TurretAIOn_value_ptr = controls_object.if_contains("TurretAIOn");
        if (TurretAIOn_value_ptr != nullptr) {
            boost::json::object TurretAIOn_object = TurretAIOn_value_ptr->get_object();
            const boost::json::value * key_value_ptr = TurretAIOn_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.TurretAIOn.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = TurretAIOn_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.TurretAIOn.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * TurretAIOff_value_ptr = controls_object.if_contains("TurretAIOff");
        if (TurretAIOff_value_ptr != nullptr) {
            boost::json::object TurretAIOff_object = TurretAIOff_value_ptr->get_object();
            const boost::json::value * key_value_ptr = TurretAIOff_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.TurretAIOff.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = TurretAIOff_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.TurretAIOff.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * TurretAIFireAtWill_value_ptr = controls_object.if_contains("TurretAIFireAtWill");
        if (TurretAIFireAtWill_value_ptr != nullptr) {
            boost::json::object TurretAIFireAtWill_object = TurretAIFireAtWill_value_ptr->get_object();
            const boost::json::value * key_value_ptr = TurretAIFireAtWill_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.TurretAIFireAtWill.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = TurretAIFireAtWill_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.TurretAIFireAtWill.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * ReverseNearestTargetKey_value_ptr = controls_object.if_contains("ReverseNearestTargetKey");
        if (ReverseNearestTargetKey_value_ptr != nullptr) {
            boost::json::object ReverseNearestTargetKey_object = ReverseNearestTargetKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = ReverseNearestTargetKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.ReverseNearestTargetKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = ReverseNearestTargetKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.ReverseNearestTargetKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * ReverseMissionTargetKey_value_ptr = controls_object.if_contains("ReverseMissionTargetKey");
        if (ReverseMissionTargetKey_value_ptr != nullptr) {
            boost::json::object ReverseMissionTargetKey_object = ReverseMissionTargetKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = ReverseMissionTargetKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.ReverseMissionTargetKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = ReverseMissionTargetKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.ReverseMissionTargetKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * MissionTargetKey_value_ptr = controls_object.if_contains("MissionTargetKey");
        if (MissionTargetKey_value_ptr != nullptr) {
            boost::json::object MissionTargetKey_object = MissionTargetKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = MissionTargetKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.MissionTargetKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = MissionTargetKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.MissionTargetKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * ReverseSigTargetKey_value_ptr = controls_object.if_contains("ReverseSigTargetKey");
        if (ReverseSigTargetKey_value_ptr != nullptr) {
            boost::json::object ReverseSigTargetKey_object = ReverseSigTargetKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = ReverseSigTargetKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.ReverseSigTargetKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = ReverseSigTargetKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.ReverseSigTargetKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * ReverseUnitTargetKey_value_ptr = controls_object.if_contains("ReverseUnitTargetKey");
        if (ReverseUnitTargetKey_value_ptr != nullptr) {
            boost::json::object ReverseUnitTargetKey_object = ReverseUnitTargetKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = ReverseUnitTargetKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.ReverseUnitTargetKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = ReverseUnitTargetKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.ReverseUnitTargetKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }
        ...
        const boost::json::value * DecelKey_value_ptr = controls_object.if_contains("DecelKey");
        if (DecelKey_value_ptr != nullptr) {
            boost::json::object DecelKey_object = DecelKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = DecelKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.DecelKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = DecelKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.DecelKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * AccelKey_value_ptr = controls_object.if_contains("AccelKey");
        if (AccelKey_value_ptr != nullptr) {
            boost::json::object AccelKey_object = AccelKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = AccelKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.AccelKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = AccelKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.AccelKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * RollLeftKey_value_ptr = controls_object.if_contains("RollLeftKey");
        if (RollLeftKey_value_ptr != nullptr) {
            boost::json::object RollLeftKey_object = RollLeftKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = RollLeftKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.RollLeftKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = RollLeftKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.RollLeftKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * RollRightKey_value_ptr = controls_object.if_contains("RollRightKey");
        if (RollRightKey_value_ptr != nullptr) {
            boost::json::object RollRightKey_object = RollRightKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = RollRightKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.RollRightKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = RollRightKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.RollRightKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * StopKey_value_ptr = controls_object.if_contains("StopKey");
        if (StopKey_value_ptr != nullptr) {
            boost::json::object StopKey_object = StopKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = StopKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.StopKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = StopKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.StopKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * StartKey_value_ptr = controls_object.if_contains("StartKey");
        if (StartKey_value_ptr != nullptr) {
            boost::json::object StartKey_object = StartKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = StartKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.StartKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = StartKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.StartKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * ABKey_value_ptr = controls_object.if_contains("ABKey");
        if (ABKey_value_ptr != nullptr) {
            boost::json::object ABKey_object = ABKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = ABKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.ABKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = ABKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.ABKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * SuicideKey_value_ptr = controls_object.if_contains("SuicideKey");
        if (SuicideKey_value_ptr != nullptr) {
            boost::json::object SuicideKey_object = SuicideKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = SuicideKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.SuicideKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = SuicideKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.SuicideKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * UpKey_value_ptr = controls_object.if_contains("UpKey");
        if (UpKey_value_ptr != nullptr) {
            boost::json::object UpKey_object = UpKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = UpKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.UpKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = UpKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.UpKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * DownKey_value_ptr = controls_object.if_contains("DownKey");
        if (DownKey_value_ptr != nullptr) {
            boost::json::object DownKey_object = DownKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = DownKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.DownKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = DownKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.DownKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * RightKey_value_ptr = controls_object.if_contains("RightKey");
        if (RightKey_value_ptr != nullptr) {
            boost::json::object RightKey_object = RightKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = RightKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.RightKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = RightKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.RightKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * LeftKey_value_ptr = controls_object.if_contains("LeftKey");
        if (LeftKey_value_ptr != nullptr) {
            boost::json::object LeftKey_object = LeftKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = LeftKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.LeftKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = LeftKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.LeftKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }
        ...
        const boost::json::value * PauseKey_value_ptr = controls_object.if_contains("PauseKey");
        if (PauseKey_value_ptr != nullptr) {
            boost::json::object PauseKey_object = PauseKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = PauseKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.PauseKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = PauseKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.PauseKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * ThrustUp_value_ptr = controls_object.if_contains("ThrustUp");
        if (ThrustUp_value_ptr != nullptr) {
            boost::json::object ThrustUp_object = ThrustUp_value_ptr->get_object();
            const boost::json::value * key_value_ptr = ThrustUp_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.ThrustUp.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = ThrustUp_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
            }
        ...
        const boost::json::value * ThrustDown_value_ptr = controls_object.if_contains("ThrustDown");
        if (ThrustDown_value_ptr != nullptr) {
            boost::json::object ThrustDown_object = ThrustDown_value_ptr->get_object();
            const boost::json::value * key_value_ptr = ThrustDown_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.ThrustDown.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = ThrustDown_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
            }
        ...
        const boost::json::value * ThrustLeft_value_ptr = controls_object.if_contains("ThrustLeft");
        if (ThrustLeft_value_ptr != nullptr) {
            boost::json::object ThrustLeft_object = ThrustLeft_value_ptr->get_object();
            const boost::json::value * key_value_ptr = ThrustLeft_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.ThrustLeft.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = ThrustLeft_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
            }
        ...
        const boost::json::value * ThrustRight_value_ptr = controls_object.if_contains("ThrustRight");
        if (ThrustRight_value_ptr != nullptr) {
            boost::json::object ThrustRight_object = ThrustRight_value_ptr->get_object();
            const boost::json::value * key_value_ptr = ThrustRight_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.ThrustRight.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = ThrustRight_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
            }
        ...
        const boost::json::value * VolumeInc_value_ptr = controls_object.if_contains("VolumeInc");
        if (VolumeInc_value_ptr != nullptr) {
            boost::json::object VolumeInc_object = VolumeInc_value_ptr->get_object();
            const boost::json::value * key_value_ptr = VolumeInc_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.VolumeInc.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = VolumeInc_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.VolumeInc.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * VolumeDec_value_ptr = controls_object.if_contains("VolumeDec");
        if (VolumeDec_value_ptr != nullptr) {
            boost::json::object VolumeDec_object = VolumeDec_value_ptr->get_object();
            const boost::json::value * key_value_ptr = VolumeDec_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.VolumeDec.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = VolumeDec_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.VolumeDec.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * MusicVolumeInc_value_ptr = controls_object.if_contains("MusicVolumeInc");
        if (MusicVolumeInc_value_ptr != nullptr) {
            boost::json::object MusicVolumeInc_object = MusicVolumeInc_value_ptr->get_object();
            const boost::json::value * key_value_ptr = MusicVolumeInc_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.MusicVolumeInc.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = MusicVolumeInc_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.MusicVolumeInc.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * MusicVolumeDec_value_ptr = controls_object.if_contains("MusicVolumeDec");
        if (MusicVolumeDec_value_ptr != nullptr) {
            boost::json::object MusicVolumeDec_object = MusicVolumeDec_value_ptr->get_object();
            const boost::json::value * key_value_ptr = MusicVolumeDec_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.MusicVolumeDec.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = MusicVolumeDec_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.MusicVolumeDec.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * NewShader_value_ptr = controls_object.if_contains("NewShader");
        if (NewShader_value_ptr != nullptr) {
            boost::json::object NewShader_object = NewShader_value_ptr->get_object();
            const boost::json::value * key_value_ptr = NewShader_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.NewShader.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = NewShader_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.NewShader.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }
        ...
        const boost::json::value * SetVelocityRefKey_value_ptr = controls_object.if_contains("SetVelocityRefKey");
        if (SetVelocityRefKey_value_ptr != nullptr) {
            boost::json::object SetVelocityRefKey_object = SetVelocityRefKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = SetVelocityRefKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.SetVelocityRefKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = SetVelocityRefKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.SetVelocityRefKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * SetVelocityNullKey_value_ptr = controls_object.if_contains("SetVelocityNullKey");
        if (SetVelocityNullKey_value_ptr != nullptr) {
            boost::json::object SetVelocityNullKey_object = SetVelocityNullKey_value_ptr->get_object();
            const boost::json::value * key_value_ptr = SetVelocityNullKey_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.SetVelocityNullKey.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = SetVelocityNullKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.SetVelocityNullKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }
        ...
        const boost::json::value * FreeSlaves_value_ptr = controls_object.if_contains("FreeSlaves");
        if (FreeSlaves_value_ptr != nullptr) {
            boost::json::object FreeSlaves_object = FreeSlaves_value_ptr->get_object();
            const boost::json::value * key_value_ptr = FreeSlaves_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.FreeSlaves.key = boost::json::value_to<std::string>(*key_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = FreeSlaves_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                controls.FreeSlaves.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


        const boost::json::value * Enslave_value_ptr = controls_object.if_contains("Enslave");
        if (Enslave_value_ptr != nullptr) {
            boost::json::object Enslave_object = Enslave_value_ptr->get_object();
            const boost::json::value * key_value_ptr = Enslave_object.if_contains("key");
            if (key_value_ptr != nullptr) {
                controls.Enslave.key = boost::json::value_to<std::string>(*key_value_ptr);
            }
        ...
        if (mouse_value_ptr != nullptr) {
            ...
            if (enabled_value_ptr != nullptr) {
                mouse.enabled = boost::json::value_to<bool>(*enabled_value_ptr);
            }

        const boost::json::value * FireKey_value_ptr = mouse_object.if_contains("FireKey");
        if (FireKey_value_ptr != nullptr) {
            boost::json::object FireKey_object = FireKey_value_ptr->get_object();
            const boost::json::value * button_value_ptr = FireKey_object.if_contains("button");
            if (button_value_ptr != nullptr) {
                mouse.FireKey.button = boost::json::value_to<int>(*button_value_ptr);
            }

            const boost::json::value * modifier_value_ptr = FireKey_object.if_contains("modifier");
            if (modifier_value_ptr != nullptr) {
                mouse.FireKey.modifier = boost::json::value_to<std::string>(*modifier_value_ptr);
            }

        }


            const boost::json::value * inverse_x_value_ptr = mouse_object.if_contains("inverse_x");
            if (inverse_x_value_ptr != nullptr) {
                mouse.inverse_x = boost::json::value_to<bool>(*inverse_x_value_ptr);
            }

            const boost::json::value * inverse_y_value_ptr = mouse_object.if_contains("inverse_y");
            if (inverse_y_value_ptr != nullptr) {
                mouse.inverse_y = boost::json::value_to<bool>(*inverse_y_value_ptr);
            }

            const boost::json::value * comment_value_ptr = mouse_object.if_contains("comment");
            if (comment_value_ptr != nullptr) {
                mouse.comment = boost::json::value_to<std::string>(*comment_value_ptr);
            }
        ...
        if (ai_value_ptr != nullptr) {
            ...
            if (ai_cheat_dot_value_ptr != nullptr) {
                ai.ai_cheat_dot_dbl = boost::json::value_to<double>(*ai_cheat_dot_value_ptr);
                ai.ai_cheat_dot_flt = boost::json::value_to<float>(*ai_cheat_dot_value_ptr);
            }
            ...
            if (anger_affects_response_value_ptr != nullptr) {
                ai.anger_affects_response_dbl = boost::json::value_to<double>(*anger_affects_response_value_ptr);
                ai.anger_affects_response_flt = boost::json::value_to<float>(*anger_affects_response_value_ptr);
            }
            ...
            if (attacker_switch_time_value_ptr != nullptr) {
                ai.attacker_switch_time_dbl = boost::json::value_to<double>(*attacker_switch_time_value_ptr);
                ai.attacker_switch_time_flt = boost::json::value_to<float>(*attacker_switch_time_value_ptr);
            }
            ...
            if (comm_initiate_time_value_ptr != nullptr) {
                ai.comm_initiate_time_dbl = boost::json::value_to<double>(*comm_initiate_time_value_ptr);
                ai.comm_initiate_time_flt = boost::json::value_to<float>(*comm_initiate_time_value_ptr);
            }
            ...
            if (comm_response_time_value_ptr != nullptr) {
                ai.comm_response_time_dbl = boost::json::value_to<double>(*comm_response_time_value_ptr);
                ai.comm_response_time_flt = boost::json::value_to<float>(*comm_response_time_value_ptr);
            }
            ...
            if (comm_to_player_percent_value_ptr != nullptr) {
                ai.comm_to_player_percent_dbl = boost::json::value_to<double>(*comm_to_player_percent_value_ptr);
                ai.comm_to_player_percent_flt = boost::json::value_to<float>(*comm_to_player_percent_value_ptr);
            }
            ...
            if (comm_to_target_percent_value_ptr != nullptr) {
                ai.comm_to_target_percent_dbl = boost::json::value_to<double>(*comm_to_target_percent_value_ptr);
                ai.comm_to_target_percent_flt = boost::json::value_to<float>(*comm_to_target_percent_value_ptr);
            }
            ...
            if (contraband_initiate_time_value_ptr != nullptr) {
                ai.contraband_initiate_time_dbl = boost::json::value_to<double>(*contraband_initiate_time_value_ptr);
                ai.contraband_initiate_time_flt = boost::json::value_to<float>(*contraband_initiate_time_value_ptr);
            }
            ...
            if (contraband_to_player_percent_value_ptr != nullptr) {
                ai.contraband_to_player_percent_dbl = boost::json::value_to<double>(*contraband_to_player_percent_value_ptr);
                ai.contraband_to_player_percent_flt = boost::json::value_to<float>(*contraband_to_player_percent_value_ptr);
            }
            ...
            if (contraband_to_target_percent_value_ptr != nullptr) {
                ai.contraband_to_target_percent_dbl = boost::json::value_to<double>(*contraband_to_target_percent_value_ptr);
                ai.contraband_to_target_percent_flt = boost::json::value_to<float>(*contraband_to_target_percent_value_ptr);
            }
            ...
            if (contraband_update_time_value_ptr != nullptr) {
                ai.contraband_update_time_dbl = boost::json::value_to<double>(*contraband_update_time_value_ptr);
                ai.contraband_update_time_flt = boost::json::value_to<float>(*contraband_update_time_value_ptr);
            }
            ...
            if (default_rank_value_ptr != nullptr) {
                ai.default_rank_dbl = boost::json::value_to<double>(*default_rank_value_ptr);
                ai.default_rank_flt = boost::json::value_to<float>(*default_rank_value_ptr);
            }
            ...
            if (ease_to_anger_value_ptr != nullptr) {
                ai.ease_to_anger_dbl = boost::json::value_to<double>(*ease_to_anger_value_ptr);
                ai.ease_to_anger_flt = boost::json::value_to<float>(*ease_to_anger_value_ptr);
            }
            ...
            if (ease_to_appease_value_ptr != nullptr) {
                ai.ease_to_appease_dbl = boost::json::value_to<double>(*ease_to_appease_value_ptr);
                ai.ease_to_appease_flt = boost::json::value_to<float>(*ease_to_appease_value_ptr);
            }
            ...
            if (evasion_angle_value_ptr != nullptr) {
                ai.evasion_angle_dbl = boost::json::value_to<double>(*evasion_angle_value_ptr);
                ai.evasion_angle_flt = boost::json::value_to<float>(*evasion_angle_value_ptr);
            }
            ...
            if (faction_contraband_relation_adjust_value_ptr != nullptr) {
                ai.faction_contraband_relation_adjust_dbl = boost::json::value_to<double>(*faction_contraband_relation_adjust_value_ptr);
                ai.faction_contraband_relation_adjust_flt = boost::json::value_to<float>(*faction_contraband_relation_adjust_value_ptr);
            }
            ...
            if (fg_nav_select_time_value_ptr != nullptr) {
                ai.fg_nav_select_time_dbl = boost::json::value_to<double>(*fg_nav_select_time_value_ptr);
                ai.fg_nav_select_time_flt = boost::json::value_to<float>(*fg_nav_select_time_value_ptr);
            }
            ...
            if (force_jump_after_time_value_ptr != nullptr) {
                ai.force_jump_after_time_dbl = boost::json::value_to<double>(*force_jump_after_time_value_ptr);
                ai.force_jump_after_time_flt = boost::json::value_to<float>(*force_jump_after_time_value_ptr);
            }

            const boost::json::value * friend_factor_value_ptr = ai_object.if_contains("friend_factor");
            if (friend_factor_value_ptr != nullptr) {
                ai.friend_factor_dbl = boost::json::value_to<double>(*friend_factor_value_ptr);
                ai.friend_factor_flt = boost::json::value_to<float>(*friend_factor_value_ptr);
            }
            ...
            if (gun_range_percent_ok_value_ptr != nullptr) {
                ai.gun_range_percent_ok_dbl = boost::json::value_to<double>(*gun_range_percent_ok_value_ptr);
                ai.gun_range_percent_ok_flt = boost::json::value_to<float>(*gun_range_percent_ok_value_ptr);
            }
            ...
            if (how_far_to_stop_navigating_value_ptr != nullptr) {
                ai.how_far_to_stop_navigating_dbl = boost::json::value_to<double>(*how_far_to_stop_navigating_value_ptr);
                ai.how_far_to_stop_navigating_flt = boost::json::value_to<float>(*how_far_to_stop_navigating_value_ptr);
            }
            ...
            if (hull_percent_for_comm_value_ptr != nullptr) {
                ai.hull_percent_for_comm_dbl = boost::json::value_to<double>(*hull_percent_for_comm_value_ptr);
                ai.hull_percent_for_comm_flt = boost::json::value_to<float>(*hull_percent_for_comm_value_ptr);
            }
            ...
            if (kill_factor_value_ptr != nullptr) {
                ai.kill_factor_dbl = boost::json::value_to<double>(*kill_factor_value_ptr);
                ai.kill_factor_flt = boost::json::value_to<float>(*kill_factor_value_ptr);
            }
            ...
            if (loop_around_destination_distance_value_ptr != nullptr) {
                ai.loop_around_destination_distance_dbl = boost::json::value_to<double>(*loop_around_destination_distance_value_ptr);
                ai.loop_around_destination_distance_flt = boost::json::value_to<float>(*loop_around_destination_distance_value_ptr);
            }
            ...
            if (loop_around_destination_lateral_value_ptr != nullptr) {
                ai.loop_around_destination_lateral_dbl = boost::json::value_to<double>(*loop_around_destination_lateral_value_ptr);
                ai.loop_around_destination_lateral_flt = boost::json::value_to<float>(*loop_around_destination_lateral_value_ptr);
            }
            ...
            if (loop_around_destination_vertical_value_ptr != nullptr) {
                ai.loop_around_destination_vertical_dbl = boost::json::value_to<double>(*loop_around_destination_vertical_value_ptr);
                ai.loop_around_destination_vertical_flt = boost::json::value_to<float>(*loop_around_destination_vertical_value_ptr);
            }
            ...
            if (loop_around_distance_value_ptr != nullptr) {
                ai.loop_around_distance_dbl = boost::json::value_to<double>(*loop_around_distance_value_ptr);
                ai.loop_around_distance_flt = boost::json::value_to<float>(*loop_around_distance_value_ptr);
            }
            ...
            if (loop_around_pursuit_velocity_percent_value_ptr != nullptr) {
                ai.loop_around_pursuit_velocity_percent_dbl = boost::json::value_to<double>(*loop_around_pursuit_velocity_percent_value_ptr);
                ai.loop_around_pursuit_velocity_percent_flt = boost::json::value_to<float>(*loop_around_pursuit_velocity_percent_value_ptr);
            }

            const boost::json::value * lurk_time_value_ptr = ai_object.if_contains("lurk_time");
            if (lurk_time_value_ptr != nullptr) {
                ai.lurk_time_dbl = boost::json::value_to<double>(*lurk_time_value_ptr);
                ai.lurk_time_flt = boost::json::value_to<float>(*lurk_time_value_ptr);
            }
            ...
            if (lowest_negative_comm_choice_value_ptr != nullptr) {
                ai.lowest_negative_comm_choice_dbl = boost::json::value_to<double>(*lowest_negative_comm_choice_value_ptr);
                ai.lowest_negative_comm_choice_flt = boost::json::value_to<float>(*lowest_negative_comm_choice_value_ptr);
            }
            ...
            if (lowest_positive_comm_choice_value_ptr != nullptr) {
                ai.lowest_positive_comm_choice_dbl = boost::json::value_to<double>(*lowest_positive_comm_choice_value_ptr);
                ai.lowest_positive_comm_choice_flt = boost::json::value_to<float>(*lowest_positive_comm_choice_value_ptr);
            }
            ...
            if (match_velocity_cone_value_ptr != nullptr) {
                ai.match_velocity_cone_dbl = boost::json::value_to<double>(*match_velocity_cone_value_ptr);
                ai.match_velocity_cone_flt = boost::json::value_to<float>(*match_velocity_cone_value_ptr);
            }
            ...
            if (max_allowable_travel_time_value_ptr != nullptr) {
                ai.max_allowable_travel_time_dbl = boost::json::value_to<double>(*max_allowable_travel_time_value_ptr);
                ai.max_allowable_travel_time_flt = boost::json::value_to<float>(*max_allowable_travel_time_value_ptr);
            }
            ...
            if (max_faction_contraband_relation_value_ptr != nullptr) {
                ai.max_faction_contraband_relation_dbl = boost::json::value_to<double>(*max_faction_contraband_relation_value_ptr);
                ai.max_faction_contraband_relation_flt = boost::json::value_to<float>(*max_faction_contraband_relation_value_ptr);
            }
            ...
            if (min_angular_accel_cheat_value_ptr != nullptr) {
                ai.min_angular_accel_cheat_dbl = boost::json::value_to<double>(*min_angular_accel_cheat_value_ptr);
                ai.min_angular_accel_cheat_flt = boost::json::value_to<float>(*min_angular_accel_cheat_value_ptr);
            }
            ...
            if (min_docking_relationship_value_ptr != nullptr) {
                ai.min_docking_relationship_dbl = boost::json::value_to<double>(*min_docking_relationship_value_ptr);
                ai.min_docking_relationship_flt = boost::json::value_to<float>(*min_docking_relationship_value_ptr);
            }
            ...
            if (min_energy_to_enter_warp_value_ptr != nullptr) {
                ai.min_energy_to_enter_warp_dbl = boost::json::value_to<double>(*min_energy_to_enter_warp_value_ptr);
                ai.min_energy_to_enter_warp_flt = boost::json::value_to<float>(*min_energy_to_enter_warp_value_ptr);
            }
            ...
            if (min_relationship_value_ptr != nullptr) {
                ai.min_relationship_dbl = boost::json::value_to<double>(*min_relationship_value_ptr);
                ai.min_relationship_flt = boost::json::value_to<float>(*min_relationship_value_ptr);
            }
            ...
            if (min_time_to_auto_value_ptr != nullptr) {
                ai.min_time_to_auto_dbl = boost::json::value_to<double>(*min_time_to_auto_value_ptr);
                ai.min_time_to_auto_flt = boost::json::value_to<float>(*min_time_to_auto_value_ptr);
            }
            ...
            if (min_warp_to_try_value_ptr != nullptr) {
                ai.min_warp_to_try_dbl = boost::json::value_to<double>(*min_warp_to_try_value_ptr);
                ai.min_warp_to_try_flt = boost::json::value_to<float>(*min_warp_to_try_value_ptr);
            }
            ...
            if (missile_gun_delay_value_ptr != nullptr) {
                ai.missile_gun_delay_dbl = boost::json::value_to<double>(*missile_gun_delay_value_ptr);
                ai.missile_gun_delay_flt = boost::json::value_to<float>(*missile_gun_delay_value_ptr);
            }
            ...
            if (mood_affects_response_value_ptr != nullptr) {
                ai.mood_affects_response_dbl = boost::json::value_to<double>(*mood_affects_response_value_ptr);
                ai.mood_affects_response_flt = boost::json::value_to<float>(*mood_affects_response_value_ptr);
            }
            ...
            if (mood_swing_level_value_ptr != nullptr) {
                ai.mood_swing_level_dbl = boost::json::value_to<double>(*mood_swing_level_value_ptr);
                ai.mood_swing_level_flt = boost::json::value_to<float>(*mood_swing_level_value_ptr);
            }
            ...
            if (percentage_speed_change_to_stop_search_value_ptr != nullptr) {
                ai.percentage_speed_change_to_stop_search_dbl = boost::json::value_to<double>(*percentage_speed_change_to_stop_search_value_ptr);
                ai.percentage_speed_change_to_stop_search_flt = boost::json::value_to<float>(*percentage_speed_change_to_stop_search_value_ptr);
            }
            ...
            if (pirate_bonus_for_empty_hold_value_ptr != nullptr) {
                ai.pirate_bonus_for_empty_hold_dbl = boost::json::value_to<double>(*pirate_bonus_for_empty_hold_value_ptr);
                ai.pirate_bonus_for_empty_hold_flt = boost::json::value_to<float>(*pirate_bonus_for_empty_hold_value_ptr);
            }
            ...
            if (pirate_nav_select_time_value_ptr != nullptr) {
                ai.pirate_nav_select_time_dbl = boost::json::value_to<double>(*pirate_nav_select_time_value_ptr);
                ai.pirate_nav_select_time_flt = boost::json::value_to<float>(*pirate_nav_select_time_value_ptr);
            }
            ...
            if (random_response_range_value_ptr != nullptr) {
                ai.random_response_range_dbl = boost::json::value_to<double>(*random_response_range_value_ptr);
                ai.random_response_range_flt = boost::json::value_to<float>(*random_response_range_value_ptr);
            }
            ...
            if (random_spacing_factor_value_ptr != nullptr) {
                ai.random_spacing_factor_dbl = boost::json::value_to<double>(*random_spacing_factor_value_ptr);
                ai.random_spacing_factor_flt = boost::json::value_to<float>(*random_spacing_factor_value_ptr);
            }

            const boost::json::value * reaction_time_value_ptr = ai_object.if_contains("reaction_time");
            if (reaction_time_value_ptr != nullptr) {
                ai.reaction_time_dbl = boost::json::value_to<double>(*reaction_time_value_ptr);
                ai.reaction_time_flt = boost::json::value_to<float>(*reaction_time_value_ptr);
            }
            ...
            if (resistance_to_side_force_percent_value_ptr != nullptr) {
                ai.resistance_to_side_force_percent_dbl = boost::json::value_to<double>(*resistance_to_side_force_percent_value_ptr);
                ai.resistance_to_side_force_percent_flt = boost::json::value_to<float>(*resistance_to_side_force_percent_value_ptr);
            }
            ...
            if (resistance_to_side_movement_percent_value_ptr != nullptr) {
                ai.resistance_to_side_movement_percent_dbl = boost::json::value_to<double>(*resistance_to_side_movement_percent_value_ptr);
                ai.resistance_to_side_movement_percent_flt = boost::json::value_to<float>(*resistance_to_side_movement_percent_value_ptr);
            }
            ...
            if (roll_order_duration_value_ptr != nullptr) {
                ai.roll_order_duration_dbl = boost::json::value_to<double>(*roll_order_duration_value_ptr);
                ai.roll_order_duration_flt = boost::json::value_to<float>(*roll_order_duration_value_ptr);
            }

            const boost::json::value * safety_spacing_value_ptr = ai_object.if_contains("safety_spacing");
            if (safety_spacing_value_ptr != nullptr) {
                ai.safety_spacing_dbl = boost::json::value_to<double>(*safety_spacing_value_ptr);
                ai.safety_spacing_flt = boost::json::value_to<float>(*safety_spacing_value_ptr);
            }
            ...
            if (slow_diplomacy_for_enemies_value_ptr != nullptr) {
                ai.slow_diplomacy_for_enemies_dbl = boost::json::value_to<double>(*slow_diplomacy_for_enemies_value_ptr);
                ai.slow_diplomacy_for_enemies_flt = boost::json::value_to<float>(*slow_diplomacy_for_enemies_value_ptr);
            }
            ...
            if (static_relationship_affects_response_value_ptr != nullptr) {
                ai.static_relationship_affects_response_dbl = boost::json::value_to<double>(*static_relationship_affects_response_value_ptr);
                ai.static_relationship_affects_response_flt = boost::json::value_to<float>(*static_relationship_affects_response_value_ptr);
            }
            ...
            if (talk_relation_factor_value_ptr != nullptr) {
                ai.talk_relation_factor_dbl = boost::json::value_to<double>(*talk_relation_factor_value_ptr);
                ai.talk_relation_factor_flt = boost::json::value_to<float>(*talk_relation_factor_value_ptr);
            }
            ...
            if (too_close_for_warp_in_formation_value_ptr != nullptr) {
                ai.too_close_for_warp_in_formation_dbl = boost::json::value_to<double>(*too_close_for_warp_in_formation_value_ptr);
                ai.too_close_for_warp_in_formation_flt = boost::json::value_to<float>(*too_close_for_warp_in_formation_value_ptr);
            }
            ...
            if (too_close_for_warp_tactic_value_ptr != nullptr) {
                ai.too_close_for_warp_tactic_dbl = boost::json::value_to<double>(*too_close_for_warp_tactic_value_ptr);
                ai.too_close_for_warp_tactic_flt = boost::json::value_to<float>(*too_close_for_warp_tactic_value_ptr);
            }
            ...
            if (unknown_relation_enemy_value_ptr != nullptr) {
                ai.unknown_relation_enemy_dbl = boost::json::value_to<double>(*unknown_relation_enemy_value_ptr);
                ai.unknown_relation_enemy_flt = boost::json::value_to<float>(*unknown_relation_enemy_value_ptr);
            }
            ...
            if (unknown_relation_hit_cost_value_ptr != nullptr) {
                ai.unknown_relation_hit_cost_dbl = boost::json::value_to<double>(*unknown_relation_hit_cost_value_ptr);
                ai.unknown_relation_hit_cost_flt = boost::json::value_to<float>(*unknown_relation_hit_cost_value_ptr);
            }
            ...
            if (warp_cone_value_ptr != nullptr) {
                ai.warp_cone_dbl = boost::json::value_to<double>(*warp_cone_value_ptr);
                ai.warp_cone_flt = boost::json::value_to<float>(*warp_cone_value_ptr);
            }
        ...
        if (firing_value_ptr != nullptr) {
            ...
            if (aggressivity_value_ptr != nullptr) {
                ai.firing.aggressivity_dbl = boost::json::value_to<double>(*aggressivity_value_ptr);
                ai.firing.aggressivity_flt = boost::json::value_to<float>(*aggressivity_value_ptr);
            }
            ...
            if (in_weapon_range_value_ptr != nullptr) {
                ai.firing.in_weapon_range_dbl = boost::json::value_to<double>(*in_weapon_range_value_ptr);
                ai.firing.in_weapon_range_flt = boost::json::value_to<float>(*in_weapon_range_value_ptr);
            }
            ...
            if (missile_probability_value_ptr != nullptr) {
                ai.firing.missile_probability_dbl = boost::json::value_to<double>(*missile_probability_value_ptr);
                ai.firing.missile_probability_flt = boost::json::value_to<float>(*missile_probability_value_ptr);
            }

            const boost::json::value * reaction_time_value_ptr = firing_object.if_contains("reaction_time");
            if (reaction_time_value_ptr != nullptr) {
                ai.firing.reaction_time_dbl = boost::json::value_to<double>(*reaction_time_value_ptr);
                ai.firing.reaction_time_flt = boost::json::value_to<float>(*reaction_time_value_ptr);
            }
            ...
            if (turret_dot_cutoff_value_ptr != nullptr) {
                ai.firing.turret_dot_cutoff_dbl = boost::json::value_to<double>(*turret_dot_cutoff_value_ptr);
                ai.firing.turret_dot_cutoff_flt = boost::json::value_to<float>(*turret_dot_cutoff_value_ptr);
            }
            ...
            if (turret_missile_probability_value_ptr != nullptr) {
                ai.firing.turret_missile_probability_dbl = boost::json::value_to<double>(*turret_missile_probability_value_ptr);
                ai.firing.turret_missile_probability_flt = boost::json::value_to<float>(*turret_missile_probability_value_ptr);
            }
        ...
        if (targeting_value_ptr != nullptr) {
            ...
            if (escort_distance_value_ptr != nullptr) {
                ai.targeting.escort_distance_dbl = boost::json::value_to<double>(*escort_distance_value_ptr);
                ai.targeting.escort_distance_flt = boost::json::value_to<float>(*escort_distance_value_ptr);
            }
            ...
            if (mass_inertial_priority_cutoff_value_ptr != nullptr) {
                ai.targeting.mass_inertial_priority_cutoff_dbl = boost::json::value_to<double>(*mass_inertial_priority_cutoff_value_ptr);
                ai.targeting.mass_inertial_priority_cutoff_flt = boost::json::value_to<float>(*mass_inertial_priority_cutoff_value_ptr);
            }
            ...
            if (mass_inertial_priority_scale_value_ptr != nullptr) {
                ai.targeting.mass_inertial_priority_scale_dbl = boost::json::value_to<double>(*mass_inertial_priority_scale_value_ptr);
                ai.targeting.mass_inertial_priority_scale_flt = boost::json::value_to<float>(*mass_inertial_priority_scale_value_ptr);
            }
            ...
            if (min_time_to_switch_targets_value_ptr != nullptr) {
                ai.targeting.min_time_to_switch_targets_dbl = boost::json::value_to<double>(*min_time_to_switch_targets_value_ptr);
                ai.targeting.min_time_to_switch_targets_flt = boost::json::value_to<float>(*min_time_to_switch_targets_value_ptr);
            }
            ...
            if (min_null_time_to_switch_targets_value_ptr != nullptr) {
                ai.targeting.min_null_time_to_switch_targets_dbl = boost::json::value_to<double>(*min_null_time_to_switch_targets_value_ptr);
                ai.targeting.min_null_time_to_switch_targets_flt = boost::json::value_to<float>(*min_null_time_to_switch_targets_value_ptr);
            }
            ...
            if (mountless_gun_range_value_ptr != nullptr) {
                ai.targeting.mountless_gun_range_dbl = boost::json::value_to<double>(*mountless_gun_range_value_ptr);
                ai.targeting.mountless_gun_range_flt = boost::json::value_to<float>(*mountless_gun_range_value_ptr);
            }

            const boost::json::value * obedience_value_ptr = targeting_object.if_contains("obedience");
            if (obedience_value_ptr != nullptr) {
                ai.targeting.obedience_dbl = boost::json::value_to<double>(*obedience_value_ptr);
                ai.targeting.obedience_flt = boost::json::value_to<float>(*obedience_value_ptr);
            }
            ...
            if (search_extra_radius_value_ptr != nullptr) {
                ai.targeting.search_extra_radius_dbl = boost::json::value_to<double>(*search_extra_radius_value_ptr);
                ai.targeting.search_extra_radius_flt = boost::json::value_to<float>(*search_extra_radius_value_ptr);
            }
            ...
            if (threat_weight_value_ptr != nullptr) {
                ai.targeting.threat_weight_dbl = boost::json::value_to<double>(*threat_weight_value_ptr);
                ai.targeting.threat_weight_flt = boost::json::value_to<float>(*threat_weight_value_ptr);
            }
            ...
            if (time_to_recommand_wing_value_ptr != nullptr) {
                ai.targeting.time_to_recommand_wing_dbl = boost::json::value_to<double>(*time_to_recommand_wing_value_ptr);
                ai.targeting.time_to_recommand_wing_flt = boost::json::value_to<float>(*time_to_recommand_wing_value_ptr);
            }
            ...
            if (time_until_switch_value_ptr != nullptr) {
                ai.targeting.time_until_switch_dbl = boost::json::value_to<double>(*time_until_switch_value_ptr);
                ai.targeting.time_until_switch_flt = boost::json::value_to<float>(*time_until_switch_value_ptr);
            }
            ...
            if (turn_leader_distance_value_ptr != nullptr) {
                ai.targeting.turn_leader_distance_dbl = boost::json::value_to<double>(*turn_leader_distance_value_ptr);
                ai.targeting.turn_leader_distance_flt = boost::json::value_to<float>(*turn_leader_distance_value_ptr);
            }
        ...
        if (audio_value_ptr != nullptr) {
            ...
            if (afterburner_gain_value_ptr != nullptr) {
                audio.afterburner_gain_dbl = boost::json::value_to<double>(*afterburner_gain_value_ptr);
                audio.afterburner_gain_flt = boost::json::value_to<float>(*afterburner_gain_value_ptr);
            }
            ...
            if (audio_max_distance_value_ptr != nullptr) {
                audio.audio_max_distance_dbl = boost::json::value_to<double>(*audio_max_distance_value_ptr);
                audio.audio_max_distance_flt = boost::json::value_to<float>(*audio_max_distance_value_ptr);
            }
            ...
            if (audio_ref_distance_value_ptr != nullptr) {
                audio.audio_ref_distance_dbl = boost::json::value_to<double>(*audio_ref_distance_value_ptr);
                audio.audio_ref_distance_flt = boost::json::value_to<float>(*audio_ref_distance_value_ptr);
            }
            ...
            if (buzzing_distance_value_ptr != nullptr) {
                audio.buzzing_distance_dbl = boost::json::value_to<double>(*buzzing_distance_value_ptr);
                audio.buzzing_distance_flt = boost::json::value_to<float>(*buzzing_distance_value_ptr);
            }
            ...
            if (buzzing_time_value_ptr != nullptr) {
                audio.buzzing_time_dbl = boost::json::value_to<double>(*buzzing_time_value_ptr);
                audio.buzzing_time_flt = boost::json::value_to<float>(*buzzing_time_value_ptr);
            }
            ...
            if (doppler_scale_value_ptr != nullptr) {
                audio.doppler_scale_dbl = boost::json::value_to<double>(*doppler_scale_value_ptr);
                audio.doppler_scale_flt = boost::json::value_to<float>(*doppler_scale_value_ptr);
            }
            ...
            if (explosion_closeness_value_ptr != nullptr) {
                audio.explosion_closeness_dbl = boost::json::value_to<double>(*explosion_closeness_value_ptr);
                audio.explosion_closeness_flt = boost::json::value_to<float>(*explosion_closeness_value_ptr);
            }
            ...
            if (exterior_weapon_gain_value_ptr != nullptr) {
                audio.exterior_weapon_gain_dbl = boost::json::value_to<double>(*exterior_weapon_gain_value_ptr);
                audio.exterior_weapon_gain_flt = boost::json::value_to<float>(*exterior_weapon_gain_value_ptr);
            }
            ...
            if (loss_relationship_value_ptr != nullptr) {
                audio.loss_relationship_dbl = boost::json::value_to<double>(*loss_relationship_value_ptr);
                audio.loss_relationship_flt = boost::json::value_to<float>(*loss_relationship_value_ptr);
            }
            ...
            if (max_range_to_hear_weapon_fire_value_ptr != nullptr) {
                audio.max_range_to_hear_weapon_fire_dbl = boost::json::value_to<double>(*max_range_to_hear_weapon_fire_value_ptr);
                audio.max_range_to_hear_weapon_fire_flt = boost::json::value_to<float>(*max_range_to_hear_weapon_fire_value_ptr);
            }
            ...
            if (min_weapon_sound_refire_value_ptr != nullptr) {
                audio.min_weapon_sound_refire_dbl = boost::json::value_to<double>(*min_weapon_sound_refire_value_ptr);
                audio.min_weapon_sound_refire_flt = boost::json::value_to<float>(*min_weapon_sound_refire_value_ptr);
            }
            ...
            if (music_muting_fade_in_value_ptr != nullptr) {
                audio.music_muting_fade_in_dbl = boost::json::value_to<double>(*music_muting_fade_in_value_ptr);
                audio.music_muting_fade_in_flt = boost::json::value_to<float>(*music_muting_fade_in_value_ptr);
            }
            ...
            if (music_muting_fade_out_value_ptr != nullptr) {
                audio.music_muting_fade_out_dbl = boost::json::value_to<double>(*music_muting_fade_out_value_ptr);
                audio.music_muting_fade_out_flt = boost::json::value_to<float>(*music_muting_fade_out_value_ptr);
            }

            const boost::json::value * music_volume_value_ptr = audio_object.if_contains("music_volume");
            if (music_volume_value_ptr != nullptr) {
                audio.music_volume_dbl = boost::json::value_to<double>(*music_volume_value_ptr);
                audio.music_volume_flt = boost::json::value_to<float>(*music_volume_value_ptr);
            }
            ...
            if (music_volume_down_latency_value_ptr != nullptr) {
                audio.music_volume_down_latency_dbl = boost::json::value_to<double>(*music_volume_down_latency_value_ptr);
                audio.music_volume_down_latency_flt = boost::json::value_to<float>(*music_volume_down_latency_value_ptr);
            }
            ...
            if (music_volume_up_latency_value_ptr != nullptr) {
                audio.music_volume_up_latency_dbl = boost::json::value_to<double>(*music_volume_up_latency_value_ptr);
                audio.music_volume_up_latency_flt = boost::json::value_to<float>(*music_volume_up_latency_value_ptr);
            }
            ...
            if (sound_gain_value_ptr != nullptr) {
                audio.sound_gain_dbl = boost::json::value_to<double>(*sound_gain_value_ptr);
                audio.sound_gain_flt = boost::json::value_to<float>(*sound_gain_value_ptr);
            }
            ...
            if (time_between_music_value_ptr != nullptr) {
                audio.time_between_music_dbl = boost::json::value_to<double>(*time_between_music_value_ptr);
                audio.time_between_music_flt = boost::json::value_to<float>(*time_between_music_value_ptr);
            }
            ...
            if (victory_relationship_value_ptr != nullptr) {
                audio.victory_relationship_dbl = boost::json::value_to<double>(*victory_relationship_value_ptr);
                audio.victory_relationship_flt = boost::json::value_to<float>(*victory_relationship_value_ptr);
            }

            const boost::json::value * volume_value_ptr = audio_object.if_contains("volume");
            if (volume_value_ptr != nullptr) {
                audio.volume_dbl = boost::json::value_to<double>(*volume_value_ptr);
                audio.volume_flt = boost::json::value_to<float>(*volume_value_ptr);
            }

            const boost::json::value * weapon_gain_value_ptr = audio_object.if_contains("weapon_gain");
            if (weapon_gain_value_ptr != nullptr) {
                audio.weapon_gain_dbl = boost::json::value_to<double>(*weapon_gain_value_ptr);
                audio.weapon_gain_flt = boost::json::value_to<float>(*weapon_gain_value_ptr);
            }
        ...
        if (cargo_value_ptr != nullptr) {
            ...
            if (junk_starship_mass_value_ptr != nullptr) {
                cargo.junk_starship_mass_dbl = boost::json::value_to<double>(*junk_starship_mass_value_ptr);
                cargo.junk_starship_mass_flt = boost::json::value_to<float>(*junk_starship_mass_value_ptr);
            }
            ...
            if (junk_starship_price_value_ptr != nullptr) {
                cargo.junk_starship_price_dbl = boost::json::value_to<double>(*junk_starship_price_value_ptr);
                cargo.junk_starship_price_flt = boost::json::value_to<float>(*junk_starship_price_value_ptr);
            }
            ...
            if (junk_starship_volume_value_ptr != nullptr) {
                cargo.junk_starship_volume_dbl = boost::json::value_to<double>(*junk_starship_volume_value_ptr);
                cargo.junk_starship_volume_flt = boost::json::value_to<float>(*junk_starship_volume_value_ptr);
            }
            ...
            if (max_price_quant_adj_value_ptr != nullptr) {
                cargo.max_price_quant_adj_dbl = boost::json::value_to<double>(*max_price_quant_adj_value_ptr);
                cargo.max_price_quant_adj_flt = boost::json::value_to<float>(*max_price_quant_adj_value_ptr);
            }
            ...
            if (min_cargo_price_value_ptr != nullptr) {
                cargo.min_cargo_price_dbl = boost::json::value_to<double>(*min_cargo_price_value_ptr);
                cargo.min_cargo_price_flt = boost::json::value_to<float>(*min_cargo_price_value_ptr);
            }
            ...
            if (min_price_quant_adj_value_ptr != nullptr) {
                cargo.min_price_quant_adj_dbl = boost::json::value_to<double>(*min_price_quant_adj_value_ptr);
                cargo.min_price_quant_adj_flt = boost::json::value_to<float>(*min_price_quant_adj_value_ptr);
            }
            ...
            if (price_quant_adj_power_value_ptr != nullptr) {
                cargo.price_quant_adj_power_dbl = boost::json::value_to<double>(*price_quant_adj_power_value_ptr);
                cargo.price_quant_adj_power_flt = boost::json::value_to<float>(*price_quant_adj_power_value_ptr);
            }
            ...
            if (price_recenter_factor_value_ptr != nullptr) {
                cargo.price_recenter_factor_dbl = boost::json::value_to<double>(*price_recenter_factor_value_ptr);
                cargo.price_recenter_factor_flt = boost::json::value_to<float>(*price_recenter_factor_value_ptr);
            }
            ...
            if (space_junk_price_value_ptr != nullptr) {
                cargo.space_junk_price_dbl = boost::json::value_to<double>(*space_junk_price_value_ptr);
                cargo.space_junk_price_flt = boost::json::value_to<float>(*space_junk_price_value_ptr);
            }
        ...
        if (collision_hacks_value_ptr != nullptr) {
            ...
            if (collision_hack_distance_value_ptr != nullptr) {
                collision_hacks.collision_hack_distance_dbl = boost::json::value_to<double>(*collision_hack_distance_value_ptr);
                collision_hacks.collision_hack_distance_flt = boost::json::value_to<float>(*collision_hack_distance_value_ptr);
            }
            ...
            if (front_collision_hack_angle_value_ptr != nullptr) {
                collision_hacks.front_collision_hack_angle_dbl = boost::json::value_to<double>(*front_collision_hack_angle_value_ptr);
                collision_hacks.front_collision_hack_angle_flt = boost::json::value_to<float>(*front_collision_hack_angle_value_ptr);
            }
            ...
            if (front_collision_hack_distance_value_ptr != nullptr) {
                collision_hacks.front_collision_hack_distance_dbl = boost::json::value_to<double>(*front_collision_hack_distance_value_ptr);
                collision_hacks.front_collision_hack_distance_flt = boost::json::value_to<float>(*front_collision_hack_distance_value_ptr);
            }
        ...
        if (computer_value_ptr != nullptr) {
            ...
            if (default_lock_cone_value_ptr != nullptr) {
                components.computer.default_lock_cone_dbl = boost::json::value_to<double>(*default_lock_cone_value_ptr);
                components.computer.default_lock_cone_flt = boost::json::value_to<float>(*default_lock_cone_value_ptr);
            }
            ...
            if (default_max_range_value_ptr != nullptr) {
                components.computer.default_max_range_dbl = boost::json::value_to<double>(*default_max_range_value_ptr);
                components.computer.default_max_range_flt = boost::json::value_to<float>(*default_max_range_value_ptr);
            }
            ...
            if (default_tracking_cone_value_ptr != nullptr) {
                components.computer.default_tracking_cone_dbl = boost::json::value_to<double>(*default_tracking_cone_value_ptr);
                components.computer.default_tracking_cone_flt = boost::json::value_to<float>(*default_tracking_cone_value_ptr);
            }
        ...
        if (drive_value_ptr != nullptr) {
            ...
            if (minimum_drive_value_ptr != nullptr) {
                components.drive.minimum_drive_dbl = boost::json::value_to<double>(*minimum_drive_value_ptr);
                components.drive.minimum_drive_flt = boost::json::value_to<float>(*minimum_drive_value_ptr);
            }
        ...
        if (fuel_value_ptr != nullptr) {
            ...
            if (afterburner_fuel_usage_value_ptr != nullptr) {
                components.fuel.afterburner_fuel_usage_dbl = boost::json::value_to<double>(*afterburner_fuel_usage_value_ptr);
                components.fuel.afterburner_fuel_usage_flt = boost::json::value_to<float>(*afterburner_fuel_usage_value_ptr);
            }
            ...
            if (deuterium_relative_efficiency_lithium_value_ptr != nullptr) {
                components.fuel.deuterium_relative_efficiency_lithium_dbl = boost::json::value_to<double>(*deuterium_relative_efficiency_lithium_value_ptr);
                components.fuel.deuterium_relative_efficiency_lithium_flt = boost::json::value_to<float>(*deuterium_relative_efficiency_lithium_value_ptr);
            }
            ...
            if (ecm_energy_cost_value_ptr != nullptr) {
                components.fuel.ecm_energy_cost_dbl = boost::json::value_to<double>(*ecm_energy_cost_value_ptr);
                components.fuel.ecm_energy_cost_flt = boost::json::value_to<float>(*ecm_energy_cost_value_ptr);
            }

            const boost::json::value * fmec_factor_value_ptr = fuel_object.if_contains("fmec_factor");
            if (fmec_factor_value_ptr != nullptr) {
                components.fuel.fmec_factor_dbl = boost::json::value_to<double>(*fmec_factor_value_ptr);
                components.fuel.fmec_factor_flt = boost::json::value_to<float>(*fmec_factor_value_ptr);
            }
            ...
            if (fuel_efficiency_value_ptr != nullptr) {
                components.fuel.fuel_efficiency_dbl = boost::json::value_to<double>(*fuel_efficiency_value_ptr);
                components.fuel.fuel_efficiency_flt = boost::json::value_to<float>(*fuel_efficiency_value_ptr);
            }
            ...
            if (megajoules_factor_value_ptr != nullptr) {
                components.fuel.megajoules_factor_dbl = boost::json::value_to<double>(*megajoules_factor_value_ptr);
                components.fuel.megajoules_factor_flt = boost::json::value_to<float>(*megajoules_factor_value_ptr);
            }
            ...
            if (min_reactor_efficiency_value_ptr != nullptr) {
                components.fuel.min_reactor_efficiency_dbl = boost::json::value_to<double>(*min_reactor_efficiency_value_ptr);
                components.fuel.min_reactor_efficiency_flt = boost::json::value_to<float>(*min_reactor_efficiency_value_ptr);
            }
            ...
            if (no_fuel_afterburn_value_ptr != nullptr) {
                components.fuel.no_fuel_afterburn_dbl = boost::json::value_to<double>(*no_fuel_afterburn_value_ptr);
                components.fuel.no_fuel_afterburn_flt = boost::json::value_to<float>(*no_fuel_afterburn_value_ptr);
            }
            ...
            if (no_fuel_thrust_value_ptr != nullptr) {
                components.fuel.no_fuel_thrust_dbl = boost::json::value_to<double>(*no_fuel_thrust_value_ptr);
                components.fuel.no_fuel_thrust_flt = boost::json::value_to<float>(*no_fuel_thrust_value_ptr);
            }
            ...
            if (normal_fuel_usage_value_ptr != nullptr) {
                components.fuel.normal_fuel_usage_dbl = boost::json::value_to<double>(*normal_fuel_usage_value_ptr);
                components.fuel.normal_fuel_usage_flt = boost::json::value_to<float>(*normal_fuel_usage_value_ptr);
            }
            ...
            if (reactor_idle_efficiency_value_ptr != nullptr) {
                components.fuel.reactor_idle_efficiency_dbl = boost::json::value_to<double>(*reactor_idle_efficiency_value_ptr);
                components.fuel.reactor_idle_efficiency_flt = boost::json::value_to<float>(*reactor_idle_efficiency_value_ptr);
            }
            ...
            if (vsd_mj_yield_value_ptr != nullptr) {
                components.fuel.vsd_mj_yield_dbl = boost::json::value_to<double>(*vsd_mj_yield_value_ptr);
                components.fuel.vsd_mj_yield_flt = boost::json::value_to<float>(*vsd_mj_yield_value_ptr);
            }
        ...
        if (ftl_drive_value_ptr != nullptr) {
            ...
            if (factor_value_ptr != nullptr) {
                components.ftl_drive.factor_dbl = boost::json::value_to<double>(*factor_value_ptr);
                components.ftl_drive.factor_flt = boost::json::value_to<float>(*factor_value_ptr);
            }
        ...
        if (ftl_energy_value_ptr != nullptr) {
            ...
            if (factor_value_ptr != nullptr) {
                components.ftl_energy.factor_dbl = boost::json::value_to<double>(*factor_value_ptr);
                components.ftl_energy.factor_flt = boost::json::value_to<float>(*factor_value_ptr);
            }
        ...
        if (jump_drive_value_ptr != nullptr) {
            ...
            if (factor_value_ptr != nullptr) {
                components.jump_drive.factor_dbl = boost::json::value_to<double>(*factor_value_ptr);
                components.jump_drive.factor_flt = boost::json::value_to<float>(*factor_value_ptr);
            }
        ...
        if (reactor_value_ptr != nullptr) {
            ...
            if (factor_value_ptr != nullptr) {
                components.reactor.factor_dbl = boost::json::value_to<double>(*factor_value_ptr);
                components.reactor.factor_flt = boost::json::value_to<float>(*factor_value_ptr);
            }
        ...
        if (shield_value_ptr != nullptr) {
            ...
            if (maintenance_factor_value_ptr != nullptr) {
                components.shield.maintenance_factor_dbl = boost::json::value_to<double>(*maintenance_factor_value_ptr);
                components.shield.maintenance_factor_flt = boost::json::value_to<float>(*maintenance_factor_value_ptr);
            }
            ...
            if (regeneration_factor_value_ptr != nullptr) {
                components.shield.regeneration_factor_dbl = boost::json::value_to<double>(*regeneration_factor_value_ptr);
                components.shield.regeneration_factor_flt = boost::json::value_to<float>(*regeneration_factor_value_ptr);
            }
        ...
        if (dock_value_ptr != nullptr) {
            ...
            if (count_to_dock_range_value_ptr != nullptr) {
                dock.count_to_dock_range_dbl = boost::json::value_to<double>(*count_to_dock_range_value_ptr);
                dock.count_to_dock_range_flt = boost::json::value_to<float>(*count_to_dock_range_value_ptr);
            }
            ...
            if (dock_planet_radius_percent_value_ptr != nullptr) {
                dock.dock_planet_radius_percent_dbl = boost::json::value_to<double>(*dock_planet_radius_percent_value_ptr);
                dock.dock_planet_radius_percent_flt = boost::json::value_to<float>(*dock_planet_radius_percent_value_ptr);
            }
            ...
            if (planet_dock_port_min_size_value_ptr != nullptr) {
                dock.planet_dock_port_min_size_dbl = boost::json::value_to<double>(*planet_dock_port_min_size_value_ptr);
            ...
            if (simple_dock_range_value_ptr != nullptr) {
                ...
                dock.simple_dock_range_flt = boost::json::value_to<float>(*simple_dock_range_value_ptr);
            }
        ...
        if (economics_value_ptr != nullptr) {
            ...
            if (ship_sellback_price_value_ptr != nullptr) {
                ...
                economics.ship_sellback_price_flt = boost::json::value_to<float>(*ship_sellback_price_value_ptr);
            }
            ...
            if (shipping_price_base_value_ptr != nullptr) {
                economics.shipping_price_base_dbl = boost::json::value_to<double>(*shipping_price_base_value_ptr);
                economics.shipping_price_base_flt = boost::json::value_to<float>(*shipping_price_base_value_ptr);
            }
            ...
            if (shipping_price_insys_value_ptr != nullptr) {
                economics.shipping_price_insys_dbl = boost::json::value_to<double>(*shipping_price_insys_value_ptr);
                economics.shipping_price_insys_flt = boost::json::value_to<float>(*shipping_price_insys_value_ptr);
            }
            ...
            if (shipping_price_perjump_value_ptr != nullptr) {
                economics.shipping_price_perjump_dbl = boost::json::value_to<double>(*shipping_price_perjump_value_ptr);
                economics.shipping_price_perjump_flt = boost::json::value_to<float>(*shipping_price_perjump_value_ptr);
            }
        ...
        if (galaxy_value_ptr != nullptr) {
            ...
            if (ambient_light_factor_value_ptr != nullptr) {
                galaxy.ambient_light_factor_dbl = boost::json::value_to<double>(*ambient_light_factor_value_ptr);
                galaxy.ambient_light_factor_flt = boost::json::value_to<float>(*ambient_light_factor_value_ptr);
            }
            ...
            if (atmosphere_probability_value_ptr != nullptr) {
                galaxy.atmosphere_probability_dbl = boost::json::value_to<double>(*atmosphere_probability_value_ptr);
                galaxy.atmosphere_probability_flt = boost::json::value_to<float>(*atmosphere_probability_value_ptr);
            }
            ...
            if (compactness_scale_value_ptr != nullptr) {
                galaxy.compactness_scale_dbl = boost::json::value_to<double>(*compactness_scale_value_ptr);
                galaxy.compactness_scale_flt = boost::json::value_to<float>(*compactness_scale_value_ptr);
            }
            ...
            if (double_ring_probability_value_ptr != nullptr) {
                galaxy.double_ring_probability_dbl = boost::json::value_to<double>(*double_ring_probability_value_ptr);
                galaxy.double_ring_probability_flt = boost::json::value_to<float>(*double_ring_probability_value_ptr);
            }
            ...
            if (inner_ring_radius_value_ptr != nullptr) {
                galaxy.inner_ring_radius_dbl = boost::json::value_to<double>(*inner_ring_radius_value_ptr);
                galaxy.inner_ring_radius_flt = boost::json::value_to<float>(*inner_ring_radius_value_ptr);
            }
            ...
            if (jump_compactness_scale_value_ptr != nullptr) {
                galaxy.jump_compactness_scale_dbl = boost::json::value_to<double>(*jump_compactness_scale_value_ptr);
                galaxy.jump_compactness_scale_flt = boost::json::value_to<float>(*jump_compactness_scale_value_ptr);
            }
            ...
            if (moon_relative_to_moon_value_ptr != nullptr) {
                galaxy.moon_relative_to_moon_dbl = boost::json::value_to<double>(*moon_relative_to_moon_value_ptr);
                galaxy.moon_relative_to_moon_flt = boost::json::value_to<float>(*moon_relative_to_moon_value_ptr);
            }
            ...
            if (moon_relative_to_planet_value_ptr != nullptr) {
                galaxy.moon_relative_to_planet_dbl = boost::json::value_to<double>(*moon_relative_to_planet_value_ptr);
                galaxy.moon_relative_to_planet_flt = boost::json::value_to<float>(*moon_relative_to_planet_value_ptr);
            }
            ...
            if (outer_ring_radius_value_ptr != nullptr) {
                galaxy.outer_ring_radius_dbl = boost::json::value_to<double>(*outer_ring_radius_value_ptr);
                galaxy.outer_ring_radius_flt = boost::json::value_to<float>(*outer_ring_radius_value_ptr);
            }
            ...
            if (ring_probability_value_ptr != nullptr) {
                galaxy.ring_probability_dbl = boost::json::value_to<double>(*ring_probability_value_ptr);
                galaxy.ring_probability_flt = boost::json::value_to<float>(*ring_probability_value_ptr);
            }
            ...
            if (rocky_relative_to_primary_value_ptr != nullptr) {
                galaxy.rocky_relative_to_primary_dbl = boost::json::value_to<double>(*rocky_relative_to_primary_value_ptr);
                galaxy.rocky_relative_to_primary_flt = boost::json::value_to<float>(*rocky_relative_to_primary_value_ptr);
            }
            ...
            if (second_ring_difference_value_ptr != nullptr) {
                galaxy.second_ring_difference_dbl = boost::json::value_to<double>(*second_ring_difference_value_ptr);
                galaxy.second_ring_difference_flt = boost::json::value_to<float>(*second_ring_difference_value_ptr);
            }
            ...
            if (star_radius_scale_value_ptr != nullptr) {
                galaxy.star_radius_scale_dbl = boost::json::value_to<double>(*star_radius_scale_value_ptr);
                galaxy.star_radius_scale_flt = boost::json::value_to<float>(*star_radius_scale_value_ptr);
            }
        ...
        if (general_value_ptr != nullptr) {
            ...
            if (audio_atom_value_ptr != nullptr) {
                general.audio_atom_dbl = boost::json::value_to<double>(*audio_atom_value_ptr);
                general.audio_atom_flt = boost::json::value_to<float>(*audio_atom_value_ptr);
            }
            ...
            if (docking_fee_value_ptr != nullptr) {
                general.docking_fee_dbl = boost::json::value_to<double>(*docking_fee_value_ptr);
                general.docking_fee_flt = boost::json::value_to<float>(*docking_fee_value_ptr);
            }

            const boost::json::value * docking_time_value_ptr = general_object.if_contains("docking_time");
            if (docking_time_value_ptr != nullptr) {
                general.docking_time_dbl = boost::json::value_to<double>(*docking_time_value_ptr);
                general.docking_time_flt = boost::json::value_to<float>(*docking_time_value_ptr);
            }
            ...
            if (fuel_docking_fee_value_ptr != nullptr) {
                general.fuel_docking_fee_dbl = boost::json::value_to<double>(*fuel_docking_fee_value_ptr);
                general.fuel_docking_fee_flt = boost::json::value_to<float>(*fuel_docking_fee_value_ptr);
            }
            ...
            if (jump_key_delay_value_ptr != nullptr) {
                general.jump_key_delay_dbl = boost::json::value_to<double>(*jump_key_delay_value_ptr);
                general.jump_key_delay_flt = boost::json::value_to<float>(*jump_key_delay_value_ptr);
            }
            ...
            if (percentage_speed_change_to_fault_search_value_ptr != nullptr) {
                general.percentage_speed_change_to_fault_search_dbl = boost::json::value_to<double>(*percentage_speed_change_to_fault_search_value_ptr);
                general.percentage_speed_change_to_fault_search_flt = boost::json::value_to<float>(*percentage_speed_change_to_fault_search_value_ptr);
            }
            ...
            if (pitch_value_ptr != nullptr) {
                general.pitch_dbl = boost::json::value_to<double>(*pitch_value_ptr);
                general.pitch_flt = boost::json::value_to<float>(*pitch_value_ptr);
            }
            ...
            if (remove_downgrades_less_than_percent_value_ptr != nullptr) {
                general.remove_downgrades_less_than_percent_dbl = boost::json::value_to<double>(*remove_downgrades_less_than_percent_value_ptr);
                general.remove_downgrades_less_than_percent_flt = boost::json::value_to<float>(*remove_downgrades_less_than_percent_value_ptr);
            }
            ...
            if (roll_value_ptr != nullptr) {
                general.roll_dbl = boost::json::value_to<double>(*roll_value_ptr);
                general.roll_flt = boost::json::value_to<float>(*roll_value_ptr);
            }
            ...
            if (simulation_atom_value_ptr != nullptr) {
                general.simulation_atom_dbl = boost::json::value_to<double>(*simulation_atom_value_ptr);
                general.simulation_atom_flt = boost::json::value_to<float>(*simulation_atom_value_ptr);
            }
            ...
            if (yaw_value_ptr != nullptr) {
                general.yaw_dbl = boost::json::value_to<double>(*yaw_value_ptr);
                general.yaw_flt = boost::json::value_to<float>(*yaw_value_ptr);
            }
        ...
        if (graphics_value_ptr != nullptr) {
            ...
            if (afterburner_color_red_value_ptr != nullptr) {
                graphics.afterburner_color_red_dbl = boost::json::value_to<double>(*afterburner_color_red_value_ptr);
                graphics.afterburner_color_red_flt = boost::json::value_to<float>(*afterburner_color_red_value_ptr);
            }
            ...
            if (afterburner_color_green_value_ptr != nullptr) {
                graphics.afterburner_color_green_dbl = boost::json::value_to<double>(*afterburner_color_green_value_ptr);
                graphics.afterburner_color_green_flt = boost::json::value_to<float>(*afterburner_color_green_value_ptr);
            }
            ...
            if (afterburner_color_blue_value_ptr != nullptr) {
                graphics.afterburner_color_blue_dbl = boost::json::value_to<double>(*afterburner_color_blue_value_ptr);
                graphics.afterburner_color_blue_flt = boost::json::value_to<float>(*afterburner_color_blue_value_ptr);
            }
            ...
            if (anim_far_percent_value_ptr != nullptr) {
                graphics.anim_far_percent_dbl = boost::json::value_to<double>(*anim_far_percent_value_ptr);
                graphics.anim_far_percent_flt = boost::json::value_to<float>(*anim_far_percent_value_ptr);
            }
            ...
            if (aspect_value_ptr != nullptr) {
                graphics.aspect_dbl = boost::json::value_to<double>(*aspect_value_ptr);
                graphics.aspect_flt = boost::json::value_to<float>(*aspect_value_ptr);
            }
            ...
            if (atmosphere_emissive_value_ptr != nullptr) {
                graphics.atmosphere_emissive_dbl = boost::json::value_to<double>(*atmosphere_emissive_value_ptr);
                graphics.atmosphere_emissive_flt = boost::json::value_to<float>(*atmosphere_emissive_value_ptr);
            }
            ...
            if (atmosphere_diffuse_value_ptr != nullptr) {
                graphics.atmosphere_diffuse_dbl = boost::json::value_to<double>(*atmosphere_diffuse_value_ptr);
                graphics.atmosphere_diffuse_flt = boost::json::value_to<float>(*atmosphere_diffuse_value_ptr);
            }
            ...
            if (auto_message_nav_switch_time_lim_value_ptr != nullptr) {
                graphics.auto_message_nav_switch_time_lim_dbl = boost::json::value_to<double>(*auto_message_nav_switch_time_lim_value_ptr);
                graphics.auto_message_nav_switch_time_lim_flt = boost::json::value_to<float>(*auto_message_nav_switch_time_lim_value_ptr);
            }
            ...
            if (auto_message_time_lim_value_ptr != nullptr) {
                graphics.auto_message_time_lim_dbl = boost::json::value_to<double>(*auto_message_time_lim_value_ptr);
                graphics.auto_message_time_lim_flt = boost::json::value_to<float>(*auto_message_time_lim_value_ptr);
            }
            ...
            if (autopilot_front_bias_value_ptr != nullptr) {
                graphics.autopilot_front_bias_dbl = boost::json::value_to<double>(*autopilot_front_bias_value_ptr);
                graphics.autopilot_front_bias_flt = boost::json::value_to<float>(*autopilot_front_bias_value_ptr);
            }
            ...
            if (autopilot_rotation_speed_value_ptr != nullptr) {
                graphics.autopilot_rotation_speed_dbl = boost::json::value_to<double>(*autopilot_rotation_speed_value_ptr);
                graphics.autopilot_rotation_speed_flt = boost::json::value_to<float>(*autopilot_rotation_speed_value_ptr);
            }
            ...
            if (autopilot_side_bias_value_ptr != nullptr) {
                graphics.autopilot_side_bias_dbl = boost::json::value_to<double>(*autopilot_side_bias_value_ptr);
                graphics.autopilot_side_bias_flt = boost::json::value_to<float>(*autopilot_side_bias_value_ptr);
            }
            ...
            if (background_edge_fixup_value_ptr != nullptr) {
                graphics.background_edge_fixup_dbl = boost::json::value_to<double>(*background_edge_fixup_value_ptr);
                graphics.background_edge_fixup_flt = boost::json::value_to<float>(*background_edge_fixup_value_ptr);
            }
            ...
            if (background_star_streak_velocity_scale_value_ptr != nullptr) {
                graphics.background_star_streak_velocity_scale_dbl = boost::json::value_to<double>(*background_star_streak_velocity_scale_value_ptr);
                graphics.background_star_streak_velocity_scale_flt = boost::json::value_to<float>(*background_star_streak_velocity_scale_value_ptr);
            }
            ...
            if (base_faction_color_darkness_value_ptr != nullptr) {
                graphics.base_faction_color_darkness_dbl = boost::json::value_to<double>(*base_faction_color_darkness_value_ptr);
                graphics.base_faction_color_darkness_flt = boost::json::value_to<float>(*base_faction_color_darkness_value_ptr);
            }
            ...
            if (beam_fadeout_length_value_ptr != nullptr) {
                graphics.beam_fadeout_length_dbl = boost::json::value_to<double>(*beam_fadeout_length_value_ptr);
                graphics.beam_fadeout_length_flt = boost::json::value_to<float>(*beam_fadeout_length_value_ptr);
            }
            ...
            if (beam_fadeout_hit_length_value_ptr != nullptr) {
                graphics.beam_fadeout_hit_length_dbl = boost::json::value_to<double>(*beam_fadeout_hit_length_value_ptr);
                graphics.beam_fadeout_hit_length_flt = boost::json::value_to<float>(*beam_fadeout_hit_length_value_ptr);
            }
            ...
            if (base_saturation_value_ptr != nullptr) {
                graphics.base_saturation_dbl = boost::json::value_to<double>(*base_saturation_value_ptr);
                graphics.base_saturation_flt = boost::json::value_to<float>(*base_saturation_value_ptr);
            }
            ...
            if (bolt_offset_value_ptr != nullptr) {
                graphics.bolt_offset_dbl = boost::json::value_to<double>(*bolt_offset_value_ptr);
                graphics.bolt_offset_flt = boost::json::value_to<float>(*bolt_offset_value_ptr);
            }
            ...
            if (bolt_pixel_size_value_ptr != nullptr) {
                graphics.bolt_pixel_size_dbl = boost::json::value_to<double>(*bolt_pixel_size_value_ptr);
                graphics.bolt_pixel_size_flt = boost::json::value_to<float>(*bolt_pixel_size_value_ptr);
            }
            ...
            if (camera_pan_speed_value_ptr != nullptr) {
                graphics.camera_pan_speed_dbl = boost::json::value_to<double>(*camera_pan_speed_value_ptr);
                graphics.camera_pan_speed_flt = boost::json::value_to<float>(*camera_pan_speed_value_ptr);
            }
            ...
            if (cargo_rotation_speed_value_ptr != nullptr) {
                graphics.cargo_rotation_speed_dbl = boost::json::value_to<double>(*cargo_rotation_speed_value_ptr);
                graphics.cargo_rotation_speed_flt = boost::json::value_to<float>(*cargo_rotation_speed_value_ptr);
            }
            ...
            if (circle_accuracy_value_ptr != nullptr) {
                graphics.circle_accuracy_dbl = boost::json::value_to<double>(*circle_accuracy_value_ptr);
                graphics.circle_accuracy_flt = boost::json::value_to<float>(*circle_accuracy_value_ptr);
            }
            ...
            if (city_light_strength_value_ptr != nullptr) {
                graphics.city_light_strength_dbl = boost::json::value_to<double>(*city_light_strength_value_ptr);
                graphics.city_light_strength_flt = boost::json::value_to<float>(*city_light_strength_value_ptr);
            }
            ...
            if (cockpit_drift_amount_value_ptr != nullptr) {
                graphics.cockpit_drift_amount_dbl = boost::json::value_to<double>(*cockpit_drift_amount_value_ptr);
                graphics.cockpit_drift_amount_flt = boost::json::value_to<float>(*cockpit_drift_amount_value_ptr);
            }
            ...
            if (cockpit_drift_limit_value_ptr != nullptr) {
                graphics.cockpit_drift_limit_dbl = boost::json::value_to<double>(*cockpit_drift_limit_value_ptr);
                graphics.cockpit_drift_limit_flt = boost::json::value_to<float>(*cockpit_drift_limit_value_ptr);
            }
            ...
            if (cockpit_drift_ref_accel_value_ptr != nullptr) {
                graphics.cockpit_drift_ref_accel_dbl = boost::json::value_to<double>(*cockpit_drift_ref_accel_value_ptr);
                graphics.cockpit_drift_ref_accel_flt = boost::json::value_to<float>(*cockpit_drift_ref_accel_value_ptr);
            }
            ...
            if (cockpit_nav_zfloor_value_ptr != nullptr) {
                graphics.cockpit_nav_zfloor_dbl = boost::json::value_to<double>(*cockpit_nav_zfloor_value_ptr);
                graphics.cockpit_nav_zfloor_flt = boost::json::value_to<float>(*cockpit_nav_zfloor_value_ptr);
            }
            ...
            if (cockpit_nav_zrange_value_ptr != nullptr) {
                graphics.cockpit_nav_zrange_dbl = boost::json::value_to<double>(*cockpit_nav_zrange_value_ptr);
                graphics.cockpit_nav_zrange_flt = boost::json::value_to<float>(*cockpit_nav_zrange_value_ptr);
            }
            ...
            if (cockpit_shake_value_ptr != nullptr) {
                graphics.cockpit_shake_dbl = boost::json::value_to<double>(*cockpit_shake_value_ptr);
                graphics.cockpit_shake_flt = boost::json::value_to<float>(*cockpit_shake_value_ptr);
            }
            ...
            if (cockpit_shake_max_value_ptr != nullptr) {
                graphics.cockpit_shake_max_dbl = boost::json::value_to<double>(*cockpit_shake_max_value_ptr);
                graphics.cockpit_shake_max_flt = boost::json::value_to<float>(*cockpit_shake_max_value_ptr);
            }
            ...
            if (damage_flash_length_value_ptr != nullptr) {
                graphics.damage_flash_length_dbl = boost::json::value_to<double>(*damage_flash_length_value_ptr);
                graphics.damage_flash_length_flt = boost::json::value_to<float>(*damage_flash_length_value_ptr);
            }
            ...
            if (day_city_light_strength_value_ptr != nullptr) {
                graphics.day_city_light_strength_dbl = boost::json::value_to<double>(*day_city_light_strength_value_ptr);
                graphics.day_city_light_strength_flt = boost::json::value_to<float>(*day_city_light_strength_value_ptr);
            }
            ...
            if (death_scene_time_value_ptr != nullptr) {
                graphics.death_scene_time_dbl = boost::json::value_to<double>(*death_scene_time_value_ptr);
                graphics.death_scene_time_flt = boost::json::value_to<float>(*death_scene_time_value_ptr);
            }
            ...
            if (default_engine_activation_value_ptr != nullptr) {
                graphics.default_engine_activation_dbl = boost::json::value_to<double>(*default_engine_activation_value_ptr);
                graphics.default_engine_activation_flt = boost::json::value_to<float>(*default_engine_activation_value_ptr);
            }
            ...
            if (detail_texture_scale_value_ptr != nullptr) {
                graphics.detail_texture_scale_dbl = boost::json::value_to<double>(*detail_texture_scale_value_ptr);
                graphics.detail_texture_scale_flt = boost::json::value_to<float>(*detail_texture_scale_value_ptr);
            }
            ...
            if (eject_rotation_speed_value_ptr != nullptr) {
                graphics.eject_rotation_speed_dbl = boost::json::value_to<double>(*eject_rotation_speed_value_ptr);
                graphics.eject_rotation_speed_flt = boost::json::value_to<float>(*eject_rotation_speed_value_ptr);
            }
            ...
            if (engine_color_red_value_ptr != nullptr) {
                graphics.engine_color_red_dbl = boost::json::value_to<double>(*engine_color_red_value_ptr);
                graphics.engine_color_red_flt = boost::json::value_to<float>(*engine_color_red_value_ptr);
            }
            ...
            if (engine_color_green_value_ptr != nullptr) {
                graphics.engine_color_green_dbl = boost::json::value_to<double>(*engine_color_green_value_ptr);
                graphics.engine_color_green_flt = boost::json::value_to<float>(*engine_color_green_value_ptr);
            }
            ...
            if (engine_color_blue_value_ptr != nullptr) {
                graphics.engine_color_blue_dbl = boost::json::value_to<double>(*engine_color_blue_value_ptr);
                graphics.engine_color_blue_flt = boost::json::value_to<float>(*engine_color_blue_value_ptr);
            }
            ...
            if (engine_length_scale_value_ptr != nullptr) {
                graphics.engine_length_scale_dbl = boost::json::value_to<double>(*engine_length_scale_value_ptr);
                graphics.engine_length_scale_flt = boost::json::value_to<float>(*engine_length_scale_value_ptr);
            }
            ...
            if (engine_radii_scale_value_ptr != nullptr) {
                graphics.engine_radii_scale_dbl = boost::json::value_to<double>(*engine_radii_scale_value_ptr);
                graphics.engine_radii_scale_flt = boost::json::value_to<float>(*engine_radii_scale_value_ptr);
            }
            ...
            if (explosion_force_value_ptr != nullptr) {
                graphics.explosion_force_dbl = boost::json::value_to<double>(*explosion_force_value_ptr);
                graphics.explosion_force_flt = boost::json::value_to<float>(*explosion_force_value_ptr);
            }
            ...
            if (explosion_size_value_ptr != nullptr) {
                graphics.explosion_size_dbl = boost::json::value_to<double>(*explosion_size_value_ptr);
                graphics.explosion_size_flt = boost::json::value_to<float>(*explosion_size_value_ptr);
            }
            ...
            if (explosion_torque_value_ptr != nullptr) {
                graphics.explosion_torque_dbl = boost::json::value_to<double>(*explosion_torque_value_ptr);
                graphics.explosion_torque_flt = boost::json::value_to<float>(*explosion_torque_value_ptr);
            }
            ...
            if (far_stars_sprite_size_value_ptr != nullptr) {
                graphics.far_stars_sprite_size_dbl = boost::json::value_to<double>(*far_stars_sprite_size_value_ptr);
                graphics.far_stars_sprite_size_flt = boost::json::value_to<float>(*far_stars_sprite_size_value_ptr);
            }
            ...
            if (fog_fade_in_percent_value_ptr != nullptr) {
                graphics.fog_fade_in_percent_dbl = boost::json::value_to<double>(*fog_fade_in_percent_value_ptr);
                graphics.fog_fade_in_percent_flt = boost::json::value_to<float>(*fog_fade_in_percent_value_ptr);
            }

            const boost::json::value * fog_time_value_ptr = graphics_object.if_contains("fog_time");
            if (fog_time_value_ptr != nullptr) {
                graphics.fog_time_dbl = boost::json::value_to<double>(*fog_time_value_ptr);
                graphics.fog_time_flt = boost::json::value_to<float>(*fog_time_value_ptr);
            }
            ...
            if (font_point_value_ptr != nullptr) {
                graphics.font_point_dbl = boost::json::value_to<double>(*font_point_value_ptr);
                graphics.font_point_flt = boost::json::value_to<float>(*font_point_value_ptr);
            }
            ...
            if (font_width_hack_value_ptr != nullptr) {
                graphics.font_width_hack_dbl = boost::json::value_to<double>(*font_width_hack_value_ptr);
                graphics.font_width_hack_flt = boost::json::value_to<float>(*font_width_hack_value_ptr);
            }
            ...
            if (fov_value_ptr != nullptr) {
                graphics.fov_dbl = boost::json::value_to<double>(*fov_value_ptr);
                graphics.fov_flt = boost::json::value_to<float>(*fov_value_ptr);
            }
            ...
            if (generic_cargo_rotation_speed_value_ptr != nullptr) {
                graphics.generic_cargo_rotation_speed_dbl = boost::json::value_to<double>(*generic_cargo_rotation_speed_value_ptr);
                graphics.generic_cargo_rotation_speed_flt = boost::json::value_to<float>(*generic_cargo_rotation_speed_value_ptr);
            }
            ...
            if (gui_font_scale_value_ptr != nullptr) {
                graphics.gui_font_scale_dbl = boost::json::value_to<double>(*gui_font_scale_value_ptr);
                graphics.gui_font_scale_flt = boost::json::value_to<float>(*gui_font_scale_value_ptr);
            }
            ...
            if (halo_offset_value_ptr != nullptr) {
                graphics.halo_offset_dbl = boost::json::value_to<double>(*halo_offset_value_ptr);
                graphics.halo_offset_flt = boost::json::value_to<float>(*halo_offset_value_ptr);
            }
            ...
            if (halo_sparkle_rate_value_ptr != nullptr) {
                graphics.halo_sparkle_rate_dbl = boost::json::value_to<double>(*halo_sparkle_rate_value_ptr);
                graphics.halo_sparkle_rate_flt = boost::json::value_to<float>(*halo_sparkle_rate_value_ptr);
            }
            ...
            if (halo_sparkle_scale_value_ptr != nullptr) {
                graphics.halo_sparkle_scale_dbl = boost::json::value_to<double>(*halo_sparkle_scale_value_ptr);
                graphics.halo_sparkle_scale_flt = boost::json::value_to<float>(*halo_sparkle_scale_value_ptr);
            }
            ...
            if (halo_sparkle_speed_value_ptr != nullptr) {
                graphics.halo_sparkle_speed_dbl = boost::json::value_to<double>(*halo_sparkle_speed_value_ptr);
                graphics.halo_sparkle_speed_flt = boost::json::value_to<float>(*halo_sparkle_speed_value_ptr);
            }
            ...
            if (in_system_jump_ani_second_ahead_value_ptr != nullptr) {
                graphics.in_system_jump_ani_second_ahead_dbl = boost::json::value_to<double>(*in_system_jump_ani_second_ahead_value_ptr);
                graphics.in_system_jump_ani_second_ahead_flt = boost::json::value_to<float>(*in_system_jump_ani_second_ahead_value_ptr);
            }
            ...
            if (in_system_jump_ani_second_ahead_end_value_ptr != nullptr) {
                graphics.in_system_jump_ani_second_ahead_end_dbl = boost::json::value_to<double>(*in_system_jump_ani_second_ahead_end_value_ptr);
                graphics.in_system_jump_ani_second_ahead_end_flt = boost::json::value_to<float>(*in_system_jump_ani_second_ahead_end_value_ptr);
            }
            ...
            if (in_system_jump_animation_growth_value_ptr != nullptr) {
                graphics.in_system_jump_animation_growth_dbl = boost::json::value_to<double>(*in_system_jump_animation_growth_value_ptr);
                graphics.in_system_jump_animation_growth_flt = boost::json::value_to<float>(*in_system_jump_animation_growth_value_ptr);
            }
            ...
            if (in_system_jump_animation_size_value_ptr != nullptr) {
                graphics.in_system_jump_animation_size_dbl = boost::json::value_to<double>(*in_system_jump_animation_size_value_ptr);
                graphics.in_system_jump_animation_size_flt = boost::json::value_to<float>(*in_system_jump_animation_size_value_ptr);
            }
            ...
            if (initial_zoom_factor_value_ptr != nullptr) {
                graphics.initial_zoom_factor_dbl = boost::json::value_to<double>(*initial_zoom_factor_value_ptr);
                graphics.initial_zoom_factor_flt = boost::json::value_to<float>(*initial_zoom_factor_value_ptr);
            }
            ...
            if (jump_animation_shrink_value_ptr != nullptr) {
                graphics.jump_animation_shrink_dbl = boost::json::value_to<double>(*jump_animation_shrink_value_ptr);
                graphics.jump_animation_shrink_flt = boost::json::value_to<float>(*jump_animation_shrink_value_ptr);
            }
            ...
            if (jump_gate_size_value_ptr != nullptr) {
                graphics.jump_gate_size_dbl = boost::json::value_to<double>(*jump_gate_size_value_ptr);
                graphics.jump_gate_size_flt = boost::json::value_to<float>(*jump_gate_size_value_ptr);
            }
            ...
            if (last_message_time_value_ptr != nullptr) {
                graphics.last_message_time_dbl = boost::json::value_to<double>(*last_message_time_value_ptr);
                graphics.last_message_time_flt = boost::json::value_to<float>(*last_message_time_value_ptr);
            }

            const boost::json::value * light_cutoff_value_ptr = graphics_object.if_contains("light_cutoff");
            if (light_cutoff_value_ptr != nullptr) {
                graphics.light_cutoff_dbl = boost::json::value_to<double>(*light_cutoff_value_ptr);
                graphics.light_cutoff_flt = boost::json::value_to<float>(*light_cutoff_value_ptr);
            }
            ...
            if (light_optimal_intensity_value_ptr != nullptr) {
                graphics.light_optimal_intensity_dbl = boost::json::value_to<double>(*light_optimal_intensity_value_ptr);
                graphics.light_optimal_intensity_flt = boost::json::value_to<float>(*light_optimal_intensity_value_ptr);
            }
            ...
            if (light_saturation_value_ptr != nullptr) {
                graphics.light_saturation_dbl = boost::json::value_to<double>(*light_saturation_value_ptr);
                graphics.light_saturation_flt = boost::json::value_to<float>(*light_saturation_value_ptr);
            }
            ...
            if (locklight_time_value_ptr != nullptr) {
                graphics.locklight_time_dbl = boost::json::value_to<double>(*locklight_time_value_ptr);
                graphics.locklight_time_flt = boost::json::value_to<float>(*locklight_time_value_ptr);
            }

            const boost::json::value * logo_offset_value_ptr = graphics_object.if_contains("logo_offset");
            if (logo_offset_value_ptr != nullptr) {
                graphics.logo_offset_dbl = boost::json::value_to<double>(*logo_offset_value_ptr);
                graphics.logo_offset_flt = boost::json::value_to<float>(*logo_offset_value_ptr);
            }
            ...
            if (logo_offset_scale_value_ptr != nullptr) {
                graphics.logo_offset_scale_dbl = boost::json::value_to<double>(*logo_offset_scale_value_ptr);
                graphics.logo_offset_scale_flt = boost::json::value_to<float>(*logo_offset_scale_value_ptr);
            }
            ...
            if (mesh_animation_max_frames_skipped_value_ptr != nullptr) {
                graphics.mesh_animation_max_frames_skipped_dbl = boost::json::value_to<double>(*mesh_animation_max_frames_skipped_value_ptr);
                graphics.mesh_animation_max_frames_skipped_flt = boost::json::value_to<float>(*mesh_animation_max_frames_skipped_value_ptr);
            }
            ...
            if (mesh_far_percent_value_ptr != nullptr) {
                graphics.mesh_far_percent_dbl = boost::json::value_to<double>(*mesh_far_percent_value_ptr);
                graphics.mesh_far_percent_flt = boost::json::value_to<float>(*mesh_far_percent_value_ptr);
            }
            ...
            if (missile_explosion_radius_mult_value_ptr != nullptr) {
                graphics.missile_explosion_radius_mult_dbl = boost::json::value_to<double>(*missile_explosion_radius_mult_value_ptr);
                graphics.missile_explosion_radius_mult_flt = boost::json::value_to<float>(*missile_explosion_radius_mult_value_ptr);
            }
            ...
            if (model_detail_value_ptr != nullptr) {
                graphics.model_detail_dbl = boost::json::value_to<double>(*model_detail_value_ptr);
                graphics.model_detail_flt = boost::json::value_to<float>(*model_detail_value_ptr);
            }
            ...
            if (near_stars_sprite_size_value_ptr != nullptr) {
                graphics.near_stars_sprite_size_dbl = boost::json::value_to<double>(*near_stars_sprite_size_value_ptr);
                graphics.near_stars_sprite_size_flt = boost::json::value_to<float>(*near_stars_sprite_size_value_ptr);
            }
            ...
            if (optimize_vertex_condition_value_ptr != nullptr) {
                graphics.optimize_vertex_condition_dbl = boost::json::value_to<double>(*optimize_vertex_condition_value_ptr);
                graphics.optimize_vertex_condition_flt = boost::json::value_to<float>(*optimize_vertex_condition_value_ptr);
            }
            ...
            if (percent_afterburner_color_change_value_ptr != nullptr) {
                graphics.percent_afterburner_color_change_dbl = boost::json::value_to<double>(*percent_afterburner_color_change_value_ptr);
                graphics.percent_afterburner_color_change_flt = boost::json::value_to<float>(*percent_afterburner_color_change_value_ptr);
            }
            ...
            if (percent_halo_fade_in_value_ptr != nullptr) {
                graphics.percent_halo_fade_in_dbl = boost::json::value_to<double>(*percent_halo_fade_in_value_ptr);
                graphics.percent_halo_fade_in_flt = boost::json::value_to<float>(*percent_halo_fade_in_value_ptr);
            }
            ...
            if (percent_shockwave_value_ptr != nullptr) {
                graphics.percent_shockwave_dbl = boost::json::value_to<double>(*percent_shockwave_value_ptr);
                graphics.percent_shockwave_flt = boost::json::value_to<float>(*percent_shockwave_value_ptr);
            }
            ...
            if (precull_dist_value_ptr != nullptr) {
                graphics.precull_dist_dbl = boost::json::value_to<double>(*precull_dist_value_ptr);
                graphics.precull_dist_flt = boost::json::value_to<float>(*precull_dist_value_ptr);
            }
            ...
            if (reduced_vdus_width_value_ptr != nullptr) {
                graphics.reduced_vdus_width_dbl = boost::json::value_to<double>(*reduced_vdus_width_value_ptr);
                graphics.reduced_vdus_width_flt = boost::json::value_to<float>(*reduced_vdus_width_value_ptr);
            }
            ...
            if (reduced_vdus_height_value_ptr != nullptr) {
                graphics.reduced_vdus_height_dbl = boost::json::value_to<double>(*reduced_vdus_height_value_ptr);
                graphics.reduced_vdus_height_flt = boost::json::value_to<float>(*reduced_vdus_height_value_ptr);
            }
            ...
            if (reflectivity_value_ptr != nullptr) {
                graphics.reflectivity_dbl = boost::json::value_to<double>(*reflectivity_value_ptr);
                graphics.reflectivity_flt = boost::json::value_to<float>(*reflectivity_value_ptr);
            }
            ...
            if (shake_limit_value_ptr != nullptr) {
                graphics.shake_limit_dbl = boost::json::value_to<double>(*shake_limit_value_ptr);
                graphics.shake_limit_flt = boost::json::value_to<float>(*shake_limit_value_ptr);
            }
            ...
            if (shake_magnitude_value_ptr != nullptr) {
                graphics.shake_magnitude_dbl = boost::json::value_to<double>(*shake_magnitude_value_ptr);
                graphics.shake_magnitude_flt = boost::json::value_to<float>(*shake_magnitude_value_ptr);
            }
            ...
            if (shake_reduction_value_ptr != nullptr) {
                graphics.shake_reduction_dbl = boost::json::value_to<double>(*shake_reduction_value_ptr);
                graphics.shake_reduction_flt = boost::json::value_to<float>(*shake_reduction_value_ptr);
            }

            const boost::json::value * shake_speed_value_ptr = graphics_object.if_contains("shake_speed");
            if (shake_speed_value_ptr != nullptr) {
                graphics.shake_speed_dbl = boost::json::value_to<double>(*shake_speed_value_ptr);
                graphics.shake_speed_flt = boost::json::value_to<float>(*shake_speed_value_ptr);
            }
            ...
            if (shockwave_growth_value_ptr != nullptr) {
                graphics.shockwave_growth_dbl = boost::json::value_to<double>(*shockwave_growth_value_ptr);
                graphics.shockwave_growth_flt = boost::json::value_to<float>(*shockwave_growth_value_ptr);
            }
            ...
            if (shove_camera_down_value_ptr != nullptr) {
                graphics.shove_camera_down_dbl = boost::json::value_to<double>(*shove_camera_down_value_ptr);
                graphics.shove_camera_down_flt = boost::json::value_to<float>(*shove_camera_down_value_ptr);
            }
            ...
            if (sparkle_absolute_speed_value_ptr != nullptr) {
                graphics.sparkle_absolute_speed_dbl = boost::json::value_to<double>(*sparkle_absolute_speed_value_ptr);
                graphics.sparkle_absolute_speed_flt = boost::json::value_to<float>(*sparkle_absolute_speed_value_ptr);
            }
            ...
            if (sparkle_engine_size_relative_to_ship_value_ptr != nullptr) {
                graphics.sparkle_engine_size_relative_to_ship_dbl = boost::json::value_to<double>(*sparkle_engine_size_relative_to_ship_value_ptr);
                graphics.sparkle_engine_size_relative_to_ship_flt = boost::json::value_to<float>(*sparkle_engine_size_relative_to_ship_value_ptr);
            }

            const boost::json::value * sparkle_rate_value_ptr = graphics_object.if_contains("sparkle_rate");
            if (sparkle_rate_value_ptr != nullptr) {
                graphics.sparkle_rate_dbl = boost::json::value_to<double>(*sparkle_rate_value_ptr);
                graphics.sparkle_rate_flt = boost::json::value_to<float>(*sparkle_rate_value_ptr);
            }
            ...
            if (star_color_average_value_ptr != nullptr) {
                graphics.star_color_average_dbl = boost::json::value_to<double>(*star_color_average_value_ptr);
                graphics.star_color_average_flt = boost::json::value_to<float>(*star_color_average_value_ptr);
            }
            ...
            if (star_color_cutoff_value_ptr != nullptr) {
                graphics.star_color_cutoff_dbl = boost::json::value_to<double>(*star_color_cutoff_value_ptr);
                graphics.star_color_cutoff_flt = boost::json::value_to<float>(*star_color_cutoff_value_ptr);
            }
            ...
            if (star_color_increment_value_ptr != nullptr) {
                graphics.star_color_increment_dbl = boost::json::value_to<double>(*star_color_increment_value_ptr);
                graphics.star_color_increment_flt = boost::json::value_to<float>(*star_color_increment_value_ptr);
            }
            ...
            if (star_color_power_value_ptr != nullptr) {
                graphics.star_color_power_dbl = boost::json::value_to<double>(*star_color_power_value_ptr);
                graphics.star_color_power_flt = boost::json::value_to<float>(*star_color_power_value_ptr);
            }
            ...
            if (star_body_radius_value_ptr != nullptr) {
                graphics.star_body_radius_dbl = boost::json::value_to<double>(*star_body_radius_value_ptr);
                graphics.star_body_radius_flt = boost::json::value_to<float>(*star_body_radius_value_ptr);
            }
            ...
            if (star_glow_radius_value_ptr != nullptr) {
                graphics.star_glow_radius_dbl = boost::json::value_to<double>(*star_glow_radius_value_ptr);
                graphics.star_glow_radius_flt = boost::json::value_to<float>(*star_glow_radius_value_ptr);
            }
            ...
            if (star_lumin_scale_value_ptr != nullptr) {
                graphics.star_lumin_scale_dbl = boost::json::value_to<double>(*star_lumin_scale_value_ptr);
                graphics.star_lumin_scale_flt = boost::json::value_to<float>(*star_lumin_scale_value_ptr);
            }
            ...
            if (star_minimum_color_value_value_ptr != nullptr) {
                graphics.star_minimum_color_value_dbl = boost::json::value_to<double>(*star_minimum_color_value_value_ptr);
                graphics.star_minimum_color_value_flt = boost::json::value_to<float>(*star_minimum_color_value_value_ptr);
            }

            const boost::json::value * star_overlap_value_ptr = graphics_object.if_contains("star_overlap");
            if (star_overlap_value_ptr != nullptr) {
                graphics.star_overlap_dbl = boost::json::value_to<double>(*star_overlap_value_ptr);
                graphics.star_overlap_flt = boost::json::value_to<float>(*star_overlap_value_ptr);
            }
            ...
            if (star_spread_attenuation_value_ptr != nullptr) {
                graphics.star_spread_attenuation_dbl = boost::json::value_to<double>(*star_spread_attenuation_value_ptr);
                graphics.star_spread_attenuation_flt = boost::json::value_to<float>(*star_spread_attenuation_value_ptr);
            }
            ...
            if (star_spreading_value_ptr != nullptr) {
                graphics.star_spreading_dbl = boost::json::value_to<double>(*star_spreading_value_ptr);
                graphics.star_spreading_flt = boost::json::value_to<float>(*star_spreading_value_ptr);
            }
            ...
            if (stars_alpha_test_cutoff_value_ptr != nullptr) {
                graphics.stars_alpha_test_cutoff_dbl = boost::json::value_to<double>(*stars_alpha_test_cutoff_value_ptr);
                graphics.stars_alpha_test_cutoff_flt = boost::json::value_to<float>(*stars_alpha_test_cutoff_value_ptr);
            }
            ...
            if (stretch_bolts_value_ptr != nullptr) {
                graphics.stretch_bolts_dbl = boost::json::value_to<double>(*stretch_bolts_value_ptr);
                graphics.stretch_bolts_flt = boost::json::value_to<float>(*stretch_bolts_value_ptr);
            }
            ...
            if (text_delay_value_ptr != nullptr) {
                graphics.text_delay_dbl = boost::json::value_to<double>(*text_delay_value_ptr);
                graphics.text_delay_flt = boost::json::value_to<float>(*text_delay_value_ptr);
            }
            ...
            if (text_speed_value_ptr != nullptr) {
                graphics.text_speed_dbl = boost::json::value_to<double>(*text_speed_value_ptr);
                graphics.text_speed_flt = boost::json::value_to<float>(*text_speed_value_ptr);
            }
            ...
            if (torque_star_streak_scale_value_ptr != nullptr) {
                graphics.torque_star_streak_scale_dbl = boost::json::value_to<double>(*torque_star_streak_scale_value_ptr);
                graphics.torque_star_streak_scale_flt = boost::json::value_to<float>(*torque_star_streak_scale_value_ptr);
            }
            ...
            if (velocity_star_streak_max_value_ptr != nullptr) {
                graphics.velocity_star_streak_max_dbl = boost::json::value_to<double>(*velocity_star_streak_max_value_ptr);
                graphics.velocity_star_streak_max_flt = boost::json::value_to<float>(*velocity_star_streak_max_value_ptr);
            }
            ...
            if (velocity_star_streak_min_value_ptr != nullptr) {
                graphics.velocity_star_streak_min_dbl = boost::json::value_to<double>(*velocity_star_streak_min_value_ptr);
                graphics.velocity_star_streak_min_flt = boost::json::value_to<float>(*velocity_star_streak_min_value_ptr);
            }
            ...
            if (velocity_star_streak_scale_value_ptr != nullptr) {
                graphics.velocity_star_streak_scale_dbl = boost::json::value_to<double>(*velocity_star_streak_scale_value_ptr);
                graphics.velocity_star_streak_scale_flt = boost::json::value_to<float>(*velocity_star_streak_scale_value_ptr);
            }
            ...
            if (warp_shake_magnitude_value_ptr != nullptr) {
                graphics.warp_shake_magnitude_dbl = boost::json::value_to<double>(*warp_shake_magnitude_value_ptr);
                graphics.warp_shake_magnitude_flt = boost::json::value_to<float>(*warp_shake_magnitude_value_ptr);
            }
            ...
            if (warp_shake_ref_value_ptr != nullptr) {
                graphics.warp_shake_ref_dbl = boost::json::value_to<double>(*warp_shake_ref_value_ptr);
                graphics.warp_shake_ref_flt = boost::json::value_to<float>(*warp_shake_ref_value_ptr);
            }
            ...
            if (warp_shake_speed_value_ptr != nullptr) {
                graphics.warp_shake_speed_dbl = boost::json::value_to<double>(*warp_shake_speed_value_ptr);
                graphics.warp_shake_speed_flt = boost::json::value_to<float>(*warp_shake_speed_value_ptr);
            }
            ...
            if (warp_stretch_cutoff_value_ptr != nullptr) {
                graphics.warp_stretch_cutoff_dbl = boost::json::value_to<double>(*warp_stretch_cutoff_value_ptr);
                graphics.warp_stretch_cutoff_flt = boost::json::value_to<float>(*warp_stretch_cutoff_value_ptr);
            }
            ...
            if (warp_stretch_max_value_ptr != nullptr) {
                graphics.warp_stretch_max_dbl = boost::json::value_to<double>(*warp_stretch_max_value_ptr);
                graphics.warp_stretch_max_flt = boost::json::value_to<float>(*warp_stretch_max_value_ptr);
            }
            ...
            if (warp_stretch_max_region0_speed_value_ptr != nullptr) {
                graphics.warp_stretch_max_region0_speed_dbl = boost::json::value_to<double>(*warp_stretch_max_region0_speed_value_ptr);
                graphics.warp_stretch_max_region0_speed_flt = boost::json::value_to<float>(*warp_stretch_max_region0_speed_value_ptr);
            }
            ...
            if (warp_stretch_max_speed_value_ptr != nullptr) {
                graphics.warp_stretch_max_speed_dbl = boost::json::value_to<double>(*warp_stretch_max_speed_value_ptr);
                graphics.warp_stretch_max_speed_flt = boost::json::value_to<float>(*warp_stretch_max_speed_value_ptr);
            }
            ...
            if (warp_stretch_region0_max_value_ptr != nullptr) {
                graphics.warp_stretch_region0_max_dbl = boost::json::value_to<double>(*warp_stretch_region0_max_value_ptr);
                graphics.warp_stretch_region0_max_flt = boost::json::value_to<float>(*warp_stretch_region0_max_value_ptr);
            }
            ...
            if (warp_trail_stretch_value_ptr != nullptr) {
                graphics.warp_trail_stretch_dbl = boost::json::value_to<double>(*warp_trail_stretch_value_ptr);
                graphics.warp_trail_stretch_flt = boost::json::value_to<float>(*warp_trail_stretch_value_ptr);
            }
            ...
            if (warp_trail_time_value_ptr != nullptr) {
                graphics.warp_trail_time_dbl = boost::json::value_to<double>(*warp_trail_time_value_ptr);
                graphics.warp_trail_time_flt = boost::json::value_to<float>(*warp_trail_time_value_ptr);
            }

            const boost::json::value * weapon_gamma_value_ptr = graphics_object.if_contains("weapon_gamma");
            if (weapon_gamma_value_ptr != nullptr) {
                graphics.weapon_gamma_dbl = boost::json::value_to<double>(*weapon_gamma_value_ptr);
                graphics.weapon_gamma_flt = boost::json::value_to<float>(*weapon_gamma_value_ptr);
            }
            ...
            if (weapon_xyscale_value_ptr != nullptr) {
                graphics.weapon_xyscale_dbl = boost::json::value_to<double>(*weapon_xyscale_value_ptr);
                graphics.weapon_xyscale_flt = boost::json::value_to<float>(*weapon_xyscale_value_ptr);
            }
            ...
            if (weapon_zscale_value_ptr != nullptr) {
                graphics.weapon_zscale_dbl = boost::json::value_to<double>(*weapon_zscale_value_ptr);
                graphics.weapon_zscale_flt = boost::json::value_to<float>(*weapon_zscale_value_ptr);
            }
            ...
            if (wheel_zoom_amount_value_ptr != nullptr) {
                graphics.wheel_zoom_amount_dbl = boost::json::value_to<double>(*wheel_zoom_amount_value_ptr);
                graphics.wheel_zoom_amount_flt = boost::json::value_to<float>(*wheel_zoom_amount_value_ptr);
            }
            ...
            if (zfar_value_ptr != nullptr) {
                graphics.zfar_dbl = boost::json::value_to<double>(*zfar_value_ptr);
                graphics.zfar_flt = boost::json::value_to<float>(*zfar_value_ptr);
            }

            const boost::json::value * znear_value_ptr = graphics_object.if_contains("znear");
            if (znear_value_ptr != nullptr) {
                graphics.znear_dbl = boost::json::value_to<double>(*znear_value_ptr);
                graphics.znear_flt = boost::json::value_to<float>(*znear_value_ptr);
            }
        ...
        if (bases_value_ptr != nullptr) {
            ...
            if (alpha_test_cutoff_value_ptr != nullptr) {
                graphics.bases.alpha_test_cutoff_dbl = boost::json::value_to<double>(*alpha_test_cutoff_value_ptr);
                graphics.bases.alpha_test_cutoff_flt = boost::json::value_to<float>(*alpha_test_cutoff_value_ptr);
            }
            ...
            if (location_marker_distance_value_ptr != nullptr) {
                graphics.bases.location_marker_distance_dbl = boost::json::value_to<double>(*location_marker_distance_value_ptr);
                graphics.bases.location_marker_distance_flt = boost::json::value_to<float>(*location_marker_distance_value_ptr);
            }
            ...
            if (location_marker_text_color_r_value_ptr != nullptr) {
                graphics.bases.location_marker_text_color_r_dbl = boost::json::value_to<double>(*location_marker_text_color_r_value_ptr);
                graphics.bases.location_marker_text_color_r_flt = boost::json::value_to<float>(*location_marker_text_color_r_value_ptr);
            }
            ...
            if (location_marker_text_color_g_value_ptr != nullptr) {
                graphics.bases.location_marker_text_color_g_dbl = boost::json::value_to<double>(*location_marker_text_color_g_value_ptr);
                graphics.bases.location_marker_text_color_g_flt = boost::json::value_to<float>(*location_marker_text_color_g_value_ptr);
            }
            ...
            if (location_marker_text_color_b_value_ptr != nullptr) {
                graphics.bases.location_marker_text_color_b_dbl = boost::json::value_to<double>(*location_marker_text_color_b_value_ptr);
                graphics.bases.location_marker_text_color_b_flt = boost::json::value_to<float>(*location_marker_text_color_b_value_ptr);
            }
            ...
            if (location_marker_text_offset_x_value_ptr != nullptr) {
                graphics.bases.location_marker_text_offset_x_dbl = boost::json::value_to<double>(*location_marker_text_offset_x_value_ptr);
                graphics.bases.location_marker_text_offset_x_flt = boost::json::value_to<float>(*location_marker_text_offset_x_value_ptr);
            }
            ...
            if (location_marker_text_offset_y_value_ptr != nullptr) {
                graphics.bases.location_marker_text_offset_y_dbl = boost::json::value_to<double>(*location_marker_text_offset_y_value_ptr);
                graphics.bases.location_marker_text_offset_y_flt = boost::json::value_to<float>(*location_marker_text_offset_y_value_ptr);
            }
            ...
            if (fov_value_ptr != nullptr) {
                graphics.bases.fov_dbl = boost::json::value_to<double>(*fov_value_ptr);
                graphics.bases.fov_flt = boost::json::value_to<float>(*fov_value_ptr);
            }
            ...
            if (text_background_alpha_value_ptr != nullptr) {
                graphics.bases.text_background_alpha_dbl = boost::json::value_to<double>(*text_background_alpha_value_ptr);
                graphics.bases.text_background_alpha_flt = boost::json::value_to<float>(*text_background_alpha_value_ptr);
            }
        ...
        if (glow_flicker_value_ptr != nullptr) {
            ...
            if (flicker_time_value_ptr != nullptr) {
                graphics.glow_flicker.flicker_time_dbl = boost::json::value_to<double>(*flicker_time_value_ptr);
                graphics.glow_flicker.flicker_time_flt = boost::json::value_to<float>(*flicker_time_value_ptr);
            }
            ...
            if (flicker_off_time_value_ptr != nullptr) {
                graphics.glow_flicker.flicker_off_time_dbl = boost::json::value_to<double>(*flicker_off_time_value_ptr);
                graphics.glow_flicker.flicker_off_time_flt = boost::json::value_to<float>(*flicker_off_time_value_ptr);
            }
            ...
            if (min_flicker_cycle_value_ptr != nullptr) {
                graphics.glow_flicker.min_flicker_cycle_dbl = boost::json::value_to<double>(*min_flicker_cycle_value_ptr);
                graphics.glow_flicker.min_flicker_cycle_flt = boost::json::value_to<float>(*min_flicker_cycle_value_ptr);
            }
            ...
            if (num_times_per_second_on_value_ptr != nullptr) {
                graphics.glow_flicker.num_times_per_second_on_dbl = boost::json::value_to<double>(*num_times_per_second_on_value_ptr);
                graphics.glow_flicker.num_times_per_second_on_flt = boost::json::value_to<float>(*num_times_per_second_on_value_ptr);
            }
            ...
            if (hull_for_total_dark_value_ptr != nullptr) {
                graphics.glow_flicker.hull_for_total_dark_dbl = boost::json::value_to<double>(*hull_for_total_dark_value_ptr);
                graphics.glow_flicker.hull_for_total_dark_flt = boost::json::value_to<float>(*hull_for_total_dark_value_ptr);
            }
        ...
        if (hud_value_ptr != nullptr) {
            ...
            if (armor_hull_size_value_ptr != nullptr) {
                graphics.hud.armor_hull_size_dbl = boost::json::value_to<double>(*armor_hull_size_value_ptr);
                graphics.hud.armor_hull_size_flt = boost::json::value_to<float>(*armor_hull_size_value_ptr);
            }
            ...
            if (box_line_thickness_value_ptr != nullptr) {
                graphics.hud.box_line_thickness_dbl = boost::json::value_to<double>(*box_line_thickness_value_ptr);
                graphics.hud.box_line_thickness_flt = boost::json::value_to<float>(*box_line_thickness_value_ptr);
            }
            ...
            if (diamond_line_thickness_value_ptr != nullptr) {
                graphics.hud.diamond_line_thickness_dbl = boost::json::value_to<double>(*diamond_line_thickness_value_ptr);
                graphics.hud.diamond_line_thickness_flt = boost::json::value_to<float>(*diamond_line_thickness_value_ptr);
            }
            ...
            if (diamond_rotation_speed_value_ptr != nullptr) {
                graphics.hud.diamond_rotation_speed_dbl = boost::json::value_to<double>(*diamond_rotation_speed_value_ptr);
                graphics.hud.diamond_rotation_speed_flt = boost::json::value_to<float>(*diamond_rotation_speed_value_ptr);
            }

            const boost::json::value * diamond_size_value_ptr = hud_object.if_contains("diamond_size");
            if (diamond_size_value_ptr != nullptr) {
                graphics.hud.diamond_size_dbl = boost::json::value_to<double>(*diamond_size_value_ptr);
                graphics.hud.diamond_size_flt = boost::json::value_to<float>(*diamond_size_value_ptr);
            }
            ...
            if (itts_line_to_mark_alpha_value_ptr != nullptr) {
                graphics.hud.itts_line_to_mark_alpha_dbl = boost::json::value_to<double>(*itts_line_to_mark_alpha_value_ptr);
                graphics.hud.itts_line_to_mark_alpha_flt = boost::json::value_to<float>(*itts_line_to_mark_alpha_value_ptr);
            }
            ...
            if (lock_confirm_line_length_value_ptr != nullptr) {
                graphics.hud.lock_confirm_line_length_dbl = boost::json::value_to<double>(*lock_confirm_line_length_value_ptr);
                graphics.hud.lock_confirm_line_length_flt = boost::json::value_to<float>(*lock_confirm_line_length_value_ptr);
            }
            ...
            if (max_missile_bracket_size_value_ptr != nullptr) {
                graphics.hud.max_missile_bracket_size_dbl = boost::json::value_to<double>(*max_missile_bracket_size_value_ptr);
                graphics.hud.max_missile_bracket_size_flt = boost::json::value_to<float>(*max_missile_bracket_size_value_ptr);
            }
            ...
            if (min_missile_bracket_size_value_ptr != nullptr) {
                graphics.hud.min_missile_bracket_size_dbl = boost::json::value_to<double>(*min_missile_bracket_size_value_ptr);
                graphics.hud.min_missile_bracket_size_flt = boost::json::value_to<float>(*min_missile_bracket_size_value_ptr);
            }
            ...
            if (min_lock_box_size_value_ptr != nullptr) {
                graphics.hud.min_lock_box_size_dbl = boost::json::value_to<double>(*min_lock_box_size_value_ptr);
                graphics.hud.min_lock_box_size_flt = boost::json::value_to<float>(*min_lock_box_size_value_ptr);
            }
            ...
            if (min_radar_blip_size_value_ptr != nullptr) {
                graphics.hud.min_radar_blip_size_dbl = boost::json::value_to<double>(*min_radar_blip_size_value_ptr);
                graphics.hud.min_radar_blip_size_flt = boost::json::value_to<float>(*min_radar_blip_size_value_ptr);
            }
            ...
            if (min_target_box_size_value_ptr != nullptr) {
                graphics.hud.min_target_box_size_dbl = boost::json::value_to<double>(*min_target_box_size_value_ptr);
                graphics.hud.min_target_box_size_flt = boost::json::value_to<float>(*min_target_box_size_value_ptr);
            }
            ...
            if (nav_cross_line_thickness_value_ptr != nullptr) {
                graphics.hud.nav_cross_line_thickness_dbl = boost::json::value_to<double>(*nav_cross_line_thickness_value_ptr);
                graphics.hud.nav_cross_line_thickness_flt = boost::json::value_to<float>(*nav_cross_line_thickness_value_ptr);
            }
            ...
            if (padlock_view_lag_value_ptr != nullptr) {
                graphics.hud.padlock_view_lag_dbl = boost::json::value_to<double>(*padlock_view_lag_value_ptr);
                graphics.hud.padlock_view_lag_flt = boost::json::value_to<float>(*padlock_view_lag_value_ptr);
            }
            ...
            if (padlock_view_lag_fix_zone_value_ptr != nullptr) {
                graphics.hud.padlock_view_lag_fix_zone_dbl = boost::json::value_to<double>(*padlock_view_lag_fix_zone_value_ptr);
                graphics.hud.padlock_view_lag_fix_zone_flt = boost::json::value_to<float>(*padlock_view_lag_fix_zone_value_ptr);
            }
            ...
            if (radar_search_extra_radius_value_ptr != nullptr) {
                graphics.hud.radar_search_extra_radius_dbl = boost::json::value_to<double>(*radar_search_extra_radius_value_ptr);
                graphics.hud.radar_search_extra_radius_flt = boost::json::value_to<float>(*radar_search_extra_radius_value_ptr);
            }
            ...
            if (rotating_bracket_size_value_ptr != nullptr) {
                graphics.hud.rotating_bracket_size_dbl = boost::json::value_to<double>(*rotating_bracket_size_value_ptr);
                graphics.hud.rotating_bracket_size_flt = boost::json::value_to<float>(*rotating_bracket_size_value_ptr);
            }
            ...
            if (rotating_bracket_width_value_ptr != nullptr) {
                graphics.hud.rotating_bracket_width_dbl = boost::json::value_to<double>(*rotating_bracket_width_value_ptr);
                graphics.hud.rotating_bracket_width_flt = boost::json::value_to<float>(*rotating_bracket_width_value_ptr);
            }
            ...
            if (scale_relationship_color_value_ptr != nullptr) {
                graphics.hud.scale_relationship_color_dbl = boost::json::value_to<double>(*scale_relationship_color_value_ptr);
                graphics.hud.scale_relationship_color_flt = boost::json::value_to<float>(*scale_relationship_color_value_ptr);
            }
            ...
            if (shield_vdu_thresh0_value_ptr != nullptr) {
                graphics.hud.shield_vdu_thresh0_dbl = boost::json::value_to<double>(*shield_vdu_thresh0_value_ptr);
                graphics.hud.shield_vdu_thresh0_flt = boost::json::value_to<float>(*shield_vdu_thresh0_value_ptr);
            }
            ...
            if (shield_vdu_thresh1_value_ptr != nullptr) {
                graphics.hud.shield_vdu_thresh1_dbl = boost::json::value_to<double>(*shield_vdu_thresh1_value_ptr);
                graphics.hud.shield_vdu_thresh1_flt = boost::json::value_to<float>(*shield_vdu_thresh1_value_ptr);
            }
            ...
            if (shield_vdu_thresh2_value_ptr != nullptr) {
                graphics.hud.shield_vdu_thresh2_dbl = boost::json::value_to<double>(*shield_vdu_thresh2_value_ptr);
                graphics.hud.shield_vdu_thresh2_flt = boost::json::value_to<float>(*shield_vdu_thresh2_value_ptr);
            }
            ...
            if (tac_target_foci_value_ptr != nullptr) {
                graphics.hud.tac_target_foci_dbl = boost::json::value_to<double>(*tac_target_foci_value_ptr);
                graphics.hud.tac_target_foci_flt = boost::json::value_to<float>(*tac_target_foci_value_ptr);
            }
            ...
            if (tac_target_length_value_ptr != nullptr) {
                graphics.hud.tac_target_length_dbl = boost::json::value_to<double>(*tac_target_length_value_ptr);
                graphics.hud.tac_target_length_flt = boost::json::value_to<float>(*tac_target_length_value_ptr);
            }
            ...
            if (tac_target_thickness_value_ptr != nullptr) {
                graphics.hud.tac_target_thickness_dbl = boost::json::value_to<double>(*tac_target_thickness_value_ptr);
                graphics.hud.tac_target_thickness_flt = boost::json::value_to<float>(*tac_target_thickness_value_ptr);
            }

            const boost::json::value * text_background_alpha_value_ptr = hud_object.if_contains("text_background_alpha");
            if (text_background_alpha_value_ptr != nullptr) {
                graphics.hud.text_background_alpha_dbl = boost::json::value_to<double>(*text_background_alpha_value_ptr);
                graphics.hud.text_background_alpha_flt = boost::json::value_to<float>(*text_background_alpha_value_ptr);
            }
        ...
        if (nav_value_ptr != nullptr) {
            ...
            if (symbol_size_value_ptr != nullptr) {
                graphics.nav.symbol_size_dbl = boost::json::value_to<double>(*symbol_size_value_ptr);
                graphics.nav.symbol_size_flt = boost::json::value_to<float>(*symbol_size_value_ptr);
            }
        ...
        if (joystick_value_ptr != nullptr) {
            ...
            if (enabled_value_ptr != nullptr) {
                joystick.enabled = boost::json::value_to<bool>(*enabled_value_ptr);
            }

            const boost::json::value * throttle_value_ptr = joystick_object.if_contains("throttle");
            if (throttle_value_ptr != nullptr) {
                joystick.throttle = boost::json::value_to<bool>(*throttle_value_ptr);
            }

            const boost::json::value * hat_enabled_value_ptr = joystick_object.if_contains("hat_enabled");
            if (hat_enabled_value_ptr != nullptr) {
                joystick.hat_enabled = boost::json::value_to<bool>(*hat_enabled_value_ptr);
            }
            ...
            if (deadband_value_ptr != nullptr) {
                joystick.deadband_dbl = boost::json::value_to<double>(*deadband_value_ptr);
                joystick.deadband_flt = boost::json::value_to<float>(*deadband_value_ptr);
            }
            ...
            if (double_mouse_factor_value_ptr != nullptr) {
                joystick.double_mouse_factor_dbl = boost::json::value_to<double>(*double_mouse_factor_value_ptr);
                joystick.double_mouse_factor_flt = boost::json::value_to<float>(*double_mouse_factor_value_ptr);
            }
            ...
            if (joystick_exponent_value_ptr != nullptr) {
                joystick.joystick_exponent_dbl = boost::json::value_to<double>(*joystick_exponent_value_ptr);
                joystick.joystick_exponent_flt = boost::json::value_to<float>(*joystick_exponent_value_ptr);
            }

            const boost::json::value * mouse_blur_value_ptr = joystick_object.if_contains("mouse_blur");
            if (mouse_blur_value_ptr != nullptr) {
                joystick.mouse_blur_dbl = boost::json::value_to<double>(*mouse_blur_value_ptr);
                joystick.mouse_blur_flt = boost::json::value_to<float>(*mouse_blur_value_ptr);
            }
            ...
            if (mouse_deadband_value_ptr != nullptr) {
                joystick.mouse_deadband_dbl = boost::json::value_to<double>(*mouse_deadband_value_ptr);
                joystick.mouse_deadband_flt = boost::json::value_to<float>(*mouse_deadband_value_ptr);
            }
            ...
            if (mouse_exponent_value_ptr != nullptr) {
                joystick.mouse_exponent_dbl = boost::json::value_to<double>(*mouse_exponent_value_ptr);
                joystick.mouse_exponent_flt = boost::json::value_to<float>(*mouse_exponent_value_ptr);
            }
            ...
            if (mouse_sensitivity_value_ptr != nullptr) {
                joystick.mouse_sensitivity_dbl = boost::json::value_to<double>(*mouse_sensitivity_value_ptr);
                joystick.mouse_sensitivity_flt = boost::json::value_to<float>(*mouse_sensitivity_value_ptr);
            }
            ...
            if (nonlinear_expamount_combat_value_ptr != nullptr) {
                joystick.nonlinear_expamount_combat_dbl = boost::json::value_to<double>(*nonlinear_expamount_combat_value_ptr);
                joystick.nonlinear_expamount_combat_flt = boost::json::value_to<float>(*nonlinear_expamount_combat_value_ptr);
            }
            ...
            if (nonlinear_expamount_nav_value_ptr != nullptr) {
                joystick.nonlinear_expamount_nav_dbl = boost::json::value_to<double>(*nonlinear_expamount_nav_value_ptr);
                joystick.nonlinear_expamount_nav_flt = boost::json::value_to<float>(*nonlinear_expamount_nav_value_ptr);
            }
            ...
            if (nonlinear_expfactor_combat_value_ptr != nullptr) {
                joystick.nonlinear_expfactor_combat_dbl = boost::json::value_to<double>(*nonlinear_expfactor_combat_value_ptr);
                joystick.nonlinear_expfactor_combat_flt = boost::json::value_to<float>(*nonlinear_expfactor_combat_value_ptr);
            }
            ...
            if (nonlinear_expfactor_nav_value_ptr != nullptr) {
                joystick.nonlinear_expfactor_nav_dbl = boost::json::value_to<double>(*nonlinear_expfactor_nav_value_ptr);
                joystick.nonlinear_expfactor_nav_flt = boost::json::value_to<float>(*nonlinear_expfactor_nav_value_ptr);
            }
            ...
            if (nonlinear_pamount_combat_value_ptr != nullptr) {
                joystick.nonlinear_pamount_combat_dbl = boost::json::value_to<double>(*nonlinear_pamount_combat_value_ptr);
                joystick.nonlinear_pamount_combat_flt = boost::json::value_to<float>(*nonlinear_pamount_combat_value_ptr);
            }
            ...
            if (nonlinear_pamount_nav_value_ptr != nullptr) {
                joystick.nonlinear_pamount_nav_dbl = boost::json::value_to<double>(*nonlinear_pamount_nav_value_ptr);
                joystick.nonlinear_pamount_nav_flt = boost::json::value_to<float>(*nonlinear_pamount_nav_value_ptr);
            }
            ...
            if (nonlinear_pfactor_combat_value_ptr != nullptr) {
                joystick.nonlinear_pfactor_combat_dbl = boost::json::value_to<double>(*nonlinear_pfactor_combat_value_ptr);
                joystick.nonlinear_pfactor_combat_flt = boost::json::value_to<float>(*nonlinear_pfactor_combat_value_ptr);
            }
            ...
            if (nonlinear_pfactor_nav_value_ptr != nullptr) {
                joystick.nonlinear_pfactor_nav_dbl = boost::json::value_to<double>(*nonlinear_pfactor_nav_value_ptr);
                joystick.nonlinear_pfactor_nav_flt = boost::json::value_to<float>(*nonlinear_pfactor_nav_value_ptr);
            }
        ...
        if (physics_value_ptr != nullptr) {
            ...
            if (asteroid_difficulty_value_ptr != nullptr) {
                physics.asteroid_difficulty_dbl = boost::json::value_to<double>(*asteroid_difficulty_value_ptr);
                physics.asteroid_difficulty_flt = boost::json::value_to<float>(*asteroid_difficulty_value_ptr);
            }
            ...
            if (auto_docking_speed_boost_value_ptr != nullptr) {
                physics.auto_docking_speed_boost_dbl = boost::json::value_to<double>(*auto_docking_speed_boost_value_ptr);
                physics.auto_docking_speed_boost_flt = boost::json::value_to<float>(*auto_docking_speed_boost_value_ptr);
            }
            ...
            if (auto_landing_displace_distance_value_ptr != nullptr) {
                physics.auto_landing_displace_distance_dbl = boost::json::value_to<double>(*auto_landing_displace_distance_value_ptr);
                physics.auto_landing_displace_distance_flt = boost::json::value_to<float>(*auto_landing_displace_distance_value_ptr);
            }
            ...
            if (auto_landing_dock_distance_value_ptr != nullptr) {
                physics.auto_landing_dock_distance_dbl = boost::json::value_to<double>(*auto_landing_dock_distance_value_ptr);
                physics.auto_landing_dock_distance_flt = boost::json::value_to<float>(*auto_landing_dock_distance_value_ptr);
            }
            ...
            if (auto_landing_move_distance_value_ptr != nullptr) {
                physics.auto_landing_move_distance_dbl = boost::json::value_to<double>(*auto_landing_move_distance_value_ptr);
                physics.auto_landing_move_distance_flt = boost::json::value_to<float>(*auto_landing_move_distance_value_ptr);
            }
            ...
            if (auto_landing_port_unclamped_seconds_value_ptr != nullptr) {
                physics.auto_landing_port_unclamped_seconds_dbl = boost::json::value_to<double>(*auto_landing_port_unclamped_seconds_value_ptr);
                physics.auto_landing_port_unclamped_seconds_flt = boost::json::value_to<float>(*auto_landing_port_unclamped_seconds_value_ptr);
            }
            ...
            if (auto_landing_warning_distance_value_ptr != nullptr) {
                physics.auto_landing_warning_distance_dbl = boost::json::value_to<double>(*auto_landing_warning_distance_value_ptr);
            ...
            if (auto_pilot_no_enemies_distance_multiplier_value_ptr != nullptr) {
                ...
                physics.auto_pilot_no_enemies_distance_multiplier_flt = boost::json::value_to<float>(*auto_pilot_no_enemies_distance_multiplier_value_ptr);
            }
            ...
            if (auto_pilot_planet_radius_percent_value_ptr != nullptr) {
                physics.auto_pilot_planet_radius_percent_dbl = boost::json::value_to<double>(*auto_pilot_planet_radius_percent_value_ptr);
            ...
            if (auto_pilot_termination_distance_value_ptr != nullptr) {
                physics.auto_pilot_termination_distance_dbl = boost::json::value_to<double>(*auto_pilot_termination_distance_value_ptr);
                physics.auto_pilot_termination_distance_flt = boost::json::value_to<float>(*auto_pilot_termination_distance_value_ptr);
            }
            ...
            if (auto_pilot_termination_distance_enemy_value_ptr != nullptr) {
                physics.auto_pilot_termination_distance_enemy_dbl = boost::json::value_to<double>(*auto_pilot_termination_distance_enemy_value_ptr);
                physics.auto_pilot_termination_distance_enemy_flt = boost::json::value_to<float>(*auto_pilot_termination_distance_enemy_value_ptr);
            }
            ...
            if (auto_pilot_termination_distance_no_enemies_value_ptr != nullptr) {
                physics.auto_pilot_termination_distance_no_enemies_dbl = boost::json::value_to<double>(*auto_pilot_termination_distance_no_enemies_value_ptr);
                physics.auto_pilot_termination_distance_no_enemies_flt = boost::json::value_to<float>(*auto_pilot_termination_distance_no_enemies_value_ptr);
            }
            ...
            if (auto_time_in_seconds_value_ptr != nullptr) {
                physics.auto_time_in_seconds_dbl = boost::json::value_to<double>(*auto_time_in_seconds_value_ptr);
                physics.auto_time_in_seconds_flt = boost::json::value_to<float>(*auto_time_in_seconds_value_ptr);
            }
            ...
            if (autogen_compactness_value_ptr != nullptr) {
                physics.autogen_compactness_dbl = boost::json::value_to<double>(*autogen_compactness_value_ptr);
                physics.autogen_compactness_flt = boost::json::value_to<float>(*autogen_compactness_value_ptr);
            }
            ...
            if (autotracking_value_ptr != nullptr) {
                physics.autotracking_dbl = boost::json::value_to<double>(*autotracking_value_ptr);
                physics.autotracking_flt = boost::json::value_to<float>(*autotracking_value_ptr);
            }
            ...
            if (capship_size_value_ptr != nullptr) {
                physics.capship_size_dbl = boost::json::value_to<double>(*capship_size_value_ptr);
                physics.capship_size_flt = boost::json::value_to<float>(*capship_size_value_ptr);
            }
            ...
            if (cargo_live_time_value_ptr != nullptr) {
                physics.cargo_live_time_dbl = boost::json::value_to<double>(*cargo_live_time_value_ptr);
                physics.cargo_live_time_flt = boost::json::value_to<float>(*cargo_live_time_value_ptr);
            }
            ...
            if (close_enough_to_autotrack_value_ptr != nullptr) {
                physics.close_enough_to_autotrack_dbl = boost::json::value_to<double>(*close_enough_to_autotrack_value_ptr);
                physics.close_enough_to_autotrack_flt = boost::json::value_to<float>(*close_enough_to_autotrack_value_ptr);
            }
            ...
            if (collision_inertial_time_value_ptr != nullptr) {
                physics.collision_inertial_time_dbl = boost::json::value_to<double>(*collision_inertial_time_value_ptr);
                physics.collision_inertial_time_flt = boost::json::value_to<float>(*collision_inertial_time_value_ptr);
            }
            ...
            if (collision_scale_factor_value_ptr != nullptr) {
                physics.collision_scale_factor_dbl = boost::json::value_to<double>(*collision_scale_factor_value_ptr);
                physics.collision_scale_factor_flt = boost::json::value_to<float>(*collision_scale_factor_value_ptr);
            }
            ...
            if (computer_warp_ramp_up_time_value_ptr != nullptr) {
                physics.computer_warp_ramp_up_time_dbl = boost::json::value_to<double>(*computer_warp_ramp_up_time_value_ptr);
                physics.computer_warp_ramp_up_time_flt = boost::json::value_to<float>(*computer_warp_ramp_up_time_value_ptr);
            }
            ...
            if (contraband_assist_range_value_ptr != nullptr) {
                physics.contraband_assist_range_dbl = boost::json::value_to<double>(*contraband_assist_range_value_ptr);
                physics.contraband_assist_range_flt = boost::json::value_to<float>(*contraband_assist_range_value_ptr);
            }
            ...
            if (damage_chance_value_ptr != nullptr) {
                physics.damage_chance_dbl = boost::json::value_to<double>(*damage_chance_value_ptr);
                physics.damage_chance_flt = boost::json::value_to<float>(*damage_chance_value_ptr);
            }
            ...
            if (damage_player_chance_value_ptr != nullptr) {
                physics.damage_player_chance_dbl = boost::json::value_to<double>(*damage_player_chance_value_ptr);
                physics.damage_player_chance_flt = boost::json::value_to<float>(*damage_player_chance_value_ptr);
            }

            const boost::json::value * debris_mass_value_ptr = physics_object.if_contains("debris_mass");
            if (debris_mass_value_ptr != nullptr) {
                physics.debris_mass_dbl = boost::json::value_to<double>(*debris_mass_value_ptr);
                physics.debris_mass_flt = boost::json::value_to<float>(*debris_mass_value_ptr);
            }

            const boost::json::value * debris_time_value_ptr = physics_object.if_contains("debris_time");
            if (debris_time_value_ptr != nullptr) {
                physics.debris_time_dbl = boost::json::value_to<double>(*debris_time_value_ptr);
            ...
            if (default_shield_tightness_value_ptr != nullptr) {
                ...
                physics.default_shield_tightness_flt = boost::json::value_to<float>(*default_shield_tightness_value_ptr);
            }
            ...
            if (definite_damage_chance_value_ptr != nullptr) {
                physics.definite_damage_chance_dbl = boost::json::value_to<double>(*definite_damage_chance_value_ptr);
                physics.definite_damage_chance_flt = boost::json::value_to<float>(*definite_damage_chance_value_ptr);
            }
            ...
            if (density_of_jump_point_value_ptr != nullptr) {
                physics.density_of_jump_point_dbl = boost::json::value_to<double>(*density_of_jump_point_value_ptr);
                physics.density_of_jump_point_flt = boost::json::value_to<float>(*density_of_jump_point_value_ptr);
            }
            ...
            if (density_of_rock_value_ptr != nullptr) {
                physics.density_of_rock_dbl = boost::json::value_to<double>(*density_of_rock_value_ptr);
                physics.density_of_rock_flt = boost::json::value_to<float>(*density_of_rock_value_ptr);
            }
            ...
            if (difficulty_speed_exponent_value_ptr != nullptr) {
                physics.difficulty_speed_exponent_dbl = boost::json::value_to<double>(*difficulty_speed_exponent_value_ptr);
                physics.difficulty_speed_exponent_flt = boost::json::value_to<float>(*difficulty_speed_exponent_value_ptr);
            }
            ...
            if (distance_to_warp_value_ptr != nullptr) {
                physics.distance_to_warp_dbl = boost::json::value_to<double>(*distance_to_warp_value_ptr);
                physics.distance_to_warp_flt = boost::json::value_to<float>(*distance_to_warp_value_ptr);
            }
            ...
            if (docking_time_value_ptr != nullptr) {
                physics.docking_time_dbl = boost::json::value_to<double>(*docking_time_value_ptr);
                physics.docking_time_flt = boost::json::value_to<float>(*docking_time_value_ptr);
            }
            ...
            if (eject_cargo_speed_value_ptr != nullptr) {
                physics.eject_cargo_speed_dbl = boost::json::value_to<double>(*eject_cargo_speed_value_ptr);
                physics.eject_cargo_speed_flt = boost::json::value_to<float>(*eject_cargo_speed_value_ptr);
            }
            ...
            if (eject_distance_value_ptr != nullptr) {
                physics.eject_distance_dbl = boost::json::value_to<double>(*eject_distance_value_ptr);
                physics.eject_distance_flt = boost::json::value_to<float>(*eject_distance_value_ptr);
            }
            ...
            if (eject_live_time_value_ptr != nullptr) {
                physics.eject_live_time_dbl = boost::json::value_to<double>(*eject_live_time_value_ptr);
                physics.eject_live_time_flt = boost::json::value_to<float>(*eject_live_time_value_ptr);
            }
            ...
            if (enough_warp_for_cruise_value_ptr != nullptr) {
                physics.enough_warp_for_cruise_dbl = boost::json::value_to<double>(*enough_warp_for_cruise_value_ptr);
                physics.enough_warp_for_cruise_flt = boost::json::value_to<float>(*enough_warp_for_cruise_value_ptr);
            }
            ...
            if (explosion_damage_center_value_ptr != nullptr) {
                physics.explosion_damage_center_dbl = boost::json::value_to<double>(*explosion_damage_center_value_ptr);
                physics.explosion_damage_center_flt = boost::json::value_to<float>(*explosion_damage_center_value_ptr);
            }
            ...
            if (explosion_damage_edge_value_ptr != nullptr) {
                physics.explosion_damage_edge_dbl = boost::json::value_to<double>(*explosion_damage_edge_value_ptr);
                physics.explosion_damage_edge_flt = boost::json::value_to<float>(*explosion_damage_edge_value_ptr);
            }
            ...
            if (extra_space_drag_for_cargo_value_ptr != nullptr) {
                physics.extra_space_drag_for_cargo_dbl = boost::json::value_to<double>(*extra_space_drag_for_cargo_value_ptr);
                physics.extra_space_drag_for_cargo_flt = boost::json::value_to<float>(*extra_space_drag_for_cargo_value_ptr);
            }
            ...
            if (friendly_auto_radius_value_ptr != nullptr) {
                ...
                physics.friendly_auto_radius_flt = boost::json::value_to<float>(*friendly_auto_radius_value_ptr);
            }

            const boost::json::value * game_accel_value_ptr = physics_object.if_contains("game_accel");
            if (game_accel_value_ptr != nullptr) {
                physics.game_accel_dbl = boost::json::value_to<double>(*game_accel_value_ptr);
                physics.game_accel_flt = boost::json::value_to<float>(*game_accel_value_ptr);
            }

            const boost::json::value * game_speed_value_ptr = physics_object.if_contains("game_speed");
            if (game_speed_value_ptr != nullptr) {
                physics.game_speed_dbl = boost::json::value_to<double>(*game_speed_value_ptr);
                physics.game_speed_flt = boost::json::value_to<float>(*game_speed_value_ptr);
            }
            ...
            if (gun_speed_value_ptr != nullptr) {
                physics.gun_speed_dbl = boost::json::value_to<double>(*gun_speed_value_ptr);
                physics.gun_speed_flt = boost::json::value_to<float>(*gun_speed_value_ptr);
            }
            ...
            if (hostile_auto_radius_value_ptr != nullptr) {
                physics.hostile_auto_radius_dbl = boost::json::value_to<double>(*hostile_auto_radius_value_ptr);
                physics.hostile_auto_radius_flt = boost::json::value_to<float>(*hostile_auto_radius_value_ptr);
            }
            ...
            if (hud_repair_unit_value_ptr != nullptr) {
                physics.hud_repair_unit_dbl = boost::json::value_to<double>(*hud_repair_unit_value_ptr);
                physics.hud_repair_unit_flt = boost::json::value_to<float>(*hud_repair_unit_value_ptr);
            }
            ...
            if (inactive_system_time_value_ptr != nullptr) {
                physics.inactive_system_time_dbl = boost::json::value_to<double>(*inactive_system_time_value_ptr);
                physics.inactive_system_time_flt = boost::json::value_to<float>(*inactive_system_time_value_ptr);
            }
            ...
            if (indiscriminate_system_destruction_value_ptr != nullptr) {
                physics.indiscriminate_system_destruction_dbl = boost::json::value_to<double>(*indiscriminate_system_destruction_value_ptr);
                physics.indiscriminate_system_destruction_flt = boost::json::value_to<float>(*indiscriminate_system_destruction_value_ptr);
            }
            ...
            if (inelastic_scale_value_ptr != nullptr) {
                physics.inelastic_scale_dbl = boost::json::value_to<double>(*inelastic_scale_value_ptr);
                physics.inelastic_scale_flt = boost::json::value_to<float>(*inelastic_scale_value_ptr);
            }
            ...
            if (jump_damage_multiplier_value_ptr != nullptr) {
                physics.jump_damage_multiplier_dbl = boost::json::value_to<double>(*jump_damage_multiplier_value_ptr);
                physics.jump_damage_multiplier_flt = boost::json::value_to<float>(*jump_damage_multiplier_value_ptr);
            }
            ...
            if (jump_mesh_radius_scale_value_ptr != nullptr) {
                physics.jump_mesh_radius_scale_dbl = boost::json::value_to<double>(*jump_mesh_radius_scale_value_ptr);
                physics.jump_mesh_radius_scale_flt = boost::json::value_to<float>(*jump_mesh_radius_scale_value_ptr);
            }
            ...
            if (jump_radius_scale_value_ptr != nullptr) {
                physics.jump_radius_scale_dbl = boost::json::value_to<double>(*jump_radius_scale_value_ptr);
                physics.jump_radius_scale_flt = boost::json::value_to<float>(*jump_radius_scale_value_ptr);
            }
            ...
            if (launch_speed_value_ptr != nullptr) {
                physics.launch_speed_dbl = boost::json::value_to<double>(*launch_speed_value_ptr);
                physics.launch_speed_flt = boost::json::value_to<float>(*launch_speed_value_ptr);
            }

            const boost::json::value * lock_cone_value_ptr = physics_object.if_contains("lock_cone");
            if (lock_cone_value_ptr != nullptr) {
                physics.lock_cone_dbl = boost::json::value_to<double>(*lock_cone_value_ptr);
                physics.lock_cone_flt = boost::json::value_to<float>(*lock_cone_value_ptr);
            }
            ...
            if (max_accel_for_smooth_autopilot_value_ptr != nullptr) {
                physics.max_accel_for_smooth_autopilot_dbl = boost::json::value_to<double>(*max_accel_for_smooth_autopilot_value_ptr);
                physics.max_accel_for_smooth_autopilot_flt = boost::json::value_to<float>(*max_accel_for_smooth_autopilot_value_ptr);
            }
            ...
            if (max_damage_value_ptr != nullptr) {
                physics.max_damage_dbl = boost::json::value_to<double>(*max_damage_value_ptr);
                physics.max_damage_flt = boost::json::value_to<float>(*max_damage_value_ptr);
            }
            ...
            if (max_force_multiplier_value_ptr != nullptr) {
                physics.max_force_multiplier_dbl = boost::json::value_to<double>(*max_force_multiplier_value_ptr);
                physics.max_force_multiplier_flt = boost::json::value_to<float>(*max_force_multiplier_value_ptr);
            }
            ...
            if (max_jump_damage_value_ptr != nullptr) {
                physics.max_jump_damage_dbl = boost::json::value_to<double>(*max_jump_damage_value_ptr);
                physics.max_jump_damage_flt = boost::json::value_to<float>(*max_jump_damage_value_ptr);
            }
            ...
            if (max_lost_target_live_time_value_ptr != nullptr) {
                physics.max_lost_target_live_time_dbl = boost::json::value_to<double>(*max_lost_target_live_time_value_ptr);
                physics.max_lost_target_live_time_flt = boost::json::value_to<float>(*max_lost_target_live_time_value_ptr);
            }
            ...
            if (max_non_player_rotation_rate_value_ptr != nullptr) {
                physics.max_non_player_rotation_rate_dbl = boost::json::value_to<double>(*max_non_player_rotation_rate_value_ptr);
                physics.max_non_player_rotation_rate_flt = boost::json::value_to<float>(*max_non_player_rotation_rate_value_ptr);
            }
            ...
            if (max_over_combat_speed_for_smooth_autopilot_value_ptr != nullptr) {
                physics.max_over_combat_speed_for_smooth_autopilot_dbl = boost::json::value_to<double>(*max_over_combat_speed_for_smooth_autopilot_value_ptr);
                physics.max_over_combat_speed_for_smooth_autopilot_flt = boost::json::value_to<float>(*max_over_combat_speed_for_smooth_autopilot_value_ptr);
            }
            ...
            if (max_player_rotation_rate_value_ptr != nullptr) {
                physics.max_player_rotation_rate_dbl = boost::json::value_to<double>(*max_player_rotation_rate_value_ptr);
                physics.max_player_rotation_rate_flt = boost::json::value_to<float>(*max_player_rotation_rate_value_ptr);
            }
            ...
            if (max_radar_cone_damage_value_ptr != nullptr) {
                physics.max_radar_cone_damage_dbl = boost::json::value_to<double>(*max_radar_cone_damage_value_ptr);
                physics.max_radar_cone_damage_flt = boost::json::value_to<float>(*max_radar_cone_damage_value_ptr);
            }
            ...
            if (max_radar_lock_cone_damage_value_ptr != nullptr) {
                physics.max_radar_lock_cone_damage_dbl = boost::json::value_to<double>(*max_radar_lock_cone_damage_value_ptr);
                physics.max_radar_lock_cone_damage_flt = boost::json::value_to<float>(*max_radar_lock_cone_damage_value_ptr);
            }
            ...
            if (max_radar_track_cone_damage_value_ptr != nullptr) {
                physics.max_radar_track_cone_damage_dbl = boost::json::value_to<double>(*max_radar_track_cone_damage_value_ptr);
                physics.max_radar_track_cone_damage_flt = boost::json::value_to<float>(*max_radar_track_cone_damage_value_ptr);
            }
            ...
            if (max_torque_multiplier_value_ptr != nullptr) {
                physics.max_torque_multiplier_dbl = boost::json::value_to<double>(*max_torque_multiplier_value_ptr);
            ...
            if (min_asteroid_distance_value_ptr != nullptr) {
                ...
                physics.min_asteroid_distance_flt = boost::json::value_to<float>(*min_asteroid_distance_value_ptr);
            }

            const boost::json::value * min_damage_value_ptr = physics_object.if_contains("min_damage");
            if (min_damage_value_ptr != nullptr) {
                physics.min_damage_dbl = boost::json::value_to<double>(*min_damage_value_ptr);
                physics.min_damage_flt = boost::json::value_to<float>(*min_damage_value_ptr);
            }
            ...
            if (min_maxenergy_shot_damage_value_ptr != nullptr) {
                physics.min_maxenergy_shot_damage_dbl = boost::json::value_to<double>(*min_maxenergy_shot_damage_value_ptr);
                physics.min_maxenergy_shot_damage_flt = boost::json::value_to<float>(*min_maxenergy_shot_damage_value_ptr);
            }
            ...
            if (min_shield_speeding_discharge_value_ptr != nullptr) {
                physics.min_shield_speeding_discharge_dbl = boost::json::value_to<double>(*min_shield_speeding_discharge_value_ptr);
                physics.min_shield_speeding_discharge_flt = boost::json::value_to<float>(*min_shield_speeding_discharge_value_ptr);
            }
            ...
            if (minimum_mass_value_ptr != nullptr) {
                physics.minimum_mass_dbl = boost::json::value_to<double>(*minimum_mass_value_ptr);
                physics.minimum_mass_flt = boost::json::value_to<float>(*minimum_mass_value_ptr);
            }

            const boost::json::value * minimum_time_value_ptr = physics_object.if_contains("minimum_time");
            if (minimum_time_value_ptr != nullptr) {
                physics.minimum_time_dbl = boost::json::value_to<double>(*minimum_time_value_ptr);
                physics.minimum_time_flt = boost::json::value_to<float>(*minimum_time_value_ptr);
            }
            ...
            if (mount_repair_unit_value_ptr != nullptr) {
                physics.mount_repair_unit_dbl = boost::json::value_to<double>(*mount_repair_unit_value_ptr);
                physics.mount_repair_unit_flt = boost::json::value_to<float>(*mount_repair_unit_value_ptr);
            }
            ...
            if (near_autotrack_cone_value_ptr != nullptr) {
                physics.near_autotrack_cone_dbl = boost::json::value_to<double>(*near_autotrack_cone_value_ptr);
                physics.near_autotrack_cone_flt = boost::json::value_to<float>(*near_autotrack_cone_value_ptr);
            }
            ...
            if (nebula_shield_recharge_value_ptr != nullptr) {
                physics.nebula_shield_recharge_dbl = boost::json::value_to<double>(*nebula_shield_recharge_value_ptr);
                physics.nebula_shield_recharge_flt = boost::json::value_to<float>(*nebula_shield_recharge_value_ptr);
            }
            ...
            if (nebula_space_drag_value_ptr != nullptr) {
                physics.nebula_space_drag_dbl = boost::json::value_to<double>(*nebula_space_drag_value_ptr);
                physics.nebula_space_drag_flt = boost::json::value_to<float>(*nebula_space_drag_value_ptr);
            }
            ...
            if (neutral_auto_radius_value_ptr != nullptr) {
                physics.neutral_auto_radius_dbl = boost::json::value_to<double>(*neutral_auto_radius_value_ptr);
                physics.neutral_auto_radius_flt = boost::json::value_to<float>(*neutral_auto_radius_value_ptr);
            }
            ...
            if (no_auto_light_below_value_ptr != nullptr) {
                physics.no_auto_light_below_dbl = boost::json::value_to<double>(*no_auto_light_below_value_ptr);
                physics.no_auto_light_below_flt = boost::json::value_to<float>(*no_auto_light_below_value_ptr);
            }
            ...
            if (orbit_averaging_value_ptr != nullptr) {
                physics.orbit_averaging_dbl = boost::json::value_to<double>(*orbit_averaging_value_ptr);
                physics.orbit_averaging_flt = boost::json::value_to<float>(*orbit_averaging_value_ptr);
            }
            ...
            if (percent_missile_match_target_velocity_value_ptr != nullptr) {
                physics.percent_missile_match_target_velocity_dbl = boost::json::value_to<double>(*percent_missile_match_target_velocity_value_ptr);
                physics.percent_missile_match_target_velocity_flt = boost::json::value_to<float>(*percent_missile_match_target_velocity_value_ptr);
            }
            ...
            if (planet_ejection_stophack_value_ptr != nullptr) {
                ...
                physics.planet_ejection_stophack_flt = boost::json::value_to<float>(*planet_ejection_stophack_value_ptr);
            }
            ...
            if (player_godliness_value_ptr != nullptr) {
                physics.player_godliness_dbl = boost::json::value_to<double>(*player_godliness_value_ptr);
                physics.player_godliness_flt = boost::json::value_to<float>(*player_godliness_value_ptr);
            }
            ...
            if (player_survival_chance_on_base_death_value_ptr != nullptr) {
                physics.player_survival_chance_on_base_death_dbl = boost::json::value_to<double>(*player_survival_chance_on_base_death_value_ptr);
                physics.player_survival_chance_on_base_death_flt = boost::json::value_to<float>(*player_survival_chance_on_base_death_value_ptr);
            }
            ...
            if (refire_difficulty_scaling_value_ptr != nullptr) {
                physics.refire_difficulty_scaling_dbl = boost::json::value_to<double>(*refire_difficulty_scaling_value_ptr);
                physics.refire_difficulty_scaling_flt = boost::json::value_to<float>(*refire_difficulty_scaling_value_ptr);
            }
            ...
            if (repair_droid_check_time_value_ptr != nullptr) {
                physics.repair_droid_check_time_dbl = boost::json::value_to<double>(*repair_droid_check_time_value_ptr);
                physics.repair_droid_check_time_flt = boost::json::value_to<float>(*repair_droid_check_time_value_ptr);
            }
            ...
            if (repair_droid_time_value_ptr != nullptr) {
                physics.repair_droid_time_dbl = boost::json::value_to<double>(*repair_droid_time_value_ptr);
                physics.repair_droid_time_flt = boost::json::value_to<float>(*repair_droid_time_value_ptr);
            }
            ...
            if (respawn_unit_size_value_ptr != nullptr) {
                physics.respawn_unit_size_dbl = boost::json::value_to<double>(*respawn_unit_size_value_ptr);
                physics.respawn_unit_size_flt = boost::json::value_to<float>(*respawn_unit_size_value_ptr);
            }
            ...
            if (reverse_speed_limit_value_ptr != nullptr) {
                physics.reverse_speed_limit_dbl = boost::json::value_to<double>(*reverse_speed_limit_value_ptr);
                physics.reverse_speed_limit_flt = boost::json::value_to<float>(*reverse_speed_limit_value_ptr);
            }
            ...
            if (runtime_compactness_value_ptr != nullptr) {
                physics.runtime_compactness_dbl = boost::json::value_to<double>(*runtime_compactness_value_ptr);
                physics.runtime_compactness_flt = boost::json::value_to<float>(*runtime_compactness_value_ptr);
            }
            ...
            if (seconds_per_parsec_value_ptr != nullptr) {
                physics.seconds_per_parsec_dbl = boost::json::value_to<double>(*seconds_per_parsec_value_ptr);
                physics.seconds_per_parsec_flt = boost::json::value_to<float>(*seconds_per_parsec_value_ptr);
            }
            ...
            if (shield_energy_capacitance_value_ptr != nullptr) {
                physics.shield_energy_capacitance_dbl = boost::json::value_to<double>(*shield_energy_capacitance_value_ptr);
                physics.shield_energy_capacitance_flt = boost::json::value_to<float>(*shield_energy_capacitance_value_ptr);
            }
            ...
            if (shield_maintenance_charge_value_ptr != nullptr) {
                physics.shield_maintenance_charge_dbl = boost::json::value_to<double>(*shield_maintenance_charge_value_ptr);
                physics.shield_maintenance_charge_flt = boost::json::value_to<float>(*shield_maintenance_charge_value_ptr);
            }
            ...
            if (smallest_subunit_to_collide_value_ptr != nullptr) {
                physics.smallest_subunit_to_collide_dbl = boost::json::value_to<double>(*smallest_subunit_to_collide_value_ptr);
                physics.smallest_subunit_to_collide_flt = boost::json::value_to<float>(*smallest_subunit_to_collide_value_ptr);
            }
            ...
            if (speeding_discharge_value_ptr != nullptr) {
                physics.speeding_discharge_dbl = boost::json::value_to<double>(*speeding_discharge_value_ptr);
                physics.speeding_discharge_flt = boost::json::value_to<float>(*speeding_discharge_value_ptr);
            }
            ...
            if (star_system_scale_value_ptr != nullptr) {
                physics.star_system_scale_dbl = boost::json::value_to<double>(*star_system_scale_value_ptr);
                physics.star_system_scale_flt = boost::json::value_to<float>(*star_system_scale_value_ptr);
            }
            ...
            if (survival_chance_on_base_death_value_ptr != nullptr) {
                physics.survival_chance_on_base_death_dbl = boost::json::value_to<double>(*survival_chance_on_base_death_value_ptr);
                physics.survival_chance_on_base_death_flt = boost::json::value_to<float>(*survival_chance_on_base_death_value_ptr);
            }
            ...
            if (target_distance_to_warp_bonus_value_ptr != nullptr) {
                physics.target_distance_to_warp_bonus_dbl = boost::json::value_to<double>(*target_distance_to_warp_bonus_value_ptr);
                physics.target_distance_to_warp_bonus_flt = boost::json::value_to<float>(*target_distance_to_warp_bonus_value_ptr);
            }
            ...
            if (thruster_hit_chance_value_ptr != nullptr) {
                physics.thruster_hit_chance_dbl = boost::json::value_to<double>(*thruster_hit_chance_value_ptr);
                physics.thruster_hit_chance_flt = boost::json::value_to<float>(*thruster_hit_chance_value_ptr);
            }
            ...
            if (un_docking_time_value_ptr != nullptr) {
                physics.un_docking_time_dbl = boost::json::value_to<double>(*un_docking_time_value_ptr);
                physics.un_docking_time_flt = boost::json::value_to<float>(*un_docking_time_value_ptr);
            }
            ...
            if (unit_default_autodock_radius_value_ptr != nullptr) {
                physics.unit_default_autodock_radius_dbl = boost::json::value_to<double>(*unit_default_autodock_radius_value_ptr);
                physics.unit_default_autodock_radius_flt = boost::json::value_to<float>(*unit_default_autodock_radius_value_ptr);
            }
            ...
            if (unit_space_drag_value_ptr != nullptr) {
                physics.unit_space_drag_dbl = boost::json::value_to<double>(*unit_space_drag_value_ptr);
                physics.unit_space_drag_flt = boost::json::value_to<float>(*unit_space_drag_value_ptr);
            }
            ...
            if (velocity_max_value_ptr != nullptr) {
                physics.velocity_max_dbl = boost::json::value_to<double>(*velocity_max_value_ptr);
            ...
            if (warp_ramp_down_time_value_ptr != nullptr) {
                physics.warp_ramp_down_time_dbl = boost::json::value_to<double>(*warp_ramp_down_time_value_ptr);
            ...
            if (weapon_damage_efficiency_value_ptr != nullptr) {
                physics.weapon_damage_efficiency_dbl = boost::json::value_to<double>(*weapon_damage_efficiency_value_ptr);
                physics.weapon_damage_efficiency_flt = boost::json::value_to<float>(*weapon_damage_efficiency_value_ptr);
            }

            const boost::json::value * year_scale_value_ptr = physics_object.if_contains("year_scale");
            if (year_scale_value_ptr != nullptr) {
                physics.year_scale_dbl = boost::json::value_to<double>(*year_scale_value_ptr);
                physics.year_scale_flt = boost::json::value_to<float>(*year_scale_value_ptr);
            }
        ...
        if (ejection_value_ptr != nullptr) {
            ...
            if (auto_eject_percent_value_ptr != nullptr) {
                physics.ejection.auto_eject_percent_dbl = boost::json::value_to<double>(*auto_eject_percent_value_ptr);
                physics.ejection.auto_eject_percent_flt = boost::json::value_to<float>(*auto_eject_percent_value_ptr);
            }
            ...
            if (eject_cargo_percent_value_ptr != nullptr) {
                physics.ejection.eject_cargo_percent_dbl = boost::json::value_to<double>(*eject_cargo_percent_value_ptr);
                physics.ejection.eject_cargo_percent_flt = boost::json::value_to<float>(*eject_cargo_percent_value_ptr);
            }
            ...
            if (hull_damage_to_eject_value_ptr != nullptr) {
                physics.ejection.hull_damage_to_eject_dbl = boost::json::value_to<double>(*hull_damage_to_eject_value_ptr);
                physics.ejection.hull_damage_to_eject_flt = boost::json::value_to<float>(*hull_damage_to_eject_value_ptr);
            }
        ...
        if (priorities_value_ptr != nullptr) {
            ...
            if (player_threat_distance_factor_value_ptr != nullptr) {
                physics.priorities.player_threat_distance_factor_dbl = boost::json::value_to<double>(*player_threat_distance_factor_value_ptr);
                physics.priorities.player_threat_distance_factor_flt = boost::json::value_to<float>(*player_threat_distance_factor_value_ptr);
            }
            ...
            if (threat_distance_factor_value_ptr != nullptr) {
                physics.priorities.threat_distance_factor_dbl = boost::json::value_to<double>(*threat_distance_factor_value_ptr);
                physics.priorities.threat_distance_factor_flt = boost::json::value_to<float>(*threat_distance_factor_value_ptr);
            }
        ...
        if (dynamic_throttle_value_ptr != nullptr) {
            ...
            if (max_distance_factor_value_ptr != nullptr) {
                physics.priorities.dynamic_throttle.max_distance_factor_dbl = boost::json::value_to<double>(*max_distance_factor_value_ptr);
                physics.priorities.dynamic_throttle.max_distance_factor_flt = boost::json::value_to<float>(*max_distance_factor_value_ptr);
            }
            ...
            if (min_distance_factor_value_ptr != nullptr) {
                physics.priorities.dynamic_throttle.min_distance_factor_dbl = boost::json::value_to<double>(*min_distance_factor_value_ptr);
                physics.priorities.dynamic_throttle.min_distance_factor_flt = boost::json::value_to<float>(*min_distance_factor_value_ptr);
            }
            ...
            if (target_fps_value_ptr != nullptr) {
                physics.priorities.dynamic_throttle.target_fps_dbl = boost::json::value_to<double>(*target_fps_value_ptr);
                physics.priorities.dynamic_throttle.target_fps_flt = boost::json::value_to<float>(*target_fps_value_ptr);
            }
        ...
        if (tractor_value_ptr != nullptr) {
            ...
            if (percent_to_tractor_value_ptr != nullptr) {
                physics.tractor.percent_to_tractor_dbl = boost::json::value_to<double>(*percent_to_tractor_value_ptr);
                physics.tractor.percent_to_tractor_flt = boost::json::value_to<float>(*percent_to_tractor_value_ptr);
            }
            ...
            if (scoop_alpha_multiplier_value_ptr != nullptr) {
                physics.tractor.scoop_alpha_multiplier_dbl = boost::json::value_to<double>(*scoop_alpha_multiplier_value_ptr);
                physics.tractor.scoop_alpha_multiplier_flt = boost::json::value_to<float>(*scoop_alpha_multiplier_value_ptr);
            }

            const boost::json::value * scoop_angle_value_ptr = tractor_object.if_contains("scoop_angle");
            if (scoop_angle_value_ptr != nullptr) {
                physics.tractor.scoop_angle_dbl = boost::json::value_to<double>(*scoop_angle_value_ptr);
                physics.tractor.scoop_angle_flt = boost::json::value_to<float>(*scoop_angle_value_ptr);
            }

            const boost::json::value * scoop_fov_value_ptr = tractor_object.if_contains("scoop_fov");
            if (scoop_fov_value_ptr != nullptr) {
                physics.tractor.scoop_fov_dbl = boost::json::value_to<double>(*scoop_fov_value_ptr);
                physics.tractor.scoop_fov_flt = boost::json::value_to<float>(*scoop_fov_value_ptr);
            }
        ...
        if (cargo_value_ptr != nullptr) {
            ...
            if (distance_value_ptr != nullptr) {
                physics.tractor.cargo.distance_dbl = boost::json::value_to<double>(*distance_value_ptr);
                physics.tractor.cargo.distance_flt = boost::json::value_to<float>(*distance_value_ptr);
            }
            ...
            if (distance_own_rsize_value_ptr != nullptr) {
                physics.tractor.cargo.distance_own_rsize_dbl = boost::json::value_to<double>(*distance_own_rsize_value_ptr);
                physics.tractor.cargo.distance_own_rsize_flt = boost::json::value_to<float>(*distance_own_rsize_value_ptr);
            }
            ...
            if (distance_tgt_rsize_value_ptr != nullptr) {
                physics.tractor.cargo.distance_tgt_rsize_dbl = boost::json::value_to<double>(*distance_tgt_rsize_value_ptr);
                physics.tractor.cargo.distance_tgt_rsize_flt = boost::json::value_to<float>(*distance_tgt_rsize_value_ptr);
            }
        ...
        if (disabled_value_ptr != nullptr) {
            ...
            if (distance_value_ptr != nullptr) {
                physics.tractor.disabled.distance_dbl = boost::json::value_to<double>(*distance_value_ptr);
                physics.tractor.disabled.distance_flt = boost::json::value_to<float>(*distance_value_ptr);
            }

            const boost::json::value * distance_own_rsize_value_ptr = disabled_object.if_contains("distance_own_rsize");
            if (distance_own_rsize_value_ptr != nullptr) {
                physics.tractor.disabled.distance_own_rsize_dbl = boost::json::value_to<double>(*distance_own_rsize_value_ptr);
                physics.tractor.disabled.distance_own_rsize_flt = boost::json::value_to<float>(*distance_own_rsize_value_ptr);
            }

            const boost::json::value * distance_tgt_rsize_value_ptr = disabled_object.if_contains("distance_tgt_rsize");
            if (distance_tgt_rsize_value_ptr != nullptr) {
                physics.tractor.disabled.distance_tgt_rsize_dbl = boost::json::value_to<double>(*distance_tgt_rsize_value_ptr);
                physics.tractor.disabled.distance_tgt_rsize_flt = boost::json::value_to<float>(*distance_tgt_rsize_value_ptr);
            }
        ...
        if (faction_value_ptr != nullptr) {
            ...
            if (distance_value_ptr != nullptr) {
                physics.tractor.faction.distance_dbl = boost::json::value_to<double>(*distance_value_ptr);
                physics.tractor.faction.distance_flt = boost::json::value_to<float>(*distance_value_ptr);
            }

            const boost::json::value * distance_own_rsize_value_ptr = faction_object.if_contains("distance_own_rsize");
            if (distance_own_rsize_value_ptr != nullptr) {
                physics.tractor.faction.distance_own_rsize_dbl = boost::json::value_to<double>(*distance_own_rsize_value_ptr);
                physics.tractor.faction.distance_own_rsize_flt = boost::json::value_to<float>(*distance_own_rsize_value_ptr);
            }

            const boost::json::value * distance_tgt_rsize_value_ptr = faction_object.if_contains("distance_tgt_rsize");
            if (distance_tgt_rsize_value_ptr != nullptr) {
                physics.tractor.faction.distance_tgt_rsize_dbl = boost::json::value_to<double>(*distance_tgt_rsize_value_ptr);
                physics.tractor.faction.distance_tgt_rsize_flt = boost::json::value_to<float>(*distance_tgt_rsize_value_ptr);
            }
        ...
        if (upgrade_value_ptr != nullptr) {
            ...
            if (distance_value_ptr != nullptr) {
                physics.tractor.upgrade.distance_dbl = boost::json::value_to<double>(*distance_value_ptr);
                physics.tractor.upgrade.distance_flt = boost::json::value_to<float>(*distance_value_ptr);
            }

            const boost::json::value * distance_own_rsize_value_ptr = upgrade_object.if_contains("distance_own_rsize");
            if (distance_own_rsize_value_ptr != nullptr) {
                physics.tractor.upgrade.distance_own_rsize_dbl = boost::json::value_to<double>(*distance_own_rsize_value_ptr);
                physics.tractor.upgrade.distance_own_rsize_flt = boost::json::value_to<float>(*distance_own_rsize_value_ptr);
            }

            const boost::json::value * distance_tgt_rsize_value_ptr = upgrade_object.if_contains("distance_tgt_rsize");
            if (distance_tgt_rsize_value_ptr != nullptr) {
                physics.tractor.upgrade.distance_tgt_rsize_dbl = boost::json::value_to<double>(*distance_tgt_rsize_value_ptr);
                physics.tractor.upgrade.distance_tgt_rsize_flt = boost::json::value_to<float>(*distance_tgt_rsize_value_ptr);
            }
        ...
        if (others_value_ptr != nullptr) {
            ...
            if (distance_value_ptr != nullptr) {
                physics.tractor.others.distance_dbl = boost::json::value_to<double>(*distance_value_ptr);
                physics.tractor.others.distance_flt = boost::json::value_to<float>(*distance_value_ptr);
            }

            const boost::json::value * distance_own_rsize_value_ptr = others_object.if_contains("distance_own_rsize");
            if (distance_own_rsize_value_ptr != nullptr) {
                physics.tractor.others.distance_own_rsize_dbl = boost::json::value_to<double>(*distance_own_rsize_value_ptr);
                physics.tractor.others.distance_own_rsize_flt = boost::json::value_to<float>(*distance_own_rsize_value_ptr);
            }

            const boost::json::value * distance_tgt_rsize_value_ptr = others_object.if_contains("distance_tgt_rsize");
            if (distance_tgt_rsize_value_ptr != nullptr) {
                physics.tractor.others.distance_tgt_rsize_dbl = boost::json::value_to<double>(*distance_tgt_rsize_value_ptr);
                physics.tractor.others.distance_tgt_rsize_flt = boost::json::value_to<float>(*distance_tgt_rsize_value_ptr);
            }
        ...
        if (terrain_value_ptr != nullptr) {
            ...
            if (mass_value_ptr != nullptr) {
                terrain.mass_dbl = boost::json::value_to<double>(*mass_value_ptr);
                terrain.mass_flt = boost::json::value_to<float>(*mass_value_ptr);
            }

            const boost::json::value * radius_value_ptr = terrain_object.if_contains("radius");
            if (radius_value_ptr != nullptr) {
                terrain.radius_dbl = boost::json::value_to<double>(*radius_value_ptr);
                terrain.radius_flt = boost::json::value_to<float>(*radius_value_ptr);
            }

            const boost::json::value * xscale_value_ptr = terrain_object.if_contains("xscale");
            if (xscale_value_ptr != nullptr) {
                terrain.xscale_dbl = boost::json::value_to<double>(*xscale_value_ptr);
                terrain.xscale_flt = boost::json::value_to<float>(*xscale_value_ptr);
            }

            const boost::json::value * yscale_value_ptr = terrain_object.if_contains("yscale");
            if (yscale_value_ptr != nullptr) {
                terrain.yscale_dbl = boost::json::value_to<double>(*yscale_value_ptr);
                terrain.yscale_flt = boost::json::value_to<float>(*yscale_value_ptr);
            }

            const boost::json::value * zscale_value_ptr = terrain_object.if_contains("zscale");
            if (zscale_value_ptr != nullptr) {
                terrain.zscale_dbl = boost::json::value_to<double>(*zscale_value_ptr);
                terrain.zscale_flt = boost::json::value_to<float>(*zscale_value_ptr);
            }
        ...
        if (unit_value_ptr != nullptr) {
            ...
            if (default_aggressivity_value_ptr != nullptr) {
                unit.default_aggressivity_dbl = boost::json::value_to<double>(*default_aggressivity_value_ptr);
                unit.default_aggressivity_flt = boost::json::value_to<float>(*default_aggressivity_value_ptr);
            }
        ...
        if (warp_value_ptr != nullptr) {
            ...
            if (bleed_factor_value_ptr != nullptr) {
                warp.bleed_factor_dbl = boost::json::value_to<double>(*bleed_factor_value_ptr);
                warp.bleed_factor_flt = boost::json::value_to<float>(*bleed_factor_value_ptr);
            }
            ...
            if (in_system_jump_cost_value_ptr != nullptr) {
                warp.in_system_jump_cost_dbl = boost::json::value_to<double>(*in_system_jump_cost_value_ptr);
                warp.in_system_jump_cost_flt = boost::json::value_to<float>(*in_system_jump_cost_value_ptr);
            }
            ...
            if (max_effective_velocity_value_ptr != nullptr) {
                warp.max_effective_velocity_dbl = boost::json::value_to<double>(*max_effective_velocity_value_ptr);
                warp.max_effective_velocity_flt = boost::json::value_to<float>(*max_effective_velocity_value_ptr);
            }
            ...
            if (player_warp_energy_multiplier_value_ptr != nullptr) {
                warp.player_warp_energy_multiplier_dbl = boost::json::value_to<double>(*player_warp_energy_multiplier_value_ptr);
                warp.player_warp_energy_multiplier_flt = boost::json::value_to<float>(*player_warp_energy_multiplier_value_ptr);
            }
            ...
            if (warp_energy_multiplier_value_ptr != nullptr) {
                warp.warp_energy_multiplier_dbl = boost::json::value_to<double>(*warp_energy_multiplier_value_ptr);
                warp.warp_energy_multiplier_flt = boost::json::value_to<float>(*warp_energy_multiplier_value_ptr);
            }
            ...
            if (warp_memory_effect_value_ptr != nullptr) {
                warp.warp_memory_effect_dbl = boost::json::value_to<double>(*warp_memory_effect_value_ptr);
                warp.warp_memory_effect_flt = boost::json::value_to<float>(*warp_memory_effect_value_ptr);
            }
            ...
            if (warp_multiplier_max_value_ptr != nullptr) {
                warp.warp_multiplier_max_dbl = boost::json::value_to<double>(*warp_multiplier_max_value_ptr);
                warp.warp_multiplier_max_flt = boost::json::value_to<float>(*warp_multiplier_max_value_ptr);
            }
            ...
            if (warp_ramp_down_time_value_ptr != nullptr) {
                ...
                warp.warp_ramp_down_time_flt = boost::json::value_to<float>(*warp_ramp_down_time_value_ptr);
            }
            ...
            if (warp_ramp_up_time_value_ptr != nullptr) {
                warp.warp_ramp_up_time_dbl = boost::json::value_to<double>(*warp_ramp_up_time_value_ptr);
                warp.warp_ramp_up_time_flt = boost::json::value_to<float>(*warp_ramp_up_time_value_ptr);
            }

            const boost::json::value * warp_stretch_cutoff_value_ptr = warp_object.if_contains("warp_stretch_cutoff");
            if (warp_stretch_cutoff_value_ptr != nullptr) {
                warp.warp_stretch_cutoff_dbl = boost::json::value_to<double>(*warp_stretch_cutoff_value_ptr);
                warp.warp_stretch_cutoff_flt = boost::json::value_to<float>(*warp_stretch_cutoff_value_ptr);
            }
            ...
            if (warp_stretch_decel_cutoff_value_ptr != nullptr) {
                warp.warp_stretch_decel_cutoff_dbl = boost::json::value_to<double>(*warp_stretch_decel_cutoff_value_ptr);
                warp.warp_stretch_decel_cutoff_flt = boost::json::value_to<float>(*warp_stretch_decel_cutoff_value_ptr);
            }
        ...
        if (fov_link_value_ptr != nullptr) {
            ...
            if (reference_kps_value_ptr != nullptr) {
                warp.fov_link.reference_kps_dbl = boost::json::value_to<double>(*reference_kps_value_ptr);
                warp.fov_link.reference_kps_flt = boost::json::value_to<float>(*reference_kps_value_ptr);
            }

            const boost::json::value * smoothing_value_ptr = fov_link_object.if_contains("smoothing");
            if (smoothing_value_ptr != nullptr) {
                warp.fov_link.smoothing_dbl = boost::json::value_to<double>(*smoothing_value_ptr);
                warp.fov_link.smoothing_flt = boost::json::value_to<float>(*smoothing_value_ptr);
            }
        ...
        if (shake_value_ptr != nullptr) {
            ...
            if (exp_value_ptr != nullptr) {
                warp.fov_link.shake.exp_dbl = boost::json::value_to<double>(*exp_value_ptr);
                warp.fov_link.shake.exp_flt = boost::json::value_to<float>(*exp_value_ptr);
            }

            const boost::json::value * high_ref_value_ptr = shake_object.if_contains("high_ref");
            if (high_ref_value_ptr != nullptr) {
                warp.fov_link.shake.high_ref_dbl = boost::json::value_to<double>(*high_ref_value_ptr);
                warp.fov_link.shake.high_ref_flt = boost::json::value_to<float>(*high_ref_value_ptr);
            }

            const boost::json::value * low_ref_value_ptr = shake_object.if_contains("low_ref");
            if (low_ref_value_ptr != nullptr) {
                warp.fov_link.shake.low_ref_dbl = boost::json::value_to<double>(*low_ref_value_ptr);
                warp.fov_link.shake.low_ref_flt = boost::json::value_to<float>(*low_ref_value_ptr);
            }

            const boost::json::value * speed_value_ptr = shake_object.if_contains("speed");
            if (speed_value_ptr != nullptr) {
                warp.fov_link.shake.speed_dbl = boost::json::value_to<double>(*speed_value_ptr);
                warp.fov_link.shake.speed_flt = boost::json::value_to<float>(*speed_value_ptr);
            }
        ...
        if (offset_value_ptr != nullptr) {
            ...
            if (back_value_ptr != nullptr) {
                warp.fov_link.shake.offset.back_dbl = boost::json::value_to<double>(*back_value_ptr);
                warp.fov_link.shake.offset.back_flt = boost::json::value_to<float>(*back_value_ptr);
            }

            const boost::json::value * front_value_ptr = offset_object.if_contains("front");
            if (front_value_ptr != nullptr) {
                warp.fov_link.shake.offset.front_dbl = boost::json::value_to<double>(*front_value_ptr);
                warp.fov_link.shake.offset.front_flt = boost::json::value_to<float>(*front_value_ptr);
            }

            const boost::json::value * perpendicular_value_ptr = offset_object.if_contains("perpendicular");
            if (perpendicular_value_ptr != nullptr) {
                warp.fov_link.shake.offset.perpendicular_dbl = boost::json::value_to<double>(*perpendicular_value_ptr);
                warp.fov_link.shake.offset.perpendicular_flt = boost::json::value_to<float>(*perpendicular_value_ptr);
            }
        ...
        if (multiplier_value_ptr != nullptr) {
            ...
            if (back_value_ptr != nullptr) {
                warp.fov_link.shake.multiplier.back_dbl = boost::json::value_to<double>(*back_value_ptr);
                warp.fov_link.shake.multiplier.back_flt = boost::json::value_to<float>(*back_value_ptr);
            }

            const boost::json::value * front_value_ptr = multiplier_object.if_contains("front");
            if (front_value_ptr != nullptr) {
                warp.fov_link.shake.multiplier.front_dbl = boost::json::value_to<double>(*front_value_ptr);
                warp.fov_link.shake.multiplier.front_flt = boost::json::value_to<float>(*front_value_ptr);
            }

            const boost::json::value * perpendicular_value_ptr = multiplier_object.if_contains("perpendicular");
            if (perpendicular_value_ptr != nullptr) {
                warp.fov_link.shake.multiplier.perpendicular_dbl = boost::json::value_to<double>(*perpendicular_value_ptr);
                warp.fov_link.shake.multiplier.perpendicular_flt = boost::json::value_to<float>(*perpendicular_value_ptr);
            }
        ...
        if (stable_value_ptr != nullptr) {
            ...
            if (exp_value_ptr != nullptr) {
                warp.fov_link.stable.exp_dbl = boost::json::value_to<double>(*exp_value_ptr);
                warp.fov_link.stable.exp_flt = boost::json::value_to<float>(*exp_value_ptr);
            }

            const boost::json::value * high_ref_value_ptr = stable_object.if_contains("high_ref");
            if (high_ref_value_ptr != nullptr) {
                warp.fov_link.stable.high_ref_dbl = boost::json::value_to<double>(*high_ref_value_ptr);
                warp.fov_link.stable.high_ref_flt = boost::json::value_to<float>(*high_ref_value_ptr);
            }

            const boost::json::value * low_ref_value_ptr = stable_object.if_contains("low_ref");
            if (low_ref_value_ptr != nullptr) {
                warp.fov_link.stable.low_ref_dbl = boost::json::value_to<double>(*low_ref_value_ptr);
                warp.fov_link.stable.low_ref_flt = boost::json::value_to<float>(*low_ref_value_ptr);
            }
        ...
        if (offset_value_ptr != nullptr) {
            ...
            const boost::json::value * back_value_ptr = offset_object.if_contains("back");
            if (back_value_ptr != nullptr) {
                warp.fov_link.stable.offset.back_dbl = boost::json::value_to<double>(*back_value_ptr);
                warp.fov_link.stable.offset.back_flt = boost::json::value_to<float>(*back_value_ptr);
            }

            const boost::json::value * front_value_ptr = offset_object.if_contains("front");
            if (front_value_ptr != nullptr) {
                warp.fov_link.stable.offset.front_dbl = boost::json::value_to<double>(*front_value_ptr);
                warp.fov_link.stable.offset.front_flt = boost::json::value_to<float>(*front_value_ptr);
            }

            const boost::json::value * perpendicular_value_ptr = offset_object.if_contains("perpendicular");
            if (perpendicular_value_ptr != nullptr) {
                warp.fov_link.stable.offset.perpendicular_dbl = boost::json::value_to<double>(*perpendicular_value_ptr);
                warp.fov_link.stable.offset.perpendicular_flt = boost::json::value_to<float>(*perpendicular_value_ptr);
            }
        ...
        if (multiplier_value_ptr != nullptr) {
            ...
            const boost::json::value * back_value_ptr = multiplier_object.if_contains("back");
            if (back_value_ptr != nullptr) {
                warp.fov_link.stable.multiplier.back_dbl = boost::json::value_to<double>(*back_value_ptr);
                warp.fov_link.stable.multiplier.back_flt = boost::json::value_to<float>(*back_value_ptr);
            }

            const boost::json::value * front_value_ptr = multiplier_object.if_contains("front");
            if (front_value_ptr != nullptr) {
                warp.fov_link.stable.multiplier.front_dbl = boost::json::value_to<double>(*front_value_ptr);
                warp.fov_link.stable.multiplier.front_flt = boost::json::value_to<float>(*front_value_ptr);
            }

            const boost::json::value * perpendicular_value_ptr = multiplier_object.if_contains("perpendicular");
            if (perpendicular_value_ptr != nullptr) {
                warp.fov_link.stable.multiplier.perpendicular_dbl = boost::json::value_to<double>(*perpendicular_value_ptr);
                warp.fov_link.stable.multiplier.perpendicular_flt = boost::json::value_to<float>(*perpendicular_value_ptr);
            }
