...
class GameCockpit : public Cockpit {
    ...
    void SetParent(UnitPtr unit, const char *filename, const char *unitmodname, const QVector &startloc) override;
...
public:
    ...
    int Autopilot(UnitPtr target) override;
    ...
    float LookupTargetStat(int stat, UnitPtr target) override;
    ...
    void SetCommAnimation(Animation *ani, UnitPtr un) override;
    ...
    bool CheckCommAnimation(UnitPtr un) override;
    ...
    void OnDockEnd(UnitPtr station, UnitPtr unit) override;
    // Ship is jumping
    void OnJumpBegin(UnitPtr unit) override;
    void OnJumpEnd(UnitPtr unit) override;
